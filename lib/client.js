...
function GetTicketRow(props) {
  ...
  const body = errorText2 !== null && errorText2 !== "" ? errorBody(errorText2) : facts.length === 0 && evidence.length === 0 ? result === null ? fallbackBody(resultText) : null : /* @__PURE__ */ import_react29.default.createElement(import_react29.default.Fragment, null, /* @__PURE__ */ import_react29.default.createElement(Facts, { facts }), evidence.length > 0 ? /* @__PURE__ */ import_react29.default.createElement("ul", { className: "aidos-evidence-list" }, evidence.map((row, index) => /* @__PURE__ */ import_react29.default.createElement(
    EvidenceStrip,
    {
      key: index,
      row: {
...
function GetTicketsRow(props) {
  ...
  const body = errorText2 !== null && errorText2 !== "" ? errorBody(errorText2) : lines.length === 0 ? result === null ? fallbackBody(resultText) : null : /* @__PURE__ */ import_react29.default.createElement("ul", { className: "aidos-tool-list" }, lines.map((line) => /* @__PURE__ */ import_react29.default.createElement("li", { key: line.id }, /* @__PURE__ */ import_react29.default.createElement("span", { className: "aidos-tool-list-key" }, "#", line.id), line.state === "" ? null : /* @__PURE__ */ import_react29.default.createElement("span", { className: "aidos-tool-list-tag" }, line.state), /* @__PURE__ */ import_react29.default.createElement("span", { className: "aidos-tool-list-text", title: line.title, "data-dsh-tip": "" }, line.title))));
  return /* @__PURE__ */ import_react29.default.createElement(
    AidosRow,
    {
