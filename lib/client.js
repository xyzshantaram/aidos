...
.aidos-chip-kind,
.aidos-chip-dep {
  background: color-mix(in srgb, var(--chip-hue, var(--badge-hue-1)) 14%, transparent);
  border: 1px solid color-mix(in srgb, var(--chip-hue, var(--badge-hue-1)) 40%, transparent);
  color: color-mix(in srgb, var(--chip-hue, var(--badge-hue-1)) 72%, #ffffff);
}
...
.aidos-chip-count {
  ...
  border-inline-start: 1px solid color-mix(in srgb, var(--chip-hue, var(--badge-hue-1)) 40%, transparent);
  color: color-mix(in srgb, var(--chip-hue, var(--badge-hue-1)) 82%, #ffffff);
  font-weight: 700;
}
...
function EvidenceTags({ evidence, state }) {
  ...
  const counts2 = state === void 0 ? all : tileKindCounts(state, all);
...
function TicketTile(props) {
  ...
  return /* @__PURE__ */ import_react3.default.createElement("button", { className, onClick: props.onSelect }, /* @__PURE__ */ import_react3.default.createElement("div", { className: "aidos-tile-meta" }, /* @__PURE__ */ import_react3.default.createElement(
  ...
  ), /* @__PURE__ */ import_react3.default.createElement("span", { className: badge }, stateLabel(ticket.state))), /* @__PURE__ */ import_react3.default.createElement("h3", { className: "aidos-tile-title" }, ticket.title), /* @__PURE__ */ import_react3.default.createElement("p", { className: "aidos-tile-preview" }, ticket.description), /* @__PURE__ */ import_react3.default.createElement("div", { className: "aidos-tile-chips" }, /* @__PURE__ */ import_react3.default.createElement(
    "span",
    {
    ...
    /* @__PURE__ */ import_react3.default.createElement("span", { className: "aidos-chip-key", "aria-hidden": "true" }, "\u25E7"),
    /* @__PURE__ */ import_react3.default.createElement("span", { className: "aidos-chip-value" }, formatGateFraction(ticket.gatePresent, ticket.gateTotal, hasCriteria(ticket)))
  ...
  ), /* @__PURE__ */ import_react3.default.createElement(EvidenceTags, { evidence: props.evidence, state: ticket.state }), ticket.dependsOn?.map((ref) => /* @__PURE__ */ import_react3.default.createElement(
    "span",
    {
      key: ref,
    ...
    /* @__PURE__ */ import_react3.default.createElement("span", { className: "aidos-chip-dep-icon", "aria-hidden": "true" }, "\u21B3"),
