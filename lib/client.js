...
function ModalShell(props) {
  ...
  return /* @__PURE__ */ import_react6.default.createElement("div", { className: "aidos-modal-mask", onClick: props.onClose }, /* @__PURE__ */ import_react6.default.createElement(
    "div",
    {
      className: "aidos-modal",
      onClick: (event) => {
    ...
    /* @__PURE__ */ import_react6.default.createElement("div", { className: "aidos-modal-head" }, /* @__PURE__ */ import_react6.default.createElement("h3", { className: "aidos-modal-title" }, props.title), /* @__PURE__ */ import_react6.default.createElement("button", { className: "aidos-close-btn", onClick: props.onClose, "aria-label": "Close" }, "\xD7")),
    /* @__PURE__ */ import_react6.default.createElement("div", { className: "aidos-modal-form" }, props.children, props.onConfirm !== void 0 ? /* @__PURE__ */ import_react6.default.createElement("div", { className: "aidos-form-actions" }, /* @__PURE__ */ import_react6.default.createElement("button", { className: "aidos-btn", onClick: props.onClose, disabled: props.working }, "Cancel"), /* @__PURE__ */ import_react6.default.createElement(
      "button",
      {
        className: "aidos-btn aidos-btn-primary",
...
function NoteText(props) {
  return /* @__PURE__ */ import_react7.default.createElement("span", { className: "aidos-evidence-note-text" }, props.text);
}
function RawJsonDisclosure(props) {
  ...
  return /* @__PURE__ */ import_react7.default.createElement(
    ...
    /* @__PURE__ */ import_react7.default.createElement("summary", null, "raw payload"),
    /* @__PURE__ */ import_react7.default.createElement("pre", { className: "aidos-evidence-payload-json" }, JSON.stringify(props.payload, null, 2))
  );
}
...
function EvidencePayloadView(props) {
  ...
  if (kind === "builtin:file_allowlist" && Array.isArray(payload.paths)) {
    return /* @__PURE__ */ import_react7.default.createElement("div", { className: "aidos-evidence-fields" }, /* @__PURE__ */ import_react7.default.createElement(FieldRow, { label: "Paths" }, /* @__PURE__ */ import_react7.default.createElement("ul", { className: "aidos-evidence-payload-list" }, payload.paths.map((path) => /* @__PURE__ */ import_react7.default.createElement("li", { key: path }, path)))), note !== null ? /* @__PURE__ */ import_react7.default.createElement(FieldRow, { label: "Note" }, /* @__PURE__ */ import_react7.default.createElement(NoteText, { text: note })) : null, /* @__PURE__ */ import_react7.default.createElement(RawJsonDisclosure, { payload }));
  }
  if (kind === "builtin:imported_state" && typeof payload.claimed_state === "string") {
    return /* @__PURE__ */ import_react7.default.createElement("div", { className: "aidos-evidence-fields" }, /* @__PURE__ */ import_react7.default.createElement(FieldRow, { label: "Claimed state" }, /* @__PURE__ */ import_react7.default.createElement("span", { className: "aidos-evidence-note-text" }, payload.claimed_state)), typeof payload.source === "string" ? /* @__PURE__ */ import_react7.default.createElement(FieldRow, { label: "Source" }, payload.source) : null, note !== null ? /* @__PURE__ */ import_react7.default.createElement(FieldRow, { label: "Note" }, /* @__PURE__ */ import_react7.default.createElement(NoteText, { text: note })) : null, /* @__PURE__ */ import_react7.default.createElement(RawJsonDisclosure, { payload }));
  }
  if (typeof payload.imagePath === "string") {
    return /* @__PURE__ */ import_react7.default.createElement("div", { className: "aidos-evidence-fields" }, /* @__PURE__ */ import_react7.default.createElement(FieldRow, { label: "Screenshot" }, /* @__PURE__ */ import_react7.default.createElement("img", { className: "aidos-evidence-image", src: payload.imagePath, alt: note ?? "evidence screenshot" }), /* @__PURE__ */ import_react7.default.createElement("span", { className: "aidos-evidence-image-path" }, payload.imagePath)), note !== null ? /* @__PURE__ */ import_react7.default.createElement(FieldRow, { label: "Note" }, /* @__PURE__ */ import_react7.default.createElement(NoteText, { text: note })) : null, /* @__PURE__ */ import_react7.default.createElement(RawJsonDisclosure, { payload }));
  }
  if (typeof payload.commit === "string") {
    return /* @__PURE__ */ import_react7.default.createElement("div", { className: "aidos-evidence-fields" }, /* @__PURE__ */ import_react7.default.createElement(FieldRow, { label: "Commit" }, /* @__PURE__ */ import_react7.default.createElement("code", null, String(payload.commit).slice(0, 12)), typeof payload.subject === "string" ? /* @__PURE__ */ import_react7.default.createElement(NoteText, { text: " " + payload.subject }) : null), typeof payload.author === "string" ? /* @__PURE__ */ import_react7.default.createElement(FieldRow, { label: "Committed by" }, payload.author) : null, typeof payload.branch === "string" ? /* @__PURE__ */ import_react7.default.createElement(FieldRow, { label: "Branch" }, payload.branch) : null, note !== null ? /* @__PURE__ */ import_react7.default.createElement(FieldRow, { label: "Note" }, /* @__PURE__ */ import_react7.default.createElement(NoteText, { text: note })) : null, /* @__PURE__ */ import_react7.default.createElement(RawJsonDisclosure, { payload }));
  }
  ...
  return /* @__PURE__ */ import_react7.default.createElement("div", { className: "aidos-evidence-fields" }, textFields.map(([key, value]) => /* @__PURE__ */ import_react7.default.createElement(FieldRow, { key, label: key }, /* @__PURE__ */ import_react7.default.createElement(NoteText, { text: value }))), otherFields.map(([key, value]) => /* @__PURE__ */ import_react7.default.createElement(FieldRow, { key, label: key }, /* @__PURE__ */ import_react7.default.createElement("code", null, isImage(String(value)) ? String(value) : JSON.stringify(value)))), note !== null ? /* @__PURE__ */ import_react7.default.createElement(FieldRow, { label: "Note" }, /* @__PURE__ */ import_react7.default.createElement(NoteText, { text: note })) : null, /* @__PURE__ */ import_react7.default.createElement(RawJsonDisclosure, { payload }));
}
...
function EvidenceViewer(props) {
  ...
  return /* @__PURE__ */ import_react8.default.createElement(
    ...
    /* @__PURE__ */ import_react8.default.createElement(
      ...
      /* @__PURE__ */ import_react8.default.createElement("div", { className: "aidos-modal-head" }, /* @__PURE__ */ import_react8.default.createElement("h3", { className: "aidos-modal-title" }, /* @__PURE__ */ import_react8.default.createElement(
        "span",
        {
          className: "aidos-chip aidos-chip-kind",
          style: { background: kindColor(row.kind) }
        },
        /* @__PURE__ */ import_react8.default.createElement("span", { className: "aidos-chip-key" }, kindKeyword(row.kind))
      ), " " + row.kind), /* @__PURE__ */ import_react8.default.createElement(
        "button",
        {
          className: "aidos-close-btn",
          onClick: props.onClose,
      ...
      /* @__PURE__ */ import_react8.default.createElement("div", { className: "aidos-modal-form" }, /* @__PURE__ */ import_react8.default.createElement("div", { className: "aidos-evidence-fields" }, /* @__PURE__ */ import_react8.default.createElement(FieldRow, { label: "Author" }, row.author), /* @__PURE__ */ import_react8.default.createElement(FieldRow, { label: "At" }, typeof row.at === "number" ? new Date(row.at * 1e3).toISOString() : "unknown")), /* @__PURE__ */ import_react8.default.createElement(EvidencePayloadView, { row }))
    )
  );
}
...
function PencilIcon() {
  return /* @__PURE__ */ import_react9.default.createElement(
    ...
    /* @__PURE__ */ import_react9.default.createElement("path", { d: "M8.5 1.5l2 2L4 10l-2.5.5L2 8z" })
  );
}
function TrashIcon() {
  return /* @__PURE__ */ import_react9.default.createElement(
    ...
    /* @__PURE__ */ import_react9.default.createElement("path", { d: "M2 3.5h8M5 3.5V2h2v1.5M3 3.5l.5 7h5l.5-7M5 5.5v3M7 5.5v3" })
  );
}
...
function FieldEditor(props) {
  const [editing, setEditing] = import_react10.default.useState(false);
  const [draft, setDraft] = import_react10.default.useState(String(props.value));
  ...
  if (editing) {
    ...
    return /* @__PURE__ */ import_react10.default.createElement("div", { className: "aidos-field-editor" }, isTextarea ? /* @__PURE__ */ import_react10.default.createElement(
      "textarea",
      {
    ...
    ), /* @__PURE__ */ import_react10.default.createElement("span", null, /* @__PURE__ */ import_react10.default.createElement("button", { className: "aidos-btn", disabled: saving, onClick: save }, "Save"), " ", /* @__PURE__ */ import_react10.default.createElement("button", { className: "aidos-btn", disabled: saving, onClick: cancel }, "Cancel")));
  }
  return /* @__PURE__ */ import_react10.default.createElement("div", { className: "aidos-field-editor" }, /* @__PURE__ */ import_react10.default.createElement("span", null, props.children !== void 0 ? props.children : String(props.value), " ", /* @__PURE__ */ import_react10.default.createElement(
    "button",
    {
    ...
    /* @__PURE__ */ import_react10.default.createElement(PencilIcon, null)
  )));
}
...
function ActionBar(props) {
  ...
  return /* @__PURE__ */ import_react11.default.createElement("div", { className: "aidos-action-bar" }, buttons);
}
...
function CommentsSection(props) {
  ...
  const [draft, setDraft] = import_react12.default.useState("");
  const [sending, setSending] = import_react12.default.useState(false);
  ...
  const rows = newestFirst.map((comment, index) => {
    ...
    return /* @__PURE__ */ import_react12.default.createElement("div", { className: "aidos-comment", key: index }, /* @__PURE__ */ import_react12.default.createElement("div", null, /* @__PURE__ */ import_react12.default.createElement("span", { className: "aidos-evidence-author" }, comment.author)), /* @__PURE__ */ import_react12.default.createElement("p", { className: "aidos-detail-body" }, comment.text), /* @__PURE__ */ import_react12.default.createElement("p", { className: "aidos-detail-note" }, time));
  });
  return /* @__PURE__ */ import_react12.default.createElement("details", { className: "aidos-panel", open: comments.length !== 1 }, /* @__PURE__ */ import_react12.default.createElement("summary", { className: "aidos-panel-head" }, /* @__PURE__ */ import_react12.default.createElement("h4", { className: "aidos-panel-title" }, "Comments")), /* @__PURE__ */ import_react12.default.createElement("div", { className: "aidos-panel-body" }, rows.length === 0 ? /* @__PURE__ */ import_react12.default.createElement("p", { className: "aidos-detail-note" }, "No comments yet.") : rows, /* @__PURE__ */ import_react12.default.createElement(
    "textarea",
    {
  ...
  ), /* @__PURE__ */ import_react12.default.createElement("div", { className: "aidos-form-actions" }, /* @__PURE__ */ import_react12.default.createElement(
    "button",
    {
...
function VerifyModal(props) {
  ...
  const [imagePath, setImagePath] = import_react13.default.useState(null);
  const [uploading, setUploading] = import_react13.default.useState(false);
  const [working, setWorking] = import_react13.default.useState(false);
  const [pasteError, setPasteError] = import_react13.default.useState(null);
  ...
  return /* @__PURE__ */ import_react13.default.createElement(AttachModal, { title: "Verify", working: working || uploading, onAttach: () => void attach(), onClose: props.onClose }, /* @__PURE__ */ import_react13.default.createElement("p", { className: "aidos-modal-body" }, "You verified this ticket hands-on. Paste (Ctrl+V) or drop a screenshot to attach it."), /* @__PURE__ */ import_react13.default.createElement(
    "div",
    {
  ...
  ), pasteError !== null ? /* @__PURE__ */ import_react13.default.createElement("p", { className: "aidos-evidence-paste-error" }, pasteError) : null, /* @__PURE__ */ import_react13.default.createElement(NoteField2, { note, working, onChange: setNote }));
}
...
function TailoredForm(props) {
  const [note, setNote] = import_react13.default.useState("");
  const [pathsText, setPathsText] = import_react13.default.useState("");
  const [payloadText, setPayloadText] = import_react13.default.useState("");
  const [working, setWorking] = import_react13.default.useState(false);
  ...
  if (props.kind === "builtin:file_allowlist") {
    ...
    return /* @__PURE__ */ import_react13.default.createElement("div", { className: "aidos-evidence-tailored" }, /* @__PURE__ */ import_react13.default.createElement("div", { className: "aidos-modal-row" }, /* @__PURE__ */ import_react13.default.createElement("label", null, "Allowed paths (one per line)"), /* @__PURE__ */ import_react13.default.createElement(
      "textarea",
      {
    ...
    )), /* @__PURE__ */ import_react13.default.createElement(NoteField2, { note, working, onChange: setNote }), /* @__PURE__ */ import_react13.default.createElement("div", { className: "aidos-form-actions" }, /* @__PURE__ */ import_react13.default.createElement(
      "button",
      {
        className: "aidos-btn aidos-btn-primary",
  ...
  if (props.kind === "builtin:review_note" || props.kind === "builtin:user_verified" || props.kind === "builtin:user_signoff") {
    return /* @__PURE__ */ import_react13.default.createElement("div", { className: "aidos-evidence-tailored" }, /* @__PURE__ */ import_react13.default.createElement(NoteField2, { note, working, onChange: setNote, label: "Note" }), /* @__PURE__ */ import_react13.default.createElement("div", { className: "aidos-form-actions" }, /* @__PURE__ */ import_react13.default.createElement(
      "button",
      {
        className: "aidos-btn aidos-btn-primary",
        disabled: working,
  ...
  return /* @__PURE__ */ import_react13.default.createElement("div", { className: "aidos-evidence-tailored" }, /* @__PURE__ */ import_react13.default.createElement("div", { className: "aidos-modal-row" }, /* @__PURE__ */ import_react13.default.createElement("label", null, "Payload JSON (optional object)"), /* @__PURE__ */ import_react13.default.createElement(
    "textarea",
    {
      className: "aidos-evidence-attach-note",
      value: payloadText,
  ...
  )), parseError !== null ? /* @__PURE__ */ import_react13.default.createElement("p", { className: "aidos-evidence-paste-error" }, parseError) : null, /* @__PURE__ */ import_react13.default.createElement(NoteField2, { note, working, onChange: setNote }), /* @__PURE__ */ import_react13.default.createElement("div", { className: "aidos-form-actions" }, /* @__PURE__ */ import_react13.default.createElement(
    "button",
    {
      className: "aidos-btn aidos-btn-primary",
...
function EvidenceAttach(props) {
  ...
  const [kind, setKind] = import_react13.default.useState(kinds.length > 0 ? kinds[0].id : "");
  const [lastRow, setLastRow] = import_react13.default.useState(null);
  const remainingKinds = kinds.filter(
    (k2) => k2.id !== "builtin:user_signoff" && k2.id !== "builtin:user_verified"
  );
  void lastRow;
  return /* @__PURE__ */ import_react13.default.createElement("div", { className: "aidos-evidence-attach" }, /* @__PURE__ */ import_react13.default.createElement("div", { className: "aidos-modal-row" }, /* @__PURE__ */ import_react13.default.createElement("label", null, "Other evidence kinds"), /* @__PURE__ */ import_react13.default.createElement(
    "select",
    {
    ...
    remainingKinds.map((descriptor) => /* @__PURE__ */ import_react13.default.createElement("option", { value: descriptor.id, key: descriptor.id }, descriptor.label))
  )), /* @__PURE__ */ import_react13.default.createElement(TailoredForm, { ticketId: props.ticketId, agentId: props.agentId, kind, onAttached: () => props.onAttached?.() }));
}

// src/client/allowlist-request-card.tsx
var import_react14 = __toESM(require("react"), 1);
function AllowlistRequestCard(props) {
  const [request, setRequest] = import_react14.default.useState(null);
  const [paths, setPaths] = import_react14.default.useState([]);
  const [working, setWorking] = import_react14.default.useState(false);
  const [tick, setTick] = import_react14.default.useState(0);
  ...
  return /* @__PURE__ */ import_react14.default.createElement("div", { className: "aidos-approval-card" }, /* @__PURE__ */ import_react14.default.createElement("div", { className: "aidos-approval-head" }, /* @__PURE__ */ import_react14.default.createElement("span", { className: "aidos-chip aidos-chip-kind aidos-chip-approval-kind" }, /* @__PURE__ */ import_react14.default.createElement("span", { className: "aidos-chip-key" }, request.kind.toUpperCase())), /* @__PURE__ */ import_react14.default.createElement("span", { className: "aidos-approval-prompt" }, request.prompt)), /* @__PURE__ */ import_react14.default.createElement(
    "textarea",
    {
      className: "aidos-allowlist-input",
      value: paths.join("\n"),
  ...
  ), /* @__PURE__ */ import_react14.default.createElement("p", { className: "aidos-detail-note" }, "Edit the list before approving if the proposal needs amending. The agent is told the outcome either way."), /* @__PURE__ */ import_react14.default.createElement("div", { className: "aidos-form-actions" }, /* @__PURE__ */ import_react14.default.createElement("button", { className: "aidos-btn", disabled: working, onClick: () => void resolve(false) }, "Reject"), /* @__PURE__ */ import_react14.default.createElement("button", { className: "aidos-btn aidos-btn-primary", disabled: working, onClick: () => void resolve(true) }, working ? "Working\u2026" : "Approve")));
}
...
function SignoffDialog(props) {
  ...
  return /* @__PURE__ */ import_react15.default.createElement(
    ...
    /* @__PURE__ */ import_react15.default.createElement("p", { className: "aidos-modal-body" }, "Signoff grants the agent write access on this ticket. Confirm to proceed."),
...
function SendBackModal(props) {
  const [reason, setReason] = import_react16.default.useState("");
  ...
  return /* @__PURE__ */ import_react16.default.createElement(
    ...
    /* @__PURE__ */ import_react16.default.createElement("p", { className: "aidos-modal-body" }, "Send the ticket back to in progress. The reason attaches as a comment."),
    /* @__PURE__ */ import_react16.default.createElement(NoteField, { label: "Reason", value: reason, working, onChange: setReason })
  );
}
...
function MarkDoneModal(props) {
  const [step, setStep] = import_react17.default.useState(1);
  const [finalComment, setFinalComment] = import_react17.default.useState("");
  const [working, setWorking] = import_react17.default.useState(false);
  ...
  return /* @__PURE__ */ import_react17.default.createElement(ModalShell, { title: "Mark done", working, onClose: props.onClose }, step === 1 ? /* @__PURE__ */ import_react17.default.createElement("div", { className: "aidos-modal-form" }, /* @__PURE__ */ import_react17.default.createElement("p", { className: "aidos-modal-body" }, "The ticket criteria:"), criteriaLines2.length === 0 ? /* @__PURE__ */ import_react17.default.createElement("p", { className: "aidos-detail-note" }, "No criteria on this ticket.") : /* @__PURE__ */ import_react17.default.createElement("ul", { className: "aidos-check-list" }, criteriaLines2.map((line) => /* @__PURE__ */ import_react17.default.createElement("li", { className: "aidos-check-row", key: line }, line))), /* @__PURE__ */ import_react17.default.createElement("div", { className: "aidos-form-actions" }, /* @__PURE__ */ import_react17.default.createElement(
    "button",
    {
      className: "aidos-btn aidos-btn-primary",
      onClick: () => {
    ...
    "Continue"
  ))) : /* @__PURE__ */ import_react17.default.createElement("div", { className: "aidos-modal-form" }, /* @__PURE__ */ import_react17.default.createElement("p", { className: "aidos-modal-body" }, "The evidence summary:"), summary.length === 0 ? /* @__PURE__ */ import_react17.default.createElement("p", { className: "aidos-detail-note" }, "No evidence rows yet.") : /* @__PURE__ */ import_react17.default.createElement("ul", { className: "aidos-check-list" }, summary.map((entry) => /* @__PURE__ */ import_react17.default.createElement("li", { className: "aidos-check-row", key: entry.kind }, entry.kind + ": " + entry.count))), /* @__PURE__ */ import_react17.default.createElement(
    NoteField,
    {
...
function DescriptionPanel(props) {
  const [editing, setEditing] = import_react18.default.useState(false);
  ...
  let body;
  if (editing) {
    body = /* @__PURE__ */ import_react18.default.createElement(import_react18.default.Fragment, null, /* @__PURE__ */ import_react18.default.createElement(
      "textarea",
      {
        value: draft,
        disabled: saving,
    ...
    ), /* @__PURE__ */ import_react18.default.createElement("div", { className: "aidos-form-actions" }, /* @__PURE__ */ import_react18.default.createElement(
      "button",
      {
        className: "aidos-btn aidos-btn-primary",
        disabled: saving,
    ...
    body = /* @__PURE__ */ import_react18.default.createElement("p", { className: "aidos-detail-note" }, "No description.");
  } else {
    body = /* @__PURE__ */ import_react18.default.createElement(import_react18.default.Fragment, null, /* @__PURE__ */ import_react18.default.createElement(
      "div",
      {
    ...
    ), long ? /* @__PURE__ */ import_react18.default.createElement(
      "button",
      {
  ...
  return /* @__PURE__ */ import_react18.default.createElement("details", { className: "aidos-panel", open: true }, /* @__PURE__ */ import_react18.default.createElement("summary", { className: "aidos-panel-head" }, /* @__PURE__ */ import_react18.default.createElement("span", { className: "aidos-panel-title" }, "Description"), /* @__PURE__ */ import_react18.default.createElement(
    "button",
    {
      className: "aidos-icon-btn",
      title: "Edit",
    ...
    /* @__PURE__ */ import_react18.default.createElement(PencilIcon, null)
  )), /* @__PURE__ */ import_react18.default.createElement("div", { className: "aidos-panel-body" }, body));
}
function CriterionEditor(props) {
  const [draft, setDraft] = import_react18.default.useState(props.line);
  return /* @__PURE__ */ import_react18.default.createElement("span", { className: "aidos-criterion-row" }, /* @__PURE__ */ import_react18.default.createElement(
    "input",
    {
      type: "text",
      value: draft,
  ...
  ), /* @__PURE__ */ import_react18.default.createElement("span", { className: "aidos-criterion-actions" }, /* @__PURE__ */ import_react18.default.createElement(
    "button",
    {
      className: "aidos-btn",
      disabled: props.saving,
...
function CriteriaPanel(props) {
  const [editingIndex, setEditingIndex] = import_react18.default.useState(null);
  const [saving, setSaving] = import_react18.default.useState(false);
  const [addDraft, setAddDraft] = import_react18.default.useState("");
  ...
  return /* @__PURE__ */ import_react18.default.createElement("details", { className: "aidos-panel" }, /* @__PURE__ */ import_react18.default.createElement("summary", { className: "aidos-panel-head" }, /* @__PURE__ */ import_react18.default.createElement("span", { className: "aidos-panel-title" }, "Criteria " + covered + "/" + lines.length)), /* @__PURE__ */ import_react18.default.createElement("div", { className: "aidos-panel-body" }, lines.length === 0 ? /* @__PURE__ */ import_react18.default.createElement("p", { className: "aidos-detail-note" }, "No criteria.") : /* @__PURE__ */ import_react18.default.createElement("ul", { className: "aidos-criteria" }, lines.map((line, index) => /* @__PURE__ */ import_react18.default.createElement(
    "li",
    {
      key: index + ":" + line,
      className: uncoveredSet.has(line) ? "aidos-criterion aidos-criterion-uncovered" : "aidos-criterion"
    },
    editingIndex === index ? /* @__PURE__ */ import_react18.default.createElement(
      CriterionEditor,
      {
        line,
        saving,
    ...
    ) : /* @__PURE__ */ import_react18.default.createElement("span", { className: "aidos-criterion-row" }, line, /* @__PURE__ */ import_react18.default.createElement("span", { className: "aidos-criterion-actions" }, /* @__PURE__ */ import_react18.default.createElement(
      "button",
      {
        className: "aidos-icon-btn",
        title: "Edit",
      ...
      /* @__PURE__ */ import_react18.default.createElement(TrashIcon, null)
    )))
  )), /* @__PURE__ */ import_react18.default.createElement("li", { className: "aidos-criteria-add" }, /* @__PURE__ */ import_react18.default.createElement(
    "input",
    {
      type: "text",
      value: addDraft,
...
function DependencyCard(props) {
  ...
  return /* @__PURE__ */ import_react18.default.createElement("div", { className: "aidos-dep-card" }, /* @__PURE__ */ import_react18.default.createElement("div", { className: "aidos-dep-card-main" }, /* @__PURE__ */ import_react18.default.createElement("span", { className: "aidos-chip aidos-chip-dep", title: ref }, displayDep(ref)), known !== void 0 ? /* @__PURE__ */ import_react18.default.createElement(import_react18.default.Fragment, null, /* @__PURE__ */ import_react18.default.createElement("span", { className: "aidos-dep-card-title", title: known.title }, known.title), /* @__PURE__ */ import_react18.default.createElement("span", { className: `aidos-chip aidos-chip-state-${known.state.replace(/\s+/g, "-")}` }, stateLabel(known.state))) : /* @__PURE__ */ import_react18.default.createElement("span", { className: "aidos-dep-card-title aidos-dep-card-unknown" }, "not on this board")), props.onJump !== void 0 ? /* @__PURE__ */ import_react18.default.createElement("button", { className: "aidos-btn aidos-dep-card-open", onClick: open, title: "Open " + ref }, "Open") : null);
}
function DependencySection(props) {
  const [query, setQuery] = import_react18.default.useState("");
  const [hits, setHits] = import_react18.default.useState(null);
  const [searching, setSearching] = import_react18.default.useState(false);
  const [adding, setAdding] = import_react18.default.useState(null);
  ...
  return /* @__PURE__ */ import_react18.default.createElement("details", { className: "aidos-panel" }, /* @__PURE__ */ import_react18.default.createElement("summary", { className: "aidos-panel-head" }, /* @__PURE__ */ import_react18.default.createElement("span", { className: "aidos-panel-title" }, "Dependencies")), /* @__PURE__ */ import_react18.default.createElement("div", { className: "aidos-panel-body" }, current.length === 0 ? /* @__PURE__ */ import_react18.default.createElement("p", { className: "aidos-detail-note" }, "No dependencies.") : /* @__PURE__ */ import_react18.default.createElement("div", { className: "aidos-dep-cards" }, current.map((ref) => /* @__PURE__ */ import_react18.default.createElement(
    DependencyCard,
    {
      key: ref,
      depRef: ref,
  ...
  ))), /* @__PURE__ */ import_react18.default.createElement("div", { className: "aidos-dep-search" }, /* @__PURE__ */ import_react18.default.createElement(
    "input",
    {
    ...
    "Search"
  )), hits !== null ? /* @__PURE__ */ import_react18.default.createElement("div", { className: "aidos-dep-results" }, hits.length === 0 ? /* @__PURE__ */ import_react18.default.createElement("p", { className: "aidos-detail-note" }, "No matches.") : hits.map((hit) => /* @__PURE__ */ import_react18.default.createElement(
    "button",
    {
      key: refOf(hit),
    ...
    /* @__PURE__ */ import_react18.default.createElement("span", { className: "aidos-suggestion-title" }, hit.title),
    /* @__PURE__ */ import_react18.default.createElement("span", { className: "aidos-chip aidos-chip-id" }, displayDep(refOf(hit)))
  ))) : null));
}
function EvidencePanel(props) {
  return /* @__PURE__ */ import_react18.default.createElement(
    ...
    /* @__PURE__ */ import_react18.default.createElement("summary", { className: "aidos-panel-head" }, /* @__PURE__ */ import_react18.default.createElement("span", { className: "aidos-panel-title" }, "Evidence")),
    /* @__PURE__ */ import_react18.default.createElement("div", { className: "aidos-panel-body" }, props.evidence.length === 0 ? /* @__PURE__ */ import_react18.default.createElement("p", { className: "aidos-detail-note" }, "No evidence rows yet.") : /* @__PURE__ */ import_react18.default.createElement("ul", { className: "aidos-evidence-list" }, props.evidence.map((row, index) => /* @__PURE__ */ import_react18.default.createElement(
      "li",
      {
      ...
      /* @__PURE__ */ import_react18.default.createElement(
        ...
        /* @__PURE__ */ import_react18.default.createElement("span", { className: "aidos-chip-key" }, kindKeyword(row.kind))
      ),
      /* @__PURE__ */ import_react18.default.createElement("span", { className: "aidos-evidence-author" }, row.author),
      typeof row.payload.criteria === "string" ? /* @__PURE__ */ import_react18.default.createElement("span", { className: "aidos-evidence-meta" }, "criterion: " + row.payload.criteria) : null,
      row.kind === "builtin:imported_state" && typeof row.payload.claimed_state === "string" ? /* @__PURE__ */ import_react18.default.createElement("span", { className: "aidos-evidence-meta" }, "plan claimed: " + row.payload.claimed_state) : null,
      /* @__PURE__ */ import_react18.default.createElement(
        "button",
        {
    ...
    ))), /* @__PURE__ */ import_react18.default.createElement(EvidenceAttach, { ticketId: props.ticketIdKey, agentId: props.agentId }))
  );
}
function DetailPanel(props) {
  const ticket = props.ticket;
  const badge = badgeClass(ticket.state);
  const [deletingAt, setDeletingAt] = import_react18.default.useState(null);
  ...
  return /* @__PURE__ */ import_react18.default.createElement(import_react18.default.Fragment, null, /* @__PURE__ */ import_react18.default.createElement("div", { className: "aidos-detail-head" }, /* @__PURE__ */ import_react18.default.createElement(
    FieldEditor,
    {
      field: "title",
  ...
  ), /* @__PURE__ */ import_react18.default.createElement("button", { className: "aidos-close-btn", onClick: props.onClose }, "\xD7")), /* @__PURE__ */ import_react18.default.createElement("div", { className: "aidos-detail-chips" }, /* @__PURE__ */ import_react18.default.createElement(
    "span",
    {
      className: "aidos-chip aidos-chip-id",
      style: { background: idColor(fullTicketId(ticket)) },
    ...
    ticketChipLabel(ticket)
  ), /* @__PURE__ */ import_react18.default.createElement("span", { className: badge }, stateLabel(ticket.state))), /* @__PURE__ */ import_react18.default.createElement("dl", { className: "aidos-facts" }, /* @__PURE__ */ import_react18.default.createElement("div", { className: "aidos-facts-row" }, /* @__PURE__ */ import_react18.default.createElement("dt", { className: "aidos-facts-label" }, "State"), /* @__PURE__ */ import_react18.default.createElement("dd", { className: "aidos-facts-value" }, stateLabel(ticket.state))), /* @__PURE__ */ import_react18.default.createElement("div", { className: "aidos-facts-row" }, /* @__PURE__ */ import_react18.default.createElement("dt", { className: "aidos-facts-label" }, "Gate"), /* @__PURE__ */ import_react18.default.createElement("dd", { className: "aidos-facts-value" }, formatGateFraction(ticket.gatePresent, ticket.gateTotal, hasCriteria(ticket)))), /* @__PURE__ */ import_react18.default.createElement("div", { className: "aidos-facts-row" }, /* @__PURE__ */ import_react18.default.createElement("dt", { className: "aidos-facts-label" }, "Confidence"), /* @__PURE__ */ import_react18.default.createElement("dd", { className: "aidos-facts-value" }, String(ringPercent(ticket.confidenceScore)) + "%", /* @__PURE__ */ import_react18.default.createElement(
    "span",
    {
    ...
    "*"
  ))), /* @__PURE__ */ import_react18.default.createElement("div", { className: "aidos-facts-row" }, /* @__PURE__ */ import_react18.default.createElement("dt", { className: "aidos-facts-label" }, "Phase"), /* @__PURE__ */ import_react18.default.createElement("dd", { className: "aidos-facts-value" }, String(ticket.phase))), /* @__PURE__ */ import_react18.default.createElement("div", { className: "aidos-facts-row" }, /* @__PURE__ */ import_react18.default.createElement("dt", { className: "aidos-facts-label" }, "Order"), /* @__PURE__ */ import_react18.default.createElement("dd", { className: "aidos-facts-value" }, String(ticket.order))), /* @__PURE__ */ import_react18.default.createElement("div", { className: "aidos-facts-row" }, /* @__PURE__ */ import_react18.default.createElement("dt", { className: "aidos-facts-label" }, "Slug"), /* @__PURE__ */ import_react18.default.createElement("dd", { className: "aidos-facts-value" }, ticket.slug))), /* @__PURE__ */ import_react18.default.createElement(
  ...
  ), props.actions, /* @__PURE__ */ import_react18.default.createElement(
    DescriptionPanel,
    {
      ticket,
...
function DetailView(props) {
  const [signoffOpen, setSignoffOpen] = import_react18.default.useState(false);
  const [verifyOpen, setVerifyOpen] = import_react18.default.useState(false);
  const [sendBackOpen, setSendBackOpen] = import_react18.default.useState(false);
  const [markDoneOpen, setMarkDoneOpen] = import_react18.default.useState(false);
  const [allowlistOpen, setAllowlistOpen] = import_react18.default.useState(false);
  const [viewingEvidence, setViewingEvidence] = import_react18.default.useState(null);
  const [submitting, setSubmitting] = import_react18.default.useState(false);
  const ticket = props.ticket;
  ...
  return /* @__PURE__ */ import_react18.default.createElement("div", { className: "aidos-detail" }, /* @__PURE__ */ import_react18.default.createElement(
    DetailPanel,
    {
      ticket,
      ticketIdKey: props.ticketIdKey,
      ...
      actions: /* @__PURE__ */ import_react18.default.createElement(
        ActionBar,
        {
          ticket,
          evidence: props.evidence,
  ...
  ), allowlistOpen ? /* @__PURE__ */ import_react18.default.createElement(
    AllowlistEditor,
    {
      open: true,
      ticketId: ticket.id,
  ...
  ), signoffOpen ? /* @__PURE__ */ import_react18.default.createElement(
    SignoffDialog,
    {
      open: true,
      ticketId: props.ticketIdKey,
  ...
  ) : null, verifyOpen ? /* @__PURE__ */ import_react18.default.createElement(
    VerifyModal,
    {
      ticketId: props.ticketIdKey,
      agentId,
  ...
  ) : null, sendBackOpen ? /* @__PURE__ */ import_react18.default.createElement(
    SendBackModal,
    {
      open: true,
      ticketId: props.ticketIdKey,
  ...
  ) : null, markDoneOpen ? /* @__PURE__ */ import_react18.default.createElement(
    MarkDoneModal,
    {
      open: true,
      ticketId: props.ticketIdKey,
...
function CreateTicketModal(props) {
  const [title, setTitle] = import_react19.default.useState("");
  const [description, setDescription] = import_react19.default.useState("");
  const [criteria, setCriteria] = import_react19.default.useState("");
  ...
  return /* @__PURE__ */ import_react19.default.createElement(
    ...
    /* @__PURE__ */ import_react19.default.createElement(
      ...
      /* @__PURE__ */ import_react19.default.createElement("div", { className: "aidos-modal-head" }, /* @__PURE__ */ import_react19.default.createElement("h3", { className: "aidos-modal-title" }, "Create a ticket"), /* @__PURE__ */ import_react19.default.createElement(
        "button",
        {
          className: "aidos-close-btn",
          onClick: () => {
      ...
      /* @__PURE__ */ import_react19.default.createElement("div", { className: "aidos-modal-form" }, /* @__PURE__ */ import_react19.default.createElement("div", { className: "aidos-modal-row" }, /* @__PURE__ */ import_react19.default.createElement("label", null, "Title"), /* @__PURE__ */ import_react19.default.createElement(
        "input",
        {
          type: "text",
          value: title,
      ...
      )), /* @__PURE__ */ import_react19.default.createElement("div", { className: "aidos-modal-row" }, /* @__PURE__ */ import_react19.default.createElement("label", null, "Description"), /* @__PURE__ */ import_react19.default.createElement(
        "textarea",
        {
          value: description,
          disabled: saving,
      ...
      )), /* @__PURE__ */ import_react19.default.createElement("div", { className: "aidos-modal-row" }, /* @__PURE__ */ import_react19.default.createElement("label", null, "Criteria"), /* @__PURE__ */ import_react19.default.createElement(
        "textarea",
        {
          value: criteria,
          disabled: saving,
...
function PlanMetaModal(props) {
  const [editing, setEditing] = import_react20.default.useState(null);
  const [draft, setDraft] = import_react20.default.useState("");
  const [saving, setSaving] = import_react20.default.useState(false);
  const [expanded, setExpanded] = import_react20.default.useState([]);
  ...
  function renderEditControls(key) {
    ...
    ), /* @__PURE__ */ import_react20.default.createElement("div", { className: "aidos-plan-meta-actions" }, /* @__PURE__ */ import_react20.default.createElement(
      "button",
      {
        className: "aidos-btn aidos-btn-primary",
        disabled: saving,
  ...
  function renderNamedBlock(key, label, text) {
    return /* @__PURE__ */ import_react20.default.createElement("div", { className: "aidos-plan-meta-block", key }, /* @__PURE__ */ import_react20.default.createElement("div", { className: "aidos-plan-meta-block-head" }, /* @__PURE__ */ import_react20.default.createElement("span", { className: "aidos-plan-meta-block-title" }, label), /* @__PURE__ */ import_react20.default.createElement(
      "button",
      {
        className: "aidos-btn",
        disabled: saving,
      ...
      "Edit"
    )), editing === key ? renderEditControls(key) : /* @__PURE__ */ import_react20.default.createElement("pre", { className: "aidos-plan-meta-text" }, text === "" ? "(empty)" : text));
  }
  function renderSectionBlock(position, heading, text) {
    const open = expanded.includes(position);
    return /* @__PURE__ */ import_react20.default.createElement("div", { className: "aidos-plan-meta-block", key: position }, /* @__PURE__ */ import_react20.default.createElement("div", { className: "aidos-plan-meta-block-head" }, /* @__PURE__ */ import_react20.default.createElement(
      "button",
      {
      ...
      /* @__PURE__ */ import_react20.default.createElement("span", { "aria-hidden": "true" }, open ? "\u25BE" : "\u25B8"),
      heading
    ), /* @__PURE__ */ import_react20.default.createElement(
      "button",
      {
      ...
      "Edit"
    )), editing === position || open ? editing === position ? renderEditControls(position) : /* @__PURE__ */ import_react20.default.createElement("pre", { className: "aidos-plan-meta-text" }, text === "" ? "(empty)" : text) : null);
  }
  ...
  return /* @__PURE__ */ import_react20.default.createElement(
    ...
    /* @__PURE__ */ import_react20.default.createElement(
      ...
      /* @__PURE__ */ import_react20.default.createElement("div", { className: "aidos-modal-head" }, /* @__PURE__ */ import_react20.default.createElement("h3", { className: "aidos-modal-title" }, "Plan"), /* @__PURE__ */ import_react20.default.createElement(
        "button",
        {
          className: "aidos-close-btn",
          onClick: () => {
      ...
      meta === null ? /* @__PURE__ */ import_react20.default.createElement("p", { className: "aidos-plan-meta-note" }, "This project holds no plan yet.") : /* @__PURE__ */ import_react20.default.createElement("div", { className: "aidos-plan-meta-blocks" }, renderNamedBlock("frontmatter", "Frontmatter", meta.frontmatter), renderNamedBlock("preamble", "Preamble", meta.preamble), meta.contextSections.map(
...
function ToastRow(props) {
  ...
  return /* @__PURE__ */ import_react21.default.createElement("div", { className: "aidos-toast aidos-toast-" + toast.kind }, /* @__PURE__ */ import_react21.default.createElement("span", { className: "aidos-toast-text" }, toast.text), /* @__PURE__ */ import_react21.default.createElement(
    "button",
    {
...
function ToastContainer() {
  const [toasts2, setToasts] = import_react21.default.useState([]);
  ...
  return /* @__PURE__ */ import_react21.default.createElement("div", { className: "aidos-toast-stack" }, toasts2.map(function(toast) {
    return /* @__PURE__ */ import_react21.default.createElement(ToastRow, { key: toast.id, toast });
  }));
}
...
function LocalTicketView(props) {
  const [retryNonce, setRetryNonce] = import_react22.default.useState(0);
  import_react22.default.useEffect(function() {
...
function ProjectionReader(props) {
  ...
  const [merge, setMergeState] = import_react22.default.useState(() => getMerge(sessionId));
  const [mergePending, setMergePending] = import_react22.default.useState(() => isMergePulling(sessionId) && getMerge(sessionId) === null);
  ...
  const [applied, setAppliedStateLocal] = import_react22.default.useState(function() {
    return cloneAppliedState(DEFAULT_APPLIED);
  });
  const [selectedKey, setSelectedKey] = import_react22.default.useState(null);
  const [createOpen, setCreateOpen] = import_react22.default.useState(false);
  const [planOpen, setPlanOpen] = import_react22.default.useState(false);
  const [errorTimedOut, setErrorTimedOut] = import_react22.default.useState(false);
  const deepLinkHandled = import_react22.default.useRef(false);
  const restoredRef = import_react22.default.useRef(false);
  const layoutRef = import_react22.default.useRef(null);
  ...
  const error = errorTimedOut && !loaded ? /* @__PURE__ */ import_react22.default.createElement("div", { className: "aidos-error" }, /* @__PURE__ */ import_react22.default.createElement("span", null, "The board projection is unavailable. Retry to re-read it."), /* @__PURE__ */ import_react22.default.createElement("button", { className: "aidos-btn", onClick: props.onRetry }, "Retry")) : null;
  ...
  const [evidenceCollapsed, setEvidenceCollapsed] = import_react22.default.useState(function() {
  ...
  const detailPanel = selectedTicket === null ? null : /* @__PURE__ */ import_react22.default.createElement(
    DetailView,
    {
  ...
  const createModal = /* @__PURE__ */ import_react22.default.createElement(
    CreateTicketModal,
    {
      open: createOpen,
      onClose: () => {
  ...
  if (error !== null) {
    ...
    body = /* @__PURE__ */ import_react22.default.createElement("div", { className: "aidos-skeleton-grid" }, [0, 1, 2, 3, 4, 5].map((index) => /* @__PURE__ */ import_react22.default.createElement("div", { className: "aidos-skeleton-tile", key: index })));
  } else if (mergeLoading) {
    body = /* @__PURE__ */ import_react22.default.createElement("div", { className: "aidos-merge-loading", role: "status" }, /* @__PURE__ */ import_react22.default.createElement("span", { className: "aidos-merge-spinner", "aria-hidden": "true" }), /* @__PURE__ */ import_react22.default.createElement("span", null, "Loading workspace tickets\u2026"));
  } else {
    body = /* @__PURE__ */ import_react22.default.createElement(
      TicketView,
      {
        sessionId,
        tickets: filtered,
  ...
  const planModal = /* @__PURE__ */ import_react22.default.createElement(
    PlanMetaModal,
    {
      open: planOpen,
  ...
  return /* @__PURE__ */ import_react22.default.createElement(import_react22.default.Fragment, null, /* @__PURE__ */ import_react22.default.createElement("div", { className: "aidos-layout", ref: layoutRef, "data-conversation-composer-overlay": "" }, body, detailPanel), createModal, planModal, /* @__PURE__ */ import_react22.default.createElement(ToastContainer, null));
}
