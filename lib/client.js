...
function AidosRow(props) {
  ...
  const [activationNotice, setActivationNotice] = import_react29.default.useState(null);
  ...
  return /* @__PURE__ */ import_react29.default.createElement("div", { className: "tool-render-card", "data-error": props.state === "error" || void 0 }, /* @__PURE__ */ import_react29.default.createElement(
    ...
    /* @__PURE__ */ import_react29.default.createElement(ToolRenderChevron, { open, disabled: !expandable }),
    /* @__PURE__ */ import_react29.default.createElement("span", { className: "tool-render-name-badge", style: nameBadgeColors(props.title, props.state === "error") }, /* @__PURE__ */ import_react29.default.createElement("span", { className: "tool-render-name-badge-icon" }, props.icon), /* @__PURE__ */ import_react29.default.createElement("span", { className: "tool-render-name-badge-text", title: props.title, "data-dsh-tip": "" }, props.title)),
  ...
  ), open ? /* @__PURE__ */ import_react29.default.createElement("div", { className: "tool-render-body" }, body, footer !== null ? /* @__PURE__ */ import_react29.default.createElement("div", { className: "aidos-tool-footer" }, footer) : null) : null, peekOpen ? /* @__PURE__ */ import_react29.default.createElement(ModalShell, { title: "Ticket", onClose: () => setPeekOpen(false) }, peeked !== null ? /* @__PURE__ */ import_react29.default.createElement(import_react29.default.Fragment, null, /* @__PURE__ */ import_react29.default.createElement(TicketStrip, { ticket: peeked }), peeked.descriptionFull !== void 0 ? /* @__PURE__ */ import_react29.default.createElement(
    "div",
    {
      className: "aidos-md aidos-ticket-peek-description",
      dangerouslySetInnerHTML: { __html: renderMarkdownSafe(peeked.descriptionFull) }
    }
  ) : null, /* @__PURE__ */ import_react29.default.createElement("div", { className: "aidos-ticket-peek-actions" }, canSelect ? /* @__PURE__ */ import_react29.default.createElement(
    "button",
    {
      type: "button",
      className: "tool-render-approval-btn tool-render-approval-approve",
    ...
    /* @__PURE__ */ import_react29.default.createElement(PopOutIcon, null),
    " Open on board"
  ) : null), activationNotice !== null ? /* @__PURE__ */ import_react29.default.createElement("p", { className: "aidos-ticket-peek-note", role: "status" }, activationNotice) : null) : /* @__PURE__ */ import_react29.default.createElement("p", { className: "aidos-ticket-peek-empty" }, "#" + (props.ticketId ?? "?") + " isn't in this session's own board yet, or belongs to another session. Open the Tickets tab to look it up there.")) : null);
}
function Facts({ facts }) {
  if (facts.length === 0) return null;
  return /* @__PURE__ */ import_react29.default.createElement("dl", { className: "aidos-tool-facts" }, facts.map((fact, index) => (
    /*
     ...
     */
    /* @__PURE__ */ import_react29.default.createElement(import_react29.default.Fragment, { key: fact.label + ":" + index }, /* @__PURE__ */ import_react29.default.createElement("dt", null, fact.label), /* @__PURE__ */ import_react29.default.createElement(FactValue, { fact }))
  )));
}
function FactValue({ fact }) {
  const expandable = fact.full !== void 0 && fact.full !== "";
  if (!expandable) {
    return /* @__PURE__ */ import_react29.default.createElement("dd", { title: fact.value, "data-dsh-tip": "" }, fact.value);
  }
  return /* @__PURE__ */ import_react29.default.createElement(ExpandableValue, { fact, as: "dd" });
}
function ExpandableValue({ fact, as }) {
  const [expanded, setExpanded] = import_react29.default.useState(fact.open === true);
  const Wrapper = as;
  return /* @__PURE__ */ import_react29.default.createElement(
    ...
    expanded ? /* @__PURE__ */ import_react29.default.createElement(ExpandedFact, { fact }) : /* @__PURE__ */ import_react29.default.createElement("span", { className: "aidos-tool-fact-clipped", title: fact.value, "data-dsh-tip": "" }, fact.value),
    /* @__PURE__ */ import_react29.default.createElement(
      "button",
      {
...
function ListValue({ fact }) {
  if (fact.full === void 0 || fact.full === "") {
    return /* @__PURE__ */ import_react29.default.createElement("span", { className: "aidos-tool-list-text", title: fact.value, "data-dsh-tip": "" }, fact.value);
  }
  return (
    /*
     ...
     */
    /* @__PURE__ */ import_react29.default.createElement("span", { className: "aidos-tool-list-text aidos-tool-list-value" }, /* @__PURE__ */ import_react29.default.createElement(ExpandableValue, { fact, as: "span" }))
  );
}
function ExpandedFact({ fact }) {
  const text = fact.full ?? fact.value;
  if (fact.markdown !== true) {
    return /* @__PURE__ */ import_react29.default.createElement("span", { className: "aidos-tool-fact-full" }, text);
  }
  return /* @__PURE__ */ import_react29.default.createElement(
    "div",
    {
...
function FactsStack({
  ...
  return /* @__PURE__ */ import_react29.default.createElement("div", { className: "aidos-tool-stack" }, tables.map((table) => /* @__PURE__ */ import_react29.default.createElement("section", { className: "aidos-tool-table", key: table.id }, /* @__PURE__ */ import_react29.default.createElement(
    TicketCaption,
    {
      id: table.id,
      state: table.state,
  ...
  ), /* @__PURE__ */ import_react29.default.createElement(Facts, { facts: table.facts }))));
}
function TicketCaption({
  ...
  return /* @__PURE__ */ import_react29.default.createElement("header", { className: "aidos-tool-table-head" }, onSelect !== void 0 ? /* @__PURE__ */ import_react29.default.createElement(
    "button",
    {
    ...
    "#" + id
  ) : /* @__PURE__ */ import_react29.default.createElement("span", { className: "aidos-tool-table-id" }, "#" + id), state === "" ? null : /* @__PURE__ */ import_react29.default.createElement("span", { className: "aidos-tool-list-tag" }, state), /* @__PURE__ */ import_react29.default.createElement("span", { className: "aidos-tool-table-title", title, "data-dsh-tip": "" }, title));
}
function ticketCaption(result) {
  const caption = ticketCaptionOf(result);
  if (caption === null) return null;
  return /* @__PURE__ */ import_react29.default.createElement(TicketCaption, { id: caption.id, state: caption.state, title: caption.title });
}
...
function fallbackBody(resultText) {
  return resultText === null || resultText === "" ? null : /* @__PURE__ */ import_react29.default.createElement(TextBody, { text: resultText, isError: false });
}
function AttachEvidenceRow(props) {
  ...
  return /* @__PURE__ */ import_react29.default.createElement(
    AidosRow,
    {
      icon: /* @__PURE__ */ import_react29.default.createElement(SignoffIcon, null),
      title: "Evidence",
...
function MoveTicketRow(props) {
  ...
  const body = errorText2 !== null && errorText2 !== "" ? errorBody(errorText2) : facts.length > 0 ? /* @__PURE__ */ import_react29.default.createElement(Facts, { facts }) : result === null ? fallbackBody(resultText) : null;
  const parts = moveTicketSummary(label, to, stateLabel);
  const summaryNode = parts.state === null ? void 0 : /* @__PURE__ */ import_react29.default.createElement(import_react29.default.Fragment, null, /* @__PURE__ */ import_react29.default.createElement("span", { className: "aidos-move-title", title: label ?? parts.title, "data-dsh-tip": "" }, parts.title), /* @__PURE__ */ import_react29.default.createElement("span", { className: "aidos-move-arrow", "aria-hidden": "true" }, "\u2192"), /* @__PURE__ */ import_react29.default.createElement("span", { className: badgeClass(parts.state) }, stateLabel(parts.state)));
  return /* @__PURE__ */ import_react29.default.createElement(
    AidosRow,
    {
...
function GetTicketRow(props) {
  ...
  const body = errorText2 !== null && errorText2 !== "" ? errorBody(errorText2) : facts.length === 0 && evidence.length === 0 ? result === null ? fallbackBody(resultText) : null : /* @__PURE__ */ import_react29.default.createElement(import_react29.default.Fragment, null, ticketCaption(result), /* @__PURE__ */ import_react29.default.createElement(Facts, { facts }), evidence.length > 0 ? /* @__PURE__ */ import_react29.default.createElement("ul", { className: "aidos-evidence-list" }, evidence.map((row, index) => /* @__PURE__ */ import_react29.default.createElement(
    EvidenceStrip,
    {
      key: index,
      row: {
  ...
  return /* @__PURE__ */ import_react29.default.createElement(
    AidosRow,
    {
      icon: /* @__PURE__ */ import_react29.default.createElement(CompassIcon, null),
      title: "Read ticket",
...
function GetTicketsRow(props) {
  ...
  const body = errorText2 !== null && errorText2 !== "" ? errorBody(errorText2) : tables.length === 0 ? result === null ? fallbackBody(resultText) : null : /* @__PURE__ */ import_react29.default.createElement(
    FactsStack,
    {
      tables,
  ...
  return /* @__PURE__ */ import_react29.default.createElement(
    AidosRow,
    {
      icon: /* @__PURE__ */ import_react29.default.createElement(KeyholeIcon, null),
      title: "Read board",
      summary,
      state,
      body,
...
function RequestAllowlistRow(props) {
  ...
  const body = errorText2 !== null && errorText2 !== "" ? errorBody(errorText2) : paths.length === 0 ? null : /* @__PURE__ */ import_react29.default.createElement(Facts, { facts: paths });
  return /* @__PURE__ */ import_react29.default.createElement(
    AidosRow,
    {
      icon: /* @__PURE__ */ import_react29.default.createElement(AllowlistIcon, null),
...
function SuggestActionsRow(props) {
  ...
  const body = errorText2 !== null && errorText2 !== "" ? errorBody(errorText2) : lines.length === 0 ? null : /* @__PURE__ */ import_react29.default.createElement("ul", { className: "aidos-tool-list" }, lines.map((line) => /* @__PURE__ */ import_react29.default.createElement("li", { key: line.ticketId + ":" + line.actionId }, /* @__PURE__ */ import_react29.default.createElement("span", { className: "aidos-tool-list-key" }, "#", line.ticketId), /* @__PURE__ */ import_react29.default.createElement("span", { className: "aidos-tool-list-tag" }, line.actionId), /* @__PURE__ */ import_react29.default.createElement(ListValue, { fact: expandableFact("reason", line.reason) }))));
  return /* @__PURE__ */ import_react29.default.createElement(
    AidosRow,
    {
      icon: /* @__PURE__ */ import_react29.default.createElement(AlertCircleIcon, null),
...
function PlanRow(props) {
  ...
  return /* @__PURE__ */ import_react29.default.createElement(
    AidosRow,
    {
      icon: /* @__PURE__ */ import_react29.default.createElement(PopOutIcon, null),
      title: "Export plan",
      summary,
      state,
...
function GetEvidenceRow(props) {
  ...
  const body = errorText2 !== null && errorText2 !== "" ? errorBody(errorText2) : records.length === 0 && comments.length === 0 ? result === null ? fallbackBody(resultText) : null : /* @__PURE__ */ import_react29.default.createElement(import_react29.default.Fragment, null, /* @__PURE__ */ import_react29.default.createElement("ul", { className: "aidos-evidence-list" }, records.map((row) => /* @__PURE__ */ import_react29.default.createElement(
    EvidenceStrip,
    {
  ...
  ))), comments.map((comment, position) => /* @__PURE__ */ import_react29.default.createElement("div", { className: "aidos-comment", key: position }, /* @__PURE__ */ import_react29.default.createElement("div", null, /* @__PURE__ */ import_react29.default.createElement("span", { className: "aidos-evidence-author" }, comment.author)), /* @__PURE__ */ import_react29.default.createElement("p", { className: "aidos-detail-body" }, comment.body))));
  return /* @__PURE__ */ import_react29.default.createElement(
    AidosRow,
    {
      icon: /* @__PURE__ */ import_react29.default.createElement(CompassIcon, null),
