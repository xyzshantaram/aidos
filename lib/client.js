...
/* The primary keeps one width so two open rows agree, but nothing depends
   on it any more -- only one row is open at a time. */
.aidos-ticket-strip-actionrow .aidos-btn-primary {
  min-width: 7.5rem;
  justify-content: center;
}
...
.tool-render-body > .aidos-evidence-strips {
  margin: 0.25rem 0 0.25rem 0.25rem;
}
`;
...
function Leading({ state, open }) {
  if (open) return /* @__PURE__ */ import_react28.default.createElement(import_react28.default.Fragment, null, "\u25BE");
...
function AidosRow(props) {
  ...
  const expandable = body !== null;
  const open = expanded && expandable;
  const showsError = props.state === "error" && props.errorSummary !== void 0;
  ...
  return /* @__PURE__ */ import_react29.default.createElement("div", { className: "tool-render-card", "data-error": props.state === "error" || void 0 }, /* @__PURE__ */ import_react29.default.createElement(
    ...
    /* @__PURE__ */ import_react29.default.createElement("span", { className: "tool-render-leading", "aria-hidden": "true" }, open ? "\u25BE" : props.state === "error" || props.state === "stopped" ? "\u25CF" : "\u25B8"),
    ...
    select !== void 0 && !showsError ? /* @__PURE__ */ import_react29.default.createElement(
      "span",
      {
      ...
      shown
    ) : /* @__PURE__ */ import_react29.default.createElement("span", { className: "tool-render-summary", "tool-render-error": showsError ? true : void 0 }, shown)
  ), open ? /* @__PURE__ */ import_react29.default.createElement("div", { className: "tool-render-body" }, body) : null);
}
function Facts({ facts }) {
  if (facts.length === 0) return null;
  return /* @__PURE__ */ import_react29.default.createElement("dl", { className: "aidos-tool-facts" }, facts.map((fact) => /* @__PURE__ */ import_react29.default.createElement(import_react29.default.Fragment, { key: fact.label }, /* @__PURE__ */ import_react29.default.createElement("dt", null, fact.label), /* @__PURE__ */ import_react29.default.createElement("dd", { title: fact.value }, fact.value))));
}
...
function errorBody(errorText2) {
  return errorText2 === null || errorText2 === "" ? null : /* @__PURE__ */ import_react29.default.createElement(TextBody, { text: errorText2, isError: true });
}
function useAidosRow(props) {
  ...
  const errorText2 = state === "error" ? errorTextOf(props.block) : null;
  const errorSummary = errorText2 !== null && errorText2 !== "" ? firstLineOfError(errorText2) : void 0;
  return { args, state, result, ticketId, errorText: errorText2, errorSummary };
}
function AttachEvidenceRow(props) {
  ...
  const body = state === "error" ? errorBody(errorText2) : kind !== void 0 ? /* @__PURE__ */ import_react29.default.createElement("ul", { className: "aidos-evidence-strips" }, /* @__PURE__ */ import_react29.default.createElement(
    EvidenceStrip,
    {
      row: {
...
function MoveTicketRow(props) {
  ...
  const body = state === "error" ? errorBody(errorText2) : facts.length > 0 ? /* @__PURE__ */ import_react29.default.createElement(Facts, { facts }) : null;
  return /* @__PURE__ */ import_react29.default.createElement(
    AidosRow,
    {
      title: "Move ticket",
...
function SetTicketRow(props) {
  ...
  const body = state === "error" ? errorBody(errorText2) : fields.length > 0 ? /* @__PURE__ */ import_react29.default.createElement(Facts, { facts: fields }) : null;
  return /* @__PURE__ */ import_react29.default.createElement(
    AidosRow,
    {
...
function GetTicketRow(props) {
  ...
  const body = state === "error" ? errorBody(errorText2) : facts.length === 0 && evidence.length === 0 ? null : /* @__PURE__ */ import_react29.default.createElement(import_react29.default.Fragment, null, /* @__PURE__ */ import_react29.default.createElement(Facts, { facts }), evidence.length > 0 ? /* @__PURE__ */ import_react29.default.createElement("ul", { className: "aidos-evidence-strips" }, evidence.map((row, index) => /* @__PURE__ */ import_react29.default.createElement(
    EvidenceStrip,
    {
      key: index,
      row: {
...
function GetTicketsRow(props) {
  ...
  const body = state === "error" ? errorBody(errorText2) : lines.length === 0 ? null : /* @__PURE__ */ import_react29.default.createElement("ul", { className: "aidos-tool-list" }, lines.map((line) => /* @__PURE__ */ import_react29.default.createElement("li", { key: line.id }, /* @__PURE__ */ import_react29.default.createElement("span", { className: "aidos-tool-list-key" }, "#", line.id), line.state === "" ? null : /* @__PURE__ */ import_react29.default.createElement("span", { className: "aidos-tool-list-tag" }, line.state), /* @__PURE__ */ import_react29.default.createElement("span", { className: "aidos-tool-list-text", title: line.title }, line.title))));
  return /* @__PURE__ */ import_react29.default.createElement(
    AidosRow,
    {
...
function RequestAllowlistRow(props) {
  ...
  const body = state === "error" ? errorBody(errorText2) : paths.length === 0 ? null : /* @__PURE__ */ import_react29.default.createElement("ul", { className: "aidos-tool-list" }, paths.map((entry) => /* @__PURE__ */ import_react29.default.createElement("li", { key: entry.path }, /* @__PURE__ */ import_react29.default.createElement("span", { className: "aidos-tool-list-text" }, entry.path), entry.created ? /* @__PURE__ */ import_react29.default.createElement("span", { className: "aidos-tool-list-tag", title: "Does not exist yet; approving creates it" }, "will be created") : null)));
  return /* @__PURE__ */ import_react29.default.createElement(
    AidosRow,
    {
...
function SuggestActionsRow(props) {
  ...
  const body = state === "error" ? errorBody(errorText2) : lines.length === 0 ? null : /* @__PURE__ */ import_react29.default.createElement("ul", { className: "aidos-tool-list" }, lines.map((line) => /* @__PURE__ */ import_react29.default.createElement("li", { key: line.ticketId + ":" + line.actionId }, /* @__PURE__ */ import_react29.default.createElement("span", { className: "aidos-tool-list-key" }, "#", line.ticketId), /* @__PURE__ */ import_react29.default.createElement("span", { className: "aidos-tool-list-tag" }, line.actionId), /* @__PURE__ */ import_react29.default.createElement("span", { className: "aidos-tool-list-text", title: line.reason }, line.reason))));
  return /* @__PURE__ */ import_react29.default.createElement(
    AidosRow,
    {
...
function PlanRow(props) {
  const { args, state, errorText: errorText2, errorSummary } = useAidosRow(props);
  const text = state === "error" ? errorText2 : resultTextOf(props.block);
  ...
  return /* @__PURE__ */ import_react29.default.createElement(
    AidosRow,
    {
      ...
      summary,
      state,
      body: text === null || text === "" ? null : /* @__PURE__ */ import_react29.default.createElement(TextBody, { text, isError: state === "error" }),
      errorSummary
    }
  );
}
...
function PlanMetaSetRow(props) {
  ...
  const body = state === "error" ? errorBody(errorText2) : written.length > 0 ? /* @__PURE__ */ import_react29.default.createElement(Facts, { facts: written }) : null;
  return /* @__PURE__ */ import_react29.default.createElement(
    AidosRow,
    {
