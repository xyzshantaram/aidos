...
.aidos-tile-meta {
  ...
  gap: 6px;
  min-width: 0;
  /* The chevron joined the row's head, so space-between would spread its
     gap across every chip. The row starts at the left and only the last
     child (the state chip) pushes to the far edge. */
  justify-content: flex-start;
}

.aidos-tile-meta > :last-child {
  margin-left: auto;
}

/* The tile's persistent chevron: same grammar as the tool-render rows --
   always visible, rotating when this tile is the one whose detail is open. */
.aidos-tile-chevron {
  display: inline-flex;
  align-items: center;
  flex: none;
...
/* The strip row's persistent chevron: same grammar as the tiles and the
   tool-render rows -- always visible, rotating when the row's actions are
   expanded. */
.aidos-ticket-strip-chevron {
  display: inline-flex;
  align-items: center;
  flex: none;
}
...
function TicketTile(props) {
  ...
  return /* @__PURE__ */ import_react4.default.createElement("button", { className, onClick: props.onSelect }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "aidos-tile-meta" }, /* @__PURE__ */ import_react4.default.createElement("span", { className: "aidos-tile-chevron" }, /* @__PURE__ */ import_react4.default.createElement(ChevronIcon, { open: props.selected })), /* @__PURE__ */ import_react4.default.createElement(
    "span",
    {
      className: "aidos-chip aidos-chip-id",
      style: { ["--chip-hue"]: idColor(fullTicketId(ticket)) },
...
function TicketStrip(props) {
  ...
  return /* @__PURE__ */ import_react17.default.createElement("li", { className }, /* @__PURE__ */ import_react17.default.createElement("div", { className: "aidos-ticket-strip-main" }, /* @__PURE__ */ import_react17.default.createElement("span", { className: "aidos-ticket-strip-chevron" }, /* @__PURE__ */ import_react17.default.createElement(ChevronIcon, { open: props.expanded === true })), /* @__PURE__ */ import_react17.default.createElement("span", { className: "aidos-ticket-strip-idcol" }, /* @__PURE__ */ import_react17.default.createElement(
    "span",
    {
      className: "aidos-chip aidos-chip-id",
