...
function planImportSummary(file, imported) {
  if (imported === void 0) return file;
  return file + " \xB7 " + imported + (imported === 1 ? " ticket" : " tickets");
}
...
function PlanImportRow(props) {
  ...
  return /* @__PURE__ */ import_react29.default.createElement(
    AidosRow,
    {
      icon: /* @__PURE__ */ import_react29.default.createElement(PopOutIcon, null),
      title: "Import plan",
      summary: planImportSummary(file, typeof imported === "number" ? imported : void 0),
      state,
      body,
      errorSummary
    }
