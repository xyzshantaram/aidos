...
function QueuePanel(props) {
  ...
  const [runningKey, setRunningKey] = import_react25.default.useState(
  ...
  const [activeTab, setActiveTab] = import_react25.default.useState(null);
  const [armedDismiss, setArmedDismiss] = import_react25.default.useState(null);
  ...
  return /* @__PURE__ */ import_react25.default.createElement("div", { className: "aidos-queue" }, /* @__PURE__ */ import_react25.default.createElement("div", { className: "aidos-queue-head" }, /* @__PURE__ */ import_react25.default.createElement("span", { className: "aidos-queue-count" }, visible.length + (visible.length === 1 ? " ask" : " asks"), suggested > 0 ? " \xB7 " + suggested + " suggested by the agent" : ""), /* @__PURE__ */ import_react25.default.createElement("label", { className: "aidos-queue-sort" }, /* @__PURE__ */ import_react25.default.createElement("span", null, "Sort"), /* @__PURE__ */ import_react25.default.createElement(
    ...
    /* @__PURE__ */ import_react25.default.createElement("span", { className: "aidos-queue-tab-icon", "aria-hidden": "true" }, ACTION_ICONS[QUEUE_TAB_ICON_ACTION[tab.id]]?.icon),
    /* @__PURE__ */ import_react25.default.createElement("span", { className: "aidos-queue-tab-label" }, tab.label),
    /* @__PURE__ */ import_react25.default.createElement("span", { className: "aidos-queue-tab-count" }, tab.entries.length)
  ))), active.entries.length === 0 ? /* @__PURE__ */ import_react25.default.createElement("p", { className: "aidos-queue-empty" }, QUEUE_TAB_EMPTY[active.id]) : /* @__PURE__ */ import_react25.default.createElement("ul", { className: "aidos-ticket-strips", role: "tabpanel" }, active.entries.map((entry) => /* @__PURE__ */ import_react25.default.createElement(
    TicketStrip,
    {
      showState: false,
      key: entryKey(entry),
  ...
  ))), running !== null && running.actionId === "verify" && running.approvalId === void 0 ? /* @__PURE__ */ import_react25.default.createElement(
    VerifyModal,
    {
...
function ProjectionReader(props) {
  ...
  const useStoredModal = function(modal) {
    const [value, setValue] = import_react27.default.useState(() => isModalOpen(sessionId, modal));
    const set = function(open) {
...
function Leading({ state, open }) {
  void state;
  return /* @__PURE__ */ import_react28.default.createElement(ToolRenderChevron, { open });
}
function ScratchRow({
  title,
  icon,
  ...
  return /* @__PURE__ */ import_react28.default.createElement(
    ...
    /* @__PURE__ */ import_react28.default.createElement(
      ...
      expandable ? /* @__PURE__ */ import_react28.default.createElement(Leading, { state, open }) : null,
      /* @__PURE__ */ import_react28.default.createElement("span", { className: "tool-render-name-badge", style: nameBadgeColors(title, state === "error") }, /* @__PURE__ */ import_react28.default.createElement("span", { className: "tool-render-name-badge-icon" }, icon), /* @__PURE__ */ import_react28.default.createElement("span", { className: "tool-render-name-badge-text", title, "data-dsh-tip": "" }, title)),
      /* @__PURE__ */ import_react28.default.createElement("span", { className: "tool-render-sep", "aria-hidden": "true" }),
      linked ? /* @__PURE__ */ import_react28.default.createElement(
        "span",
        {
    ...
    open ? /* @__PURE__ */ import_react28.default.createElement("div", { className: "tool-render-body" }, body, inspect !== void 0 ? /* @__PURE__ */ import_react28.default.createElement("button", { type: "button", className: "tool-render-inspect", onClick: inspect }, /* @__PURE__ */ import_react28.default.createElement(InspectIcon, null), "Inspect") : null) : null
  );
}
...
function writeBody(content, path) {
  return /* @__PURE__ */ import_react28.default.createElement("div", { className: "tool-render-write" }, /* @__PURE__ */ import_react28.default.createElement("div", { className: "tool-render-write-note" }, "No earlier version on record; new content below"), codeBlock(numberedReadRows(content, 1), path));
}
function ScratchReadRow(props) {
  ...
  return /* @__PURE__ */ import_react28.default.createElement(ScratchRow, { ...row, icon: /* @__PURE__ */ import_react28.default.createElement(CompassIcon, null), title: "Scratch read", body });
}
function ScratchWriteRow(props) {
  ...
  return /* @__PURE__ */ import_react28.default.createElement(ScratchRow, { ...row, icon: /* @__PURE__ */ import_react28.default.createElement(PencilIcon, null), title: "Scratch write", body });
}
...
+ ${newText ?? ""}` : unwrapScratchResult(resultTextOf(props.block));
  ...
  return /* @__PURE__ */ import_react28.default.createElement(
    ...
    {
      ...row,
      icon: /* @__PURE__ */ import_react28.default.createElement(PencilIcon, null),
      title: "Scratch edit",
...
function ScratchMkdirRow(props) {
  ...
  return /* @__PURE__ */ import_react28.default.createElement(
    ...
    {
      ...row,
      icon: /* @__PURE__ */ import_react28.default.createElement(ForkIcon, null),
      title: "Scratch mkdir",
...
function InlineTicketAction(props) {
  const [open, setOpen] = import_react29.default.useState(null);
  const [checking, setChecking] = import_react29.default.useState(false);
  function activate() {
  ...
  ), open === "signoff" ? /* @__PURE__ */ import_react29.default.createElement(
    SignoffDialog,
    {
      open: true,
  ...
  ) : null, open === "verify" ? /* @__PURE__ */ import_react29.default.createElement(
    VerifyModal,
    {
      ticketId: props.boardKey,
      agentId: props.sessionId,
...
function InlineAllowlistApproval(props) {
  return /* @__PURE__ */ import_react29.default.createElement("div", { className: "aidos-inline-approval" }, /* @__PURE__ */ import_react29.default.createElement(AllowlistRequestCard, { ticketId: props.boardKey, agentId: props.sessionId }));
}
...
function AidosRow(props) {
  ...
  const [peekOpen, setPeekOpen] = import_react30.default.useState(false);
  const [activationNotice, setActivationNotice] = import_react30.default.useState(null);
  ...
  return /* @__PURE__ */ import_react30.default.createElement("div", { className: "tool-render-card", "data-error": props.state === "error" || void 0 }, /* @__PURE__ */ import_react30.default.createElement(
    "div",
    {
      className: "tool-render-row",
    ...
    /* @__PURE__ */ import_react30.default.createElement(ToolRenderChevron, { open, disabled: !expandable }),
    /* @__PURE__ */ import_react30.default.createElement("span", { className: "tool-render-name-badge", style: nameBadgeColors(props.title, props.state === "error") }, /* @__PURE__ */ import_react30.default.createElement("span", { className: "tool-render-name-badge-icon" }, props.icon), /* @__PURE__ */ import_react30.default.createElement("span", { className: "tool-render-name-badge-text", title: props.title, "data-dsh-tip": "" }, props.title)),
    /* @__PURE__ */ import_react30.default.createElement("span", { className: "tool-render-sep", "aria-hidden": "true" }),
    select !== void 0 && props.errorSummary === void 0 ? /* @__PURE__ */ import_react30.default.createElement(
      "span",
      {
  ...
  ), open ? /* @__PURE__ */ import_react30.default.createElement("div", { className: "tool-render-body" }, body, footer !== null ? /* @__PURE__ */ import_react30.default.createElement("div", { className: "aidos-tool-footer" }, footer) : null) : null, peekOpen ? /* @__PURE__ */ import_react30.default.createElement(ModalShell, { title: "Ticket", onClose: () => setPeekOpen(false) }, peeked !== null ? /* @__PURE__ */ import_react30.default.createElement(import_react30.default.Fragment, null, /* @__PURE__ */ import_react30.default.createElement(TicketStrip, { ticket: peeked }), peeked.descriptionFull !== void 0 ? /* @__PURE__ */ import_react30.default.createElement(
    "div",
    {
      className: "aidos-md aidos-ticket-peek-description",
      dangerouslySetInnerHTML: { __html: renderMarkdownSafe(peeked.descriptionFull) }
    }
  ) : null, /* @__PURE__ */ import_react30.default.createElement("div", { className: "aidos-ticket-peek-actions" }, canSelect ? /* @__PURE__ */ import_react30.default.createElement(
    "button",
    {
      type: "button",
      className: "tool-render-approval-btn tool-render-approval-approve",
    ...
    /* @__PURE__ */ import_react30.default.createElement(PopOutIcon, null),
    " Open on board"
  ) : null), activationNotice !== null ? /* @__PURE__ */ import_react30.default.createElement("p", { className: "aidos-ticket-peek-note", role: "status" }, activationNotice) : null) : /* @__PURE__ */ import_react30.default.createElement("p", { className: "aidos-ticket-peek-empty" }, "#" + (props.ticketId ?? "?") + " isn't in this session's own board yet, or belongs to another session. Open the Tickets tab to look it up there.")) : null);
}
function Facts({ facts }) {
  if (facts.length === 0) return null;
  return /* @__PURE__ */ import_react30.default.createElement("dl", { className: "aidos-tool-facts" }, facts.map((fact, index) => (
    /*
     ...
     */
    /* @__PURE__ */ import_react30.default.createElement(import_react30.default.Fragment, { key: fact.label + ":" + index }, /* @__PURE__ */ import_react30.default.createElement("dt", null, fact.label), /* @__PURE__ */ import_react30.default.createElement(FactValue, { fact }))
  )));
}
function FactValue({ fact }) {
  const expandable = fact.full !== void 0 && fact.full !== "";
  if (!expandable) {
    return /* @__PURE__ */ import_react30.default.createElement("dd", { title: fact.value, "data-dsh-tip": "" }, fact.value);
  }
  return /* @__PURE__ */ import_react30.default.createElement(ExpandableValue, { fact, as: "dd" });
}
function ExpandableValue({ fact, as }) {
  const [expanded, setExpanded] = import_react30.default.useState(fact.open === true);
  const Wrapper = as;
  return /* @__PURE__ */ import_react30.default.createElement(
    ...
    expanded ? /* @__PURE__ */ import_react30.default.createElement(ExpandedFact, { fact }) : /* @__PURE__ */ import_react30.default.createElement("span", { className: "aidos-tool-fact-clipped", title: fact.value, "data-dsh-tip": "" }, fact.value),
    /* @__PURE__ */ import_react30.default.createElement(
      "button",
      {
...
function ListValue({ fact }) {
  if (fact.full === void 0 || fact.full === "") {
    return /* @__PURE__ */ import_react30.default.createElement("span", { className: "aidos-tool-list-text", title: fact.value, "data-dsh-tip": "" }, fact.value);
  }
  return (
    /*
     ...
     */
    /* @__PURE__ */ import_react30.default.createElement("span", { className: "aidos-tool-list-text aidos-tool-list-value" }, /* @__PURE__ */ import_react30.default.createElement(ExpandableValue, { fact, as: "span" }))
  );
}
function ExpandedFact({ fact }) {
  const text = fact.full ?? fact.value;
  if (fact.markdown !== true) {
    return /* @__PURE__ */ import_react30.default.createElement("span", { className: "aidos-tool-fact-full" }, text);
  }
  return /* @__PURE__ */ import_react30.default.createElement(
    "div",
    {
...
function FactsStack({
  ...
  return /* @__PURE__ */ import_react30.default.createElement("div", { className: "aidos-tool-stack" }, tables.map((table) => /* @__PURE__ */ import_react30.default.createElement("section", { className: "aidos-tool-table", key: table.id }, /* @__PURE__ */ import_react30.default.createElement(
    TicketCaption,
    {
      id: table.id,
      state: table.state,
  ...
  ), /* @__PURE__ */ import_react30.default.createElement(Facts, { facts: table.facts }))));
}
function TicketCaption({
  ...
  return /* @__PURE__ */ import_react30.default.createElement("header", { className: "aidos-tool-table-head" }, onSelect !== void 0 ? /* @__PURE__ */ import_react30.default.createElement(
    "button",
    {
    ...
    "#" + id
  ) : /* @__PURE__ */ import_react30.default.createElement("span", { className: "aidos-tool-table-id" }, "#" + id), state === "" ? null : /* @__PURE__ */ import_react30.default.createElement("span", { className: "aidos-tool-list-tag" }, state), /* @__PURE__ */ import_react30.default.createElement("span", { className: "aidos-tool-table-title", title, "data-dsh-tip": "" }, title));
}
function ticketCaption(result) {
  const caption = ticketCaptionOf(result);
  if (caption === null) return null;
  return /* @__PURE__ */ import_react30.default.createElement(TicketCaption, { id: caption.id, state: caption.state, title: caption.title });
}
function TextBody({ text, isError }) {
  return /* @__PURE__ */ import_react30.default.createElement("pre", { className: "tool-render-output", "tool-render-error": isError === true ? true : void 0 }, text);
}
function errorBody(errorText2) {
  if (errorText2 === null || errorText2 === "") return null;
  const envelope = parseErrorEnvelope(errorText2);
  if (envelope === null) return /* @__PURE__ */ import_react30.default.createElement(TextBody, { text: errorText2, isError: true });
  const facts = [];
  ...
  if (envelope.message === null && facts.length === 0) {
    return /* @__PURE__ */ import_react30.default.createElement(TextBody, { text: errorText2, isError: true });
  }
  return /* @__PURE__ */ import_react30.default.createElement(import_react30.default.Fragment, null, envelope.message === null ? null : /* @__PURE__ */ import_react30.default.createElement("p", { className: "aidos-tool-message" }, envelope.message), /* @__PURE__ */ import_react30.default.createElement(Facts, { facts }));
}
...
function fallbackBody(resultText) {
  return resultText === null || resultText === "" ? null : /* @__PURE__ */ import_react30.default.createElement(TextBody, { text: resultText, isError: false });
}
function AttachEvidenceRow(props) {
  ...
  const body = errorText2 !== null && errorText2 !== "" ? errorBody(errorText2) : kind !== void 0 ? /* @__PURE__ */ import_react30.default.createElement("ul", { className: "aidos-evidence-list" }, /* @__PURE__ */ import_react30.default.createElement(
    EvidenceStrip,
    {
      row: {
  ...
  return /* @__PURE__ */ import_react30.default.createElement(
    AidosRow,
    {
      icon: /* @__PURE__ */ import_react30.default.createElement(SignoffIcon, null),
      title: "Evidence",
...
function MoveTicketRow(props) {
  ...
  const body = errorText2 !== null && errorText2 !== "" ? errorBody(errorText2) : facts.length > 0 ? /* @__PURE__ */ import_react30.default.createElement(Facts, { facts }) : result === null ? fallbackBody(resultText) : null;
  const parts = moveTicketSummary(label, to, stateLabel);
  const summaryNode = parts.state === null ? void 0 : /* @__PURE__ */ import_react30.default.createElement(import_react30.default.Fragment, null, /* @__PURE__ */ import_react30.default.createElement("span", { className: "aidos-move-title", title: label ?? parts.title, "data-dsh-tip": "" }, parts.title), /* @__PURE__ */ import_react30.default.createElement("span", { className: "aidos-move-arrow", "aria-hidden": "true" }, "\u2192"), /* @__PURE__ */ import_react30.default.createElement("span", { className: badgeClass(parts.state) }, stateLabel(parts.state)));
  return /* @__PURE__ */ import_react30.default.createElement(
    AidosRow,
    {
...
function SetTicketRow(props) {
  ...
  const body = errorText2 !== null && errorText2 !== "" ? errorBody(errorText2) : fields.length > 0 ? /* @__PURE__ */ import_react30.default.createElement(Facts, { facts: fields }) : null;
  return /* @__PURE__ */ import_react30.default.createElement(
    AidosRow,
    {
...
function GetTicketRow(props) {
  ...
  const body = errorText2 !== null && errorText2 !== "" ? errorBody(errorText2) : facts.length === 0 && evidence.length === 0 ? result === null ? fallbackBody(resultText) : null : /* @__PURE__ */ import_react30.default.createElement(import_react30.default.Fragment, null, ticketCaption(result), /* @__PURE__ */ import_react30.default.createElement(Facts, { facts }), evidence.length > 0 ? /* @__PURE__ */ import_react30.default.createElement("ul", { className: "aidos-evidence-list" }, evidence.map((row, index) => /* @__PURE__ */ import_react30.default.createElement(
    EvidenceStrip,
    {
      key: index,
      row: {
  ...
  return /* @__PURE__ */ import_react30.default.createElement(
    AidosRow,
    {
      icon: /* @__PURE__ */ import_react30.default.createElement(CompassIcon, null),
      title: "Read ticket",
...
function GetTicketsRow(props) {
  ...
  const body = errorText2 !== null && errorText2 !== "" ? errorBody(errorText2) : tables.length === 0 ? result === null ? fallbackBody(resultText) : null : /* @__PURE__ */ import_react30.default.createElement(
    FactsStack,
    {
      tables,
  ...
  return /* @__PURE__ */ import_react30.default.createElement(
    AidosRow,
    {
      icon: /* @__PURE__ */ import_react30.default.createElement(KeyholeIcon, null),
      title: "Read board",
      summary,
      state,
      body,
...
function RequestAllowlistRow(props) {
  ...
  const body = errorText2 !== null && errorText2 !== "" ? errorBody(errorText2) : paths.length === 0 ? null : /* @__PURE__ */ import_react30.default.createElement(import_react30.default.Fragment, null, /* @__PURE__ */ import_react30.default.createElement(Facts, { facts: paths }), props.sessionId !== void 0 && ticketId !== null ? /* @__PURE__ */ import_react30.default.createElement(
  ...
  return /* @__PURE__ */ import_react30.default.createElement(
    AidosRow,
    {
      icon: /* @__PURE__ */ import_react30.default.createElement(AllowlistIcon, null),
...
function SuggestActionsRow(props) {
  ...
  const body = errorText2 !== null && errorText2 !== "" ? errorBody(errorText2) : lines.length === 0 ? null : /* @__PURE__ */ import_react30.default.createElement("ul", { className: "aidos-tool-list" }, lines.map((line) => /* @__PURE__ */ import_react30.default.createElement("li", { key: line.ticketId + ":" + line.actionId }, /* @__PURE__ */ import_react30.default.createElement("span", { className: "aidos-tool-list-key" }, "#", line.ticketId), /* @__PURE__ */ import_react30.default.createElement("span", { className: "aidos-tool-list-tag" }, line.actionId), /* @__PURE__ */ import_react30.default.createElement(ListValue, { fact: expandableFact("reason", line.reason) }), props.sessionId !== void 0 && isInlineActionId(line.actionId) ? /* @__PURE__ */ import_react30.default.createElement(
    InlineTicketAction,
    {
      sessionId: props.sessionId,
  ...
  return /* @__PURE__ */ import_react30.default.createElement(
    AidosRow,
    {
      icon: /* @__PURE__ */ import_react30.default.createElement(AlertCircleIcon, null),
...
function PlanRow(props) {
  ...
  return /* @__PURE__ */ import_react30.default.createElement(
    AidosRow,
    {
      icon: /* @__PURE__ */ import_react30.default.createElement(PopOutIcon, null),
      title: "Export plan",
      summary,
      state,
      body: text === null || text === "" ? null : /* @__PURE__ */ import_react30.default.createElement(TextBody, { text, isError: errorText2 !== null && state === "error" }),
      errorSummary
    }
  );
}
...
function PlanMetaSetRow(props) {
  ...
  const body = errorText2 !== null && errorText2 !== "" ? errorBody(errorText2) : written.length > 0 ? /* @__PURE__ */ import_react30.default.createElement(Facts, { facts: written }) : null;
  return /* @__PURE__ */ import_react30.default.createElement(
    AidosRow,
    {
      icon: /* @__PURE__ */ import_react30.default.createElement(PencilIcon, null),
...
function GetEvidenceRow(props) {
  ...
  const body = errorText2 !== null && errorText2 !== "" ? errorBody(errorText2) : records.length === 0 && comments.length === 0 ? result === null ? fallbackBody(resultText) : null : /* @__PURE__ */ import_react30.default.createElement(import_react30.default.Fragment, null, /* @__PURE__ */ import_react30.default.createElement("ul", { className: "aidos-evidence-list" }, records.map((row) => /* @__PURE__ */ import_react30.default.createElement(
    EvidenceStrip,
    {
  ...
  ))), comments.map((comment, position) => /* @__PURE__ */ import_react30.default.createElement("div", { className: "aidos-comment", key: position }, /* @__PURE__ */ import_react30.default.createElement("div", null, /* @__PURE__ */ import_react30.default.createElement("span", { className: "aidos-evidence-author" }, comment.author)), /* @__PURE__ */ import_react30.default.createElement("p", { className: "aidos-detail-body" }, comment.body))), evidenceViewer.viewer);
  return /* @__PURE__ */ import_react30.default.createElement(
    AidosRow,
    {
      icon: /* @__PURE__ */ import_react30.default.createElement(CompassIcon, null),
...
function useEvidenceViewer() {
  const [viewed, setViewed] = import_react30.default.useState(null);
  return {
    open: setViewed,
    viewer: viewed === null ? null : /* @__PURE__ */ import_react30.default.createElement(
      EvidenceViewer,
      {
        row: viewed,
        onClose: () => {
    ...
    try {
      ...
      return import_react31.default.createElement(
        ...
        import_react31.default.createElement(
          ...
          import_react31.default.createElement("span", { className: "tool-render-title" }, key),
          import_react31.default.createElement("span", { className: "tool-render-sep" }),
          import_react31.default.createElement(
            "span",
            { className: "tool-render-summary" },
