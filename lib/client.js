...
.aidos-strip-action-toggle {
  ...
  color: color-mix(in srgb, var(--tone) 38%, #ffffff);
  cursor: pointer;
...
/* Open reads as SELECTED, not merely hovered: the row below belongs to it. */
...
/* The colour is the state the action leads TO, so the queue reads as a
   column of intents rather than of identical buttons. */
...
function SignoffIcon() {
  return /* @__PURE__ */ import_react3.default.createElement("svg", { ...iconProps() }, /* @__PURE__ */ import_react3.default.createElement("path", { d: "M8.5 2h1a1 1 0 0 1 1 1v7a1 1 0 0 1-1 1h-7a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1h1" }), /* @__PURE__ */ import_react3.default.createElement("path", { d: "M4.5 1.5h3v1.5h-3z" }), /* @__PURE__ */ import_react3.default.createElement("path", { d: "M4 7.5l1.5 1.5L8.5 6" }));
}
function VerifyIcon() {
