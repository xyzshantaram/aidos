...
"use strict";var ad=Object.create;var Wt=Object.defineProperty;var sd=Object.getOwnPropertyDescriptor;var ld=Object.getOwnPropertyNames;var dd=Object.getPrototypeOf,cd=Object.prototype.hasOwnProperty;var ud=(e,n)=>()=>{try{return n||e((n={exports:{}}).exports,n),n.exports}catch(t){throw n=0,t}},pd=(e,n)=>{for(var t in n)Wt(e,t,{get:n[t],enumerable:!0})},or=(e,n,t,i)=>{if(n&&typeof n=="object"||typeof n=="function")for(let o of ld(n))!cd.call(e,o)&&o!==t&&Wt(e,o,{get:()=>n[o],enumerable:!(i=sd(n,o))||i.enumerable});return e};var ee=(e,n,t)=>(t=e!=null?ad(dd(e)):{},or(n||!e||!e.__esModule?Wt(t,"default",{value:e,enumerable:!0}):t,e)),fd=e=>or(Wt({},"__esModule",{value:!0}),e);var Ys=ud((Lw,Js)=>{"use strict";function zs(e){return e instanceof Map?e.clear=e.delete=e.set=function(){throw new Error("map is read-only")}:e instanceof Set&&(e.add=e.clear=e.delete=function(){throw new Error("set is read-only")}),Object.freeze(e),Object.getOwnPropertyNames(e).forEach(n=>{let t=e[n],i=typeof t;(i==="object"||i==="function")&&!Object.isFrozen(t)&&zs(t)}),e}var Ri=class{constructor(n){n.data===void 0&&(n.data={}),this.data=n.data,this.isMatchIgnored=!1}ignoreMatch(){this.isMatchIgnored=!0}};function $s(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function On(e,...n){let t=Object.create(null);for(let i in e)t[i]=e[i];return n.forEach(function(i){for(let o in i)t[o]=i[o]}),t}var ap="</span>",Ps=e=>!!e.scope,sp=(e,{prefix:n})=>{if(e.startsWith("language:"))return e.replace("language:","language-");if(e.includes(".")){let t=e.split(".");return[`${n}${t.shift()}`,...t.map((i,o)=>`${i}${"_".repeat(o+1)}`)].join(" ")}return`${n}${e}`},zo=class{constructor(n,t){this.buffer="",this.classPrefix=t.classPrefix,n.walk(this)}addText(n){this.buffer+=$s(n)}openNode(n){if(!Ps(n))return;let t=sp(n.scope,{prefix:this.classPrefix});this.span(t)}closeNode(n){Ps(n)&&(this.buffer+=ap)}value(){return this.buffer}span(n){this.buffer+=`<span class="${n}">`}},Ms=(e={})=>{let n={children:[]};return Object.assign(n,e),n},$o=class e{constructor(){this.rootNode=Ms(),this.stack=[this.rootNode]}get top(){return this.stack[this.stack.length-1]}get root(){return this.rootNode}add(n){this.top.children.push(n)}openNode(n){let t=Ms({scope:n});this.add(t),this.stack.push(t)}closeNode(){if(this.stack.length>1)return this.stack.pop()}closeAllNodes(){for(;this.closeNode(););}toJSON(){return JSON.stringify(this.rootNode,null,4)}walk(n){return this.constructor._walk(n,this.rootNode)}static _walk(n,t){return typeof t=="string"?n.addText(t):t.children&&(n.openNode(t),t.children.forEach(i=>this._walk(n,i)),n.closeNode(t)),n}static _collapse(n){typeof n!="string"&&n.children&&(n.children.every(t=>typeof t=="string")?n.children=[n.children.join("")]:n.children.forEach(t=>{e._collapse(t)}))}},jo=class extends $o{constructor(n){super(),this.options=n}addText(n){n!==""&&this.add(n)}startScope(n){this.openNode(n)}endScope(){this.closeNode()}__addSublanguage(n,t){let i=n.root;t&&(i.scope=`language:${t}`),this.add(i)}toHTML(){return new zo(this,this.options).value()}finalize(){return this.closeAllNodes(),!0}};function Ft(e){return e?typeof e=="string"?e:e.source:null}function js(e){return Wn("(?=",e,")")}function lp(e){return Wn("(?:",e,")*")}function dp(e){return Wn("(?:",e,")?")}function Wn(...e){return e.map(t=>Ft(t)).join("")}function cp(e){let n=e[e.length-1];return typeof n=="object"&&n.constructor===Object?(e.splice(e.length-1,1),n):{}}function Ai(...e){return"("+(cp(e).capture?"":"?:")+e.map(i=>Ft(i)).join("|")+")"}function Fs(e){return new RegExp(e.toString()+"|").exec("").length-1}function up(e,n){let t=e&&e.exec(n);return t&&t.index===0}var pp=new RegExp(Ai(/\[(?:[^\\\]]|\\.)*\]/,/\(\?<(?![=!])[^>]+>/,/\(\?'[^']+'/,/\(\??/,/\\([1-9][0-9]*)/,/\\./));function Vo(e,{joinWith:n}){let t=0;return e.map(i=>{t+=1;let o=t,r=Ft(i),s="";for(;r.length>0;){let a=pp.exec(r);if(!a){s+=r;break}s+=r.substring(0,a.index),r=r.substring(a.index+a[0].length),a[0][0]==="\\"&&a[1]?s+="\\"+String(Number(a[1])+o):(s+=a[0],(a[0]==="("||/^\(\?[<']/.test(a[0]))&&t++)}return s}).map(i=>`(${i})`).join(n)}var fp=/\b\B/,Vs="[a-zA-Z]\\w*",qo="[a-zA-Z_]\\w*",qs="\\b\\d+(\\.\\d+)?",Us="(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)",Hs="\\b(0b[01]+)",hp="!|!=|!==|%|%=|&|&&|&=|\\*|\\*=|\\+|\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\?|\\[|\\{|\\(|\\^|\\^=|\\||\\|=|\\|\\||~",gp=(e={})=>{let n=/^#![ ]*\//;return e.binary&&(e.begin=Wn(n,/.*\b/,e.binary,/\b.*/)),On({scope:"meta",begin:n,end:/$/,relevance:0,"on:begin":(t,i)=>{t.index!==0&&i.ignoreMatch()}},e)},Vt={begin:"\\\\[\\s\\S]",relevance:0},mp={scope:"string",begin:"'",end:"'",illegal:"\\n",contains:[Vt]},bp={scope:"string",begin:'"',end:'"',illegal:"\\n",contains:[Vt]},wp={begin:/\b(a|an|the|are|I'm|isn't|don't|doesn't|won't|but|just|should|pretty|simply|enough|gonna|going|wtf|so|such|will|you|your|they|like|more)\b/},Ni=function(e,n,t={}){let i=On({scope:"comment",begin:e,end:n,contains:[]},t);i.contains.push({scope:"doctag",begin:"[ ]*(?=(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):)",end:/(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):/,excludeBegin:!0,relevance:0});let o=Ai("I","a","is","so","us","to","at","if","in","it","on",/[A-Za-z]+['](d|ve|re|ll|t|s|n)/,/[A-Za-z]+[-][a-z]+/,/[A-Za-z][a-z]{2,}/);return i.contains.push({begin:Wn(/[ ]+/,"(",o,/[.]?[:]?([.][ ]|[ ])/,"){3}")}),i},kp=Ni("//","$"),vp=Ni("/\\*","\\*/"),yp=Ni("#","$"),xp={scope:"number",begin:qs,relevance:0},Sp={scope:"number",begin:Us,relevance:0},Tp={scope:"number",begin:Hs,relevance:0},Ep={scope:"regexp",begin:/\/(?=[^/\n]*\/)/,end:/\/[gimuy]*/,contains:[Vt,{begin:/\[/,end:/\]/,relevance:0,contains:[Vt]}]},Rp={scope:"title",begin:Vs,relevance:0},Ip={scope:"title",begin:qo,relevance:0},Ap={begin:"\\.\\s*"+qo,relevance:0},Np=function(e){return Object.assign(e,{"on:begin":(n,t)=>{t.data._beginMatch=n[1]},"on:end":(n,t)=>{t.data._beginMatch!==n[1]&&t.ignoreMatch()}})},Ei=Object.freeze({__proto__:null,APOS_STRING_MODE:mp,BACKSLASH_ESCAPE:Vt,BINARY_NUMBER_MODE:Tp,BINARY_NUMBER_RE:Hs,COMMENT:Ni,C_BLOCK_COMMENT_MODE:vp,C_LINE_COMMENT_MODE:kp,C_NUMBER_MODE:Sp,C_NUMBER_RE:Us,END_SAME_AS_BEGIN:Np,HASH_COMMENT_MODE:yp,IDENT_RE:Vs,MATCH_NOTHING_RE:fp,METHOD_GUARD:Ap,NUMBER_MODE:xp,NUMBER_RE:qs,PHRASAL_WORDS_MODE:wp,QUOTE_STRING_MODE:bp,REGEXP_MODE:Ep,RE_STARTERS_RE:hp,SHEBANG:gp,TITLE_MODE:Rp,UNDERSCORE_IDENT_RE:qo,UNDERSCORE_TITLE_MODE:Ip});function Cp(e,n){e.input[e.index-1]==="."&&n.ignoreMatch()}function _p(e,n){e.className!==void 0&&(e.scope=e.className,delete e.className)}function Op(e,n){n&&e.beginKeywords&&(e.begin="\\b("+e.beginKeywords.split(" ").join("|")+")(?!\\.)(?=\\b|\\s)",e.__beforeBegin=Cp,e.keywords=e.keywords||e.beginKeywords,delete e.beginKeywords,e.relevance===void 0&&(e.relevance=0))}function Pp(e,n){Array.isArray(e.illegal)&&(e.illegal=Ai(...e.illegal))}function Mp(e,n){if(e.match){if(e.begin||e.end)throw new Error("begin & end are not supported with match");e.begin=e.match,delete e.match}}function Lp(e,n){e.relevance===void 0&&(e.relevance=1)}var Dp=(e,n)=>{if(!e.beforeMatch)return;if(e.starts)throw new Error("beforeMatch cannot be used with starts");let t=Object.assign({},e);Object.keys(e).forEach(i=>{delete e[i]}),e.keywords=t.keywords,e.begin=Wn(t.beforeMatch,js(t.begin)),e.starts={relevance:0,contains:[Object.assign(t,{endsParent:!0})]},e.relevance=0,delete t.beforeMatch},Kp=["of","and","for","in","not","or","if","then","parent","list","value"],Bp="keyword";function Gs(e,n,t=Bp){let i=Object.create(null);return typeof e=="string"?o(t,e.split(" ")):Array.isArray(e)?o(t,e):Object.keys(e).forEach(function(r){Object.assign(i,Gs(e[r],n,r))}),i;function o(r,s){n&&(s=s.map(a=>a.toLowerCase())),s.forEach(function(a){let l=a.split("|");i[l[0]]=[r,zp(l[0],l[1])]})}}function zp(e,n){return n?Number(n):$p(e)?0:1}function $p(e){return Kp.includes(e.toLowerCase())}var Ls={},Gn=e=>{console.error(e)},Ds=(e,...n)=>{console.log(`WARN: ${e}`,...n)},kt=(e,n)=>{Ls[`${e}/${n}`]||(console.log(`Deprecated as of ${e}. ${n}`),Ls[`${e}/${n}`]=!0)},Ii=new Error;function Ws(e,n,{key:t}){let i=0,o=e[t],r={},s={};for(let a=1;a<=n.length;a++)s[a+i]=o[a],r[a+i]=!0,i+=Fs(n[a-1]);e[t]=s,e[t]._emit=r,e[t]._multi=!0}function jp(e){if(Array.isArray(e.begin)){if(e.skip||e.excludeBegin||e.returnBegin)throw Gn("skip, excludeBegin, returnBegin not compatible with beginScope: {}"),Ii;if(typeof e.beginScope!="object"||e.beginScope===null)throw Gn("beginScope must be object"),Ii;Ws(e,e.begin,{key:"beginScope"}),e.begin=Vo(e.begin,{joinWith:""})}}function Fp(e){if(Array.isArray(e.end)){if(e.skip||e.excludeEnd||e.returnEnd)throw Gn("skip, excludeEnd, returnEnd not compatible with endScope: {}"),Ii;if(typeof e.endScope!="object"||e.endScope===null)throw Gn("endScope must be object"),Ii;Ws(e,e.end,{key:"endScope"}),e.end=Vo(e.end,{joinWith:""})}}function Vp(e){e.scope&&typeof e.scope=="object"&&e.scope!==null&&(e.beginScope=e.scope,delete e.scope)}function qp(e){Vp(e),typeof e.beginScope=="string"&&(e.beginScope={_wrap:e.beginScope}),typeof e.endScope=="string"&&(e.endScope={_wrap:e.endScope}),jp(e),Fp(e)}function Up(e){function n(s,a){return new RegExp(Ft(s),"m"+(e.case_insensitive?"i":"")+(e.unicodeRegex?"u":"")+(a?"g":""))}class t{constructor(){this.matchIndexes={},this.regexes=[],this.matchAt=1,this.position=0}addRule(a,l){l.position=this.position++,this.matchIndexes[this.matchAt]=l,this.regexes.push([l,a]),this.matchAt+=Fs(a)+1}compile(){this.regexes.length===0&&(this.exec=()=>null);let a=this.regexes.map(l=>l[1]);this.matcherRe=n(Vo(a,{joinWith:"|"}),!0),this.lastIndex=0}exec(a){this.matcherRe.lastIndex=this.lastIndex;let l=this.matcherRe.exec(a);if(!l)return null;let d=l.findIndex((u,p)=>p>0&&u!==void 0),c=this.matchIndexes[d];return l.splice(0,d),Object.assign(l,c)}}class i{constructor(){this.rules=[],this.multiRegexes=[],this.count=0,this.lastIndex=0,this.regexIndex=0}getMatcher(a){if(this.multiRegexes[a])return this.multiRegexes[a];let l=new t;return this.rules.slice(a).forEach(([d,c])=>l.addRule(d,c)),l.compile(),this.multiRegexes[a]=l,l}resumingScanAtSamePosition(){return this.regexIndex!==0}considerAll(){this.regexIndex=0}addRule(a,l){this.rules.push([a,l]),l.type==="begin"&&this.count++}exec(a){let l=this.getMatcher(this.regexIndex);l.lastIndex=this.lastIndex;let d=l.exec(a);if(this.resumingScanAtSamePosition()&&!(d&&d.index===this.lastIndex)){let c=this.getMatcher(0);c.lastIndex=this.lastIndex+1,d=c.exec(a)}return d&&(this.regexIndex+=d.position+1,this.regexIndex===this.count&&this.considerAll()),d}}function o(s){let a=new i;return s.contains.forEach(l=>a.addRule(l.begin,{rule:l,type:"begin"})),s.terminatorEnd&&a.addRule(s.terminatorEnd,{type:"end"}),s.illegal&&a.addRule(s.illegal,{type:"illegal"}),a}function r(s,a){let l=s;if(s.isCompiled)return l;[_p,Mp,qp,Dp].forEach(c=>c(s,a)),e.compilerExtensions.forEach(c=>c(s,a)),s.__beforeBegin=null,[Op,Pp,Lp].forEach(c=>c(s,a)),s.isCompiled=!0;let d=null;return typeof s.keywords=="object"&&s.keywords.$pattern&&(s.keywords=Object.assign({},s.keywords),d=s.keywords.$pattern,delete s.keywords.$pattern),d=d||/\w+/,s.keywords&&(s.keywords=Gs(s.keywords,e.case_insensitive)),l.keywordPatternRe=n(d,!0),a&&(s.begin||(s.begin=/\B|\b/),l.beginRe=n(l.begin),!s.end&&!s.endsWithParent&&(s.end=/\B|\b/),s.end&&(l.endRe=n(l.end)),l.terminatorEnd=Ft(l.end)||"",s.endsWithParent&&a.terminatorEnd&&(l.terminatorEnd+=(s.end?"|":"")+a.terminatorEnd)),s.illegal&&(l.illegalRe=n(s.illegal)),s.contains||(s.contains=[]),s.contains=[].concat(...s.contains.map(function(c){return Hp(c==="self"?s:c)})),s.contains.forEach(function(c){r(c,l)}),s.starts&&r(s.starts,a),l.matcher=o(l),l}if(e.compilerExtensions||(e.compilerExtensions=[]),e.contains&&e.contains.includes("self"))throw new Error("ERR: contains `self` is not supported at the top-level of a language.  See documentation.");return e.classNameAliases=On(e.classNameAliases||{}),r(e)}function Qs(e){return e?e.endsWithParent||Qs(e.starts):!1}function Hp(e){return e.variants&&!e.cachedVariants&&(e.cachedVariants=e.variants.map(function(n){return On(e,{variants:null},n)})),e.cachedVariants?e.cachedVariants:Qs(e)?On(e,{starts:e.starts?On(e.starts):null}):Object.isFrozen(e)?On(e):e}var Gp="11.12.0",Fo=class extends Error{constructor(n,t){super(n),this.name="HTMLInjectionError",this.html=t}},Bo=$s,Ks=On,Bs=Symbol("nomatch"),Wp=7,Zs=function(e){let n=Object.create(null),t=Object.create(null),i=[],o=!0,r="Could not find the language '{}', did you forget to load/include a language module?",s={disableAutodetect:!0,name:"Plain text",contains:[]},a={ignoreUnescapedHTML:!1,throwUnescapedHTML:!1,noHighlightRe:/^(no-?highlight)$/i,languageDetectRe:/\blang(?:uage)?-([\w-]+)\b/i,classPrefix:"hljs-",cssSelector:"pre code",languages:null,__emitter:jo};function l(T){return a.noHighlightRe.test(T)}function d(T){let h=T.className+" ";h+=T.parentNode?T.parentNode.className:"";let I=a.languageDetectRe.exec(h);if(I){let L=S(I[1]);return L||(Ds(r.replace("{}",I[1])),Ds("Falling back to no-highlight mode for this block.",T)),L?I[1]:"no-highlight"}return h.split(/\s+/).find(L=>l(L)||S(L))}function c(T,h,I){let L="",$="";typeof h=="object"?(L=T,I=h.ignoreIllegals,$=h.language):(kt("10.7.0","highlight(lang, code, ...args) has been deprecated."),kt("10.7.0",`Please use highlight(code, options) instead.
https://github.com/highlightjs/highlight.js/issues/2277`),$=T,L=h),I===void 0&&(I=!0);let ce={code:L,language:$};Oe("before:highlight",ce);let ge=ce.result?ce.result:u(ce.language,ce.code,I);return ge.code=ce.code,Oe("after:highlight",ge),ge}function u(T,h,I,L){let $=Object.create(null);function ce(N,P){return N.keywords[P]}function ge(){if(!z.keywords){ve.addText(se);return}let N=0;z.keywordPatternRe.lastIndex=0;let P=z.keywordPatternRe.exec(se),G="";for(;P;){G+=se.substring(N,P.index);let te=qe.case_insensitive?P[0].toLowerCase():P[0],Se=ce(z,te);if(Se){let[Ee,Ht]=Se;if(ve.addText(G),G="",$[te]=($[te]||0)+1,$[te]<=Wp&&(Mn+=Ht),Ee.startsWith("_"))G+=P[0];else{let Ln=qe.classNameAliases[Ee]||Ee;Ae(P[0],Ln)}}else G+=P[0];N=z.keywordPatternRe.lastIndex,P=z.keywordPatternRe.exec(se)}G+=se.substring(N),ve.addText(G)}function xe(){if(se==="")return;let N=null;if(typeof z.subLanguage=="string"){if(!n[z.subLanguage]){ve.addText(se);return}N=u(z.subLanguage,se,!0,pn[z.subLanguage]),pn[z.subLanguage]=N._top}else N=f(se,z.subLanguage.length?z.subLanguage:null);z.relevance>0&&(Mn+=N.relevance),ve.__addSublanguage(N._emitter,N.language)}function Ie(){z.subLanguage!=null?xe():ge(),se=""}function Ae(N,P){N!==""&&(ve.startScope(P),ve.addText(N),ve.endScope())}function Zn(N,P){let G=1,te=P.length-1;for(;G<=te;){if(!N._emit[G]){G++;continue}let Se=qe.classNameAliases[N[G]]||N[G],Ee=P[G];Se?Ae(Ee,Se):(se=Ee,ge(),se=""),G++}}function Jn(N,P){return N.scope&&typeof N.scope=="string"&&ve.openNode(qe.classNameAliases[N.scope]||N.scope),N.beginScope&&(N.beginScope._wrap?(Ae(se,qe.classNameAliases[N.beginScope._wrap]||N.beginScope._wrap),se=""):N.beginScope._multi&&(Zn(N.beginScope,P),se="")),z=Object.create(N,{parent:{value:z}}),z}function Yn(N,P,G){let te=up(N.endRe,G);if(te){if(N["on:end"]){let Se=new Ri(N);N["on:end"](P,Se),Se.isMatchIgnored&&(te=!1)}if(te){for(;N.endsParent&&N.parent;)N=N.parent;return N}}if(N.endsWithParent)return Yn(N.parent,P,G)}function Tt(N){return z.matcher.regexIndex===0?(se+=N[0],1):(nt=!0,0)}function Et(N){let P=N[0],G=N.rule,te=new Ri(G),Se=[G.__beforeBegin,G["on:begin"]];for(let Ee of Se)if(Ee&&(Ee(N,te),te.isMatchIgnored))return Tt(P);return G.skip?se+=P:(G.excludeBegin&&(se+=P),Ie(),!G.returnBegin&&!G.excludeBegin&&(se=P)),Jn(G,N),G.returnBegin?0:P.length}function qt(N){let P=N[0],G=h.substring(N.index),te=Yn(z,N,G);if(!te)return Bs;let Se=z;z.endScope&&z.endScope._wrap?(Ie(),Ae(P,z.endScope._wrap)):z.endScope&&z.endScope._multi?(Ie(),Zn(z.endScope,N)):Se.skip?se+=P:(Se.returnEnd||Se.excludeEnd||(se+=P),Ie(),Se.excludeEnd&&(se=P));do z.scope&&ve.closeNode(),!z.skip&&!z.subLanguage&&(Mn+=z.relevance),z=z.parent;while(z!==te.parent);return te.starts&&Jn(te.starts,N),Se.returnEnd?0:P.length}function qi(){let N=[];for(let P=z;P!==qe;P=P.parent)P.scope&&N.unshift(P.scope);N.forEach(P=>ve.openNode(P))}let yn={};function Ut(N,P){let G=P&&P[0];if(se+=N,G==null)return Ie(),0;if(yn.type==="begin"&&P.type==="end"&&yn.index===P.index&&G===""){if(se+=h.slice(P.index,P.index+1),!o){let te=new Error(`0 width match regex (${T})`);throw te.languageName=T,te.badRule=yn.rule,te}return 1}if(yn=P,P.type==="begin")return Et(P);if(P.type==="illegal"&&!I){let te=new Error('Illegal lexeme "'+G+'" for mode "'+(z.scope||"<unnamed>")+'"');throw te.mode=z,te}else if(P.type==="end"){let te=qt(P);if(te!==Bs)return te}if(P.type==="illegal"&&G==="")return P.index===h.length||(se+=`
`),1;if(et>1e5&&et>P.index*3)throw new Error("potential infinite loop, way more iterations than matches");return se+=G,G.length}let qe=S(T);if(!qe)throw Gn(r.replace("{}",T)),new Error('Unknown language: "'+T+'"');let Ui=Up(qe),Xn="",z=L||Ui,pn={},ve=new a.__emitter(a);qi();let se="",Mn=0,tn=0,et=0,nt=!1;try{if(qe.__emitTokens)qe.__emitTokens(h,ve);else{for(z.matcher.considerAll();;){et++,nt?nt=!1:z.matcher.considerAll(),z.matcher.lastIndex=tn;let N=z.matcher.exec(h);if(!N)break;let P=h.substring(tn,N.index),G=Ut(P,N);tn=N.index+G}Ut(h.substring(tn))}return ve.finalize(),Xn=ve.toHTML(),{language:T,value:Xn,relevance:Mn,illegal:!1,_emitter:ve,_top:z}}catch(N){if(N.message&&N.message.includes("Illegal"))return{language:T,value:Bo(h),illegal:!0,relevance:0,_illegalBy:{message:N.message,index:tn,context:h.slice(tn-100,tn+100),mode:N.mode,resultSoFar:Xn},_emitter:ve};if(o)return{language:T,value:Bo(h),illegal:!1,relevance:0,errorRaised:N,_emitter:ve,_top:z};throw N}}function p(T){let h={value:Bo(T),illegal:!1,relevance:0,_top:s,_emitter:new a.__emitter(a)};return h._emitter.addText(T),h}function f(T,h){h=h||a.languages||Object.keys(n);let I=p(T),L=h.filter(S).filter(H).map(Ie=>u(Ie,T,!1));L.unshift(I);let $=L.sort((Ie,Ae)=>{if(Ie.relevance!==Ae.relevance)return Ae.relevance-Ie.relevance;if(Ie.language&&Ae.language){if(S(Ie.language).supersetOf===Ae.language)return 1;if(S(Ae.language).supersetOf===Ie.language)return-1}return 0}),[ce,ge]=$,xe=ce;return xe.secondBest=ge,xe}function b(T,h,I){let L=h&&t[h]||I;T.classList.add("hljs"),T.classList.add(`language-${L}`)}function w(T){let h=null,I=d(T);if(l(I))return;if(Oe("before:highlightElement",{el:T,language:I}),T.dataset.highlighted){console.log("Element previously highlighted. To highlight again, first unset `dataset.highlighted`.",T);return}if(T.children.length>0&&(a.ignoreUnescapedHTML||(console.warn("One of your code blocks includes unescaped HTML. This is a potentially serious security risk."),console.warn("https://github.com/highlightjs/highlight.js/wiki/security"),console.warn("The element with unescaped HTML:"),console.warn(T)),a.throwUnescapedHTML))throw new Fo("One of your code blocks includes unescaped HTML.",T.innerHTML);h=T;let L=h.textContent,$=I?c(L,{language:I,ignoreIllegals:!0}):f(L);T.innerHTML=$.value,T.dataset.highlighted="yes",b(T,I,$.language),T.result={language:$.language,re:$.relevance,relevance:$.relevance},$.secondBest&&(T.secondBest={language:$.secondBest.language,relevance:$.secondBest.relevance}),Oe("after:highlightElement",{el:T,result:$,text:L})}function x(T){a=Ks(a,T)}let m=()=>{W(),kt("10.6.0","initHighlighting() deprecated.  Use highlightAll() now.")};function A(){W(),kt("10.6.0","initHighlightingOnLoad() deprecated.  Use highlightAll() now.")}let _=!1;function W(){function T(){W()}if(document.readyState==="loading"){_||window.addEventListener("DOMContentLoaded",T,!1),_=!0;return}document.querySelectorAll(a.cssSelector).forEach(w)}function E(T,h){let I=null;try{I=h(e)}catch(L){if(Gn("Language definition for '{}' could not be registered.".replace("{}",T)),o)Gn(L);else throw L;I=s}I.name||(I.name=T),n[T]=I,I.rawDefinition=h.bind(null,e),I.aliases&&F(I.aliases,{languageName:T})}function Y(T){delete n[T];for(let h of Object.keys(t))t[h]===T&&delete t[h]}function de(){return Object.keys(n)}function S(T){return T=(T||"").toLowerCase(),n[T]||n[t[T]]}function F(T,{languageName:h}){typeof T=="string"&&(T=[T]),T.forEach(I=>{t[I.toLowerCase()]=h})}function H(T){let h=S(T);return h&&!h.disableAutodetect}function Ve(T){T["before:highlightBlock"]&&!T["before:highlightElement"]&&(T["before:highlightElement"]=h=>{T["before:highlightBlock"](Object.assign({block:h.el},h))}),T["after:highlightBlock"]&&!T["after:highlightElement"]&&(T["after:highlightElement"]=h=>{T["after:highlightBlock"](Object.assign({block:h.el},h))})}function Ke(T){Ve(T),i.push(T)}function We(T){let h=i.indexOf(T);h!==-1&&i.splice(h,1)}function Oe(T,h){let I=T;i.forEach(function(L){L[I]&&L[I](h)})}function nn(T){return kt("10.7.0","highlightBlock will be removed entirely in v12.0"),kt("10.7.0","Please use highlightElement now."),w(T)}Object.assign(e,{highlight:c,highlightAuto:f,highlightAll:W,highlightElement:w,highlightBlock:nn,configure:x,initHighlighting:m,initHighlightingOnLoad:A,registerLanguage:E,unregisterLanguage:Y,listLanguages:de,getLanguage:S,registerAliases:F,autoDetection:H,inherit:Ks,addPlugin:Ke,removePlugin:We}),e.debugMode=function(){o=!1},e.safeMode=function(){o=!0},e.versionString=Gp,e.regex={concat:Wn,lookahead:js,either:Ai,optional:dp,anyNumberOfTimes:lp};for(let T in Ei)typeof Ei[T]=="object"&&zs(Ei[T]);return Object.assign(e,Ei),e},vt=Zs({});vt.newInstance=()=>Zs({});Js.exports=vt;vt.HighlightJS=vt;vt.default=vt});var ih={};pd(ih,{apply:()=>th,inject:()=>Jf,name:()=>Zf});module.exports=fd(ih);var rr=`/* Dark Settings Form Control Design System \u2014 applied to aidos board */
...
`)}var Uo=/^([A-Za-z0-9]{3})│/;function lf(e){return e.length>0&&/^<path>/.test(e[0])&&e.indexOf("<content>")!==-1}function xl(e,n){if(e!==null&&typeof e=="object"&&typeof e.offset=="number"&&Number.isInteger(e.offset)&&e.offset>=1)return e.offset;var t=String(n).split(`
...
`),i=t.length>0&&Uo.test(t[0]),o=!i&&lf(t),r=[],s=n,a=0;a<t.length;a++)if(i&&Uo.test(t[a]))r.push({number:s,text:t[a].slice(4)}),s++;else if(i)r.push({number:null,text:t[a]});else if(o){if(a===0||/^<type>/.test(t[a])||t[a]==="<content>"||t[a]==="</content>")continue;var l=/^(\d+): ?/.exec(t[a]);l!==null?r.push({number:parseInt(l[1],10),text:t[a].slice(l[0].length)}):r.push({number:null,text:t[a]})}else r.push({number:s,text:t[a]}),s++;for(var d=[],a=0;a<r.length;a++)r[a].number!==null&&d.push(r[a].text);for(var c=sf(d.join(`
`)).split(`
...
`)}function Di(e){if(!Oi(e))return null;let n=Pn(e);if(n!==null&&n!=="")return n;let t=e.error;return t!==void 0&&typeof t.message=="string"?t.message:t!==void 0&&typeof t.code=="string"?t.code:null}function df(e){let n=e.indexOf(`
`);return n===-1?e:e.slice(0,n)}var cf=/\[(?:E_|exit code:|sandbox:)|FS_[A-Z_]+|AIDOS_[A-Z_]+/;function Ki(e){if(e==="")return e;let n=uf(e);if(n!==null)return n;for(let t of e.split(`
`))if(cf.test(t))return t;return df(e)}function uf(e){let n=Bi(e);if(n===null)return null;let{code:t,message:i}=n;return i===null?t:t===null?i:`${t} \u2014 ${i}`}var pf=new Set(["tool_error","Error","error"]),ff=[/^gate refused/i,/\brefused\b/i,/is not one of the ticket's criteria/i,/cannot attach kind/i,/outside the allowlist/i,/\bnot permitted\b/i];function Bi(e){let n=e.indexOf("{"),t=e.lastIndexOf("}");if(n===-1||t<=n)return null;let i;try{i=JSON.parse(e.slice(n,t+1))}catch{return null}if(i===null||typeof i!="object"||Array.isArray(i))return null;let o=i,r=typeof o.message=="string"?o.message:null,s=typeof o.code=="string"?o.code:typeof o.error=="string"?o.error:null,a=s!==null&&pf.has(s)&&r!==null?null:s,l={};for(let[c,u]of Object.entries(o))c==="ok"||c==="error"||c==="code"||c==="message"||(l[c]=u);let d=r??s??"";return{code:a,message:r,extra:l,refusal:ff.some(c=>c.test(d))}}function Tl(e,n){if(n===void 0||n==="")return e;let t=n.endsWith("/")?n:n+"/";return e.startsWith(t)?e.slice(t.length):e}function Go(e){if(e===null||e==="")return e;try{let n=JSON.parse(e);if(n===null||typeof n!="object")return e;let t=n;return typeof t.content=="string"?t.content:typeof t.message=="string"?t.message:e}catch{return e}}function hf(e){let n=0;for(let o=0;o<e.length;o++)n=n*31+e.charCodeAt(o)|0;n=Math.abs(n);let i=n*.6180339887498949%1;return Math.floor(i*360)}function zi(e,n){if(n)return{background:"color-mix(in srgb, var(--dsw-alias-state-error-primary) 85%, black)",borderColor:"var(--dsw-alias-state-error-primary)",color:"#fff"};let t=hf(e);return{background:`color-mix(in srgb, hsl(${t} 65% 45%) 55%, var(--dsw-alias-bg-tertiary))`,borderColor:`hsl(${t} 55% 60%)`}}function gf({state:e,open:n}){return ae.default.createElement(ai,{open:n})}function $i({title:e,icon:n,summary:t,state:i,body:o,errorSummary:r,path:s,openFile:a,inspect:l}){let[d,c]=ae.default.useState(!1),u=o!==null||l!==void 0,p=d&&u,f=i==="error"&&r!==void 0,b=f?r:t,w=!f&&s!==void 0&&a!==void 0,x=()=>{s!==void 0&&a!==void 0&&a(s)};return ae.default.createElement("div",{className:"tool-render-card","data-error":i==="error"||void 0,"data-stopped":i==="stopped"||void 0},ae.default.createElement("div",{className:"tool-render-row","data-state":i,"data-expandable":u?!0:void 0,role:u?"button":void 0,tabIndex:u?0:void 0,"aria-expanded":u?p:void 0,onClick:u?()=>c(!d):void 0,onKeyDown:u?m=>{(m.key==="Enter"||m.key===" ")&&(m.preventDefault(),c(!d))}:void 0},u?ae.default.createElement(gf,{state:i,open:p}):null,ae.default.createElement("span",{className:"tool-render-name-badge",style:zi(e,i==="error")},ae.default.createElement("span",{className:"tool-render-name-badge-icon"},n),ae.default.createElement("span",{className:"tool-render-name-badge-text",title:e,"data-dsh-tip":""},e)),ae.default.createElement("span",{className:"tool-render-sep","aria-hidden":"true"}),w?ae.default.createElement("span",{className:"tool-render-path",role:"link",tabIndex:0,title:s,"data-dsh-tip":"",onClick:m=>{m.stopPropagation(),x()},onKeyDown:m=>{(m.key==="Enter"||m.key===" ")&&(m.preventDefault(),m.stopPropagation(),x())}},b):ae.default.createElement("span",{className:"tool-render-summary","tool-render-error":f?!0:void 0,title:b,"data-dsh-tip":""},b)),p?ae.default.createElement("div",{className:"tool-render-body"},o,l!==void 0?ae.default.createElement("button",{type:"button",className:"tool-render-inspect",onClick:l},ae.default.createElement(ga,null),"Inspect"):null):null)}function ji(e,n){let t=Mi(Pi(e.block)),i=Li(e.block),o=yt(t,["path","file_path"]),r=i==="error"?Di(e.block):null,s=o!==void 0?Tl(o,e.cwd):n,a=r!==null&&r!==""?Ki(r):void 0;return{args:t,state:i,summary:s,errorText:r,errorSummary:a,path:o,openFile:e.openFile,inspect:e.inspect}}function Fi(e,n){return e===null||e===""?null:ae.default.createElement("pre",{className:"tool-render-output","tool-render-error":n?!0:void 0},e)}function mf(e,n){return El(Ho(e,xl(null,e)),n)}function El(e,n){let t=kl(n??""),i=yl(e.map(o=>o.number));return ae.default.createElement("div",{className:"tool-render-code"},e.map((o,r)=>ae.default.createElement("div",{className:"tool-render-code-row",key:r},ae.default.createElement("span",{className:"tool-render-gutter","aria-hidden":"true",style:{width:i}},o.number===null?"":String(o.number)),ae.default.createElement("code",{className:"tool-render-line-cell hljs","data-highlighted":"yes",dangerouslySetInnerHTML:{__html:vl(o.text,t)}}))))}function bf(e,n){return ae.default.createElement("div",{className:"tool-render-write"},ae.default.createElement("div",{className:"tool-render-write-note"},"No earlier version on record; new content below"),El(Ho(e,1),n))}function wf(e){let n=ji(e,"Read"),{args:t,state:i,errorText:o}=n,r=i==="error"?o:Go(Pn(e.block)),s=yt(t,["path","file_path"]),a=i==="error"||r===null||r===""?Fi(r,i==="error"):mf(r,s);return ae.default.createElement($i,{...n,icon:ae.default.createElement(In,null),title:"Scratch read",body:a})}function kf(e){let n=ji(e,"Write"),{args:t,state:i,errorText:o}=n,r=i==="error"?o:yt(t,["content"])??null,s=i==="error"||r===null||r===""?Fi(r,i==="error"):bf(r,n.path);return ae.default.createElement($i,{...n,icon:ae.default.createElement(Ze,null),title:"Scratch write",body:s})}function vf(e){let n=ji(e,"Edit"),{args:t,state:i,errorText:o}=n,r;if(i==="error")r=o;else{let s=yt(t,["old_string"]),a=yt(t,["new_string"]);r=s!==void 0||a!==void 0?`- ${s??""}
+ ${a??""}`:Go(Pn(e.block))}return ae.default.createElement($i,{...n,icon:ae.default.createElement(Ze,null),title:"Scratch edit",body:Fi(r,i==="error")})}function yf(e){let n=ji(e,"Mkdir"),{state:t,errorText:i}=n;return ae.default.createElement($i,{...n,icon:ae.default.createElement(ut,null),title:"Scratch mkdir",body:Fi(t==="error"?i:null,t==="error")})}var Rl=[["scratch_read",wf],["scratch_write",kf],["scratch_edit",vf],["scratch_mkdir",yf]];var k=ee(require("react"),1);function cn(e){return e!==null&&typeof e=="object"&&!Array.isArray(e)?e:null}function un(e){return Array.isArray(e)?e:[]}function ie(e){return typeof e=="string"?e:typeof e=="number"||typeof e=="boolean"?String(e):null}function Wo(e,n=120){let i=(typeof e=="string"?e:JSON.stringify(e)??"").replace(/\s+/g," ").trim();return i.length>n?i.slice(0,n-1)+"\u2026":i}function Qo(e){if(typeof e=="string")return e;if(e===void 0)return"";try{return JSON.stringify(e,null,2)??String(e)}catch{return String(e)}}function Fe(e,n,t){let i=Wo(n,t?.max),o=n.trim(),r=o!==i,s=/\n/.test(o);return!r&&!s?{label:e,value:i}:{label:e,value:i,full:o,...t?.markdown===!0?{markdown:!0}:{},...t?.open===!0?{open:!0}:{}}}function Zo(e){let n=cn(e?.ticket);if(n===null)return[];let t=[],i=ie(n.state);i!==null&&t.push({label:"State",value:i});let o=n.gatePresent,r=n.gateTotal;typeof o=="number"&&typeof r=="number"&&t.push({label:"Gate",value:`${o}/${r}`});let s=ie(n.description);s!==null&&s.trim()!==""&&t.push(Fe("Description",s,{markdown:!0}));let a=ie(n.criteria);a!==null&&a.trim()!==""&&t.push(Fe("Criteria",a));let l=ie(n.body);l!==null&&l.trim()!==""&&t.push(Fe("Body",l,{markdown:!0}));let d=un(n.allowlist);d.length>0&&t.push(Fe("Allowlist",d.map(p=>String(p)).join(" \xB7 ")));let c=un(n.dependsOn);c.length>0&&t.push(Fe("Depends on",c.map(p=>String(p)).join(" \xB7 ")));let u=e?.commentCount;return typeof u=="number"&&u>0&&t.push({label:"Comments",value:String(u)}),t}function xf(e){let n=[],t=e.gatePresent,i=e.gateTotal;typeof t=="number"&&typeof i=="number"&&n.push({label:"Gate",value:`${t}/${i}`});let o=e.confidenceScore;typeof o=="number"&&n.push({label:"Score",value:String(o)});let r=e.phase;typeof r=="number"&&n.push({label:"Phase",value:String(r)});let s=e.dependsOnCount;typeof s=="number"&&s>0&&n.push({label:"Depends on",value:String(s)});let a=e.allowlistCount;typeof a=="number"&&a>0&&n.push({label:"Allowlist",value:`${a} path${a===1?"":"s"}`});let l=ie(e.descriptionExcerpt);if(l!==null&&l.trim()!==""){let c=e.descriptionTruncated===!0?l.trimEnd()+`

_(excerpt \u2014 read the ticket for the rest)_`:l;n.push(Fe("Description",c,{markdown:!0}))}return{id:ie(e.id)??"?",state:ie(e.state)??"",title:ie(e.title)??"",facts:n}}function Il(e){let n=cn(e?.ticket);if(n===null)return null;let t=ie(n.title)??"";return t.trim()===""?null:{id:ie(n.id)??"?",state:ie(n.state)??"",title:t}}function Al(e){return un(e?.tickets).map(n=>cn(n)).filter(n=>n!==null).map(n=>xf(n))}function Nl(e){return un(e?.evidence).map(n=>cn(n)).filter(n=>n!==null).map(n=>({kind:ie(n.kind)??"",author:ie(n.author)??"agent",at:typeof n.at=="number"?n.at:void 0,excerpt:ie(n.excerpt)??""})).filter(n=>n.kind!=="")}function Cl(e){return un(e?.evidence).map(n=>cn(n)).filter(n=>n!==null).map((n,t)=>({index:typeof n.index=="number"?n.index:t,kind:ie(n.kind)??"",author:ie(n.author)??"agent",at:typeof n.at=="number"?n.at:void 0,payload:cn(n.payload)??{}})).filter(n=>n.kind!=="")}function _l(e){return un(e?.comments).map(n=>cn(n)).filter(n=>n!==null).map(n=>({author:ie(n.author)??"user",at:typeof n.at=="number"?n.at:void 0,body:ie(n.body)??""})).filter(n=>n.body!=="")}function Ol(e){if(e===null)return"all tickets";let n=[],i=(Array.isArray(e.stateIds)?e.stateIds:[e.stateIds]).map(c=>ie(c)).filter(c=>c!==null&&c!=="");i.length>0&&n.push(i.join("|"));let o=ie(e.search);o!==null&&o!==""&&n.push(`"${o}"`);let r=un(e.projectIds).map(c=>ie(c)).filter(c=>c!==null&&c!==""),s=ie(e.projectId);r.length>0?n.push(`projects ${r.join(",")}`):s!==null&&s!==""&&n.push(`project ${s}`);let a=ie(e.sortKey);a!==null&&a!==""&&n.push(`${a} ${e.descending===!1?"\u2191":"\u2193"}`),e.detail==="full"&&n.push("full");let l=ie(e.limit);l!==null&&l!==""&&n.push(`limit ${l}`);let d=ie(e.offset);return d!==null&&d!==""&&d!=="0"&&n.push(`offset ${d}`),n.length===0?"all tickets":n.join(" \xB7 ")}var Sf=new Set(["ticketId","projectId"]),Tf=new Set(["description","body"]);function Jo(e){if(e===null)return[];let n=[];for(let[t,i]of Object.entries(e))Sf.has(t)||i!==void 0&&n.push(Fe(t,Qo(i),{open:!0,...Tf.has(t)?{markdown:!0}:{}}));return n}var Ef=72;function Pl(e,n,t){let i=Wo(e??"move",Ef);if(n===null||n==="")return{title:i,state:null,text:i};let o=t===void 0?n:t(n);return{title:i,state:n,text:`${i} \u2192 ${o}`}}function Rf(e,n){let t=new Set(un(n?.created).map(i=>String(i)));return un(e?.paths).map(i=>{let o=String(i);return{path:o,created:t.has(o)}})}function Ml(e,n){return Rf(e,n).map(t=>Fe(t.created?"will be created":"exists",t.path))}function Ll(e){let n=ie(e?.fromState),t=ie(e?.toState);return n===null||t===null?[]:[{label:"From",value:n},{label:"To",value:t}]}function Dl(e){let n=[];for(let i of["frontmatter","preamble"]){let o=e?.[i];typeof o=="string"&&n.push(o===""?{label:i,value:"(empty)"}:Fe(i,o))}let t=e?.contextSections;return Array.isArray(t)&&n.push({label:"contextSections",value:String(t.length)}),n}function Kl(e){let n=[],t=e?.imported??e?.count;typeof t=="number"&&n.push({label:"Imported",value:String(t)}),typeof e?.projectId=="number"&&n.push({label:"Project",value:String(e.projectId)});let i=e?.deleted;typeof i=="boolean"&&n.push({label:"Plan file",value:i?"deleted":"KEPT"});let o=e?.deletionError;return typeof o=="string"&&o!==""&&n.push(Fe("Deletion error",o)),n}function Bl(e){return un(e?.suggestions).map(n=>cn(n)).filter(n=>n!==null).map(n=>({ticketId:ie(n.ticketId)??"?",actionId:ie(n.actionId)??"",reason:ie(n.reason)??""}))}var If=["frontmatter","preamble","contextSections"];function zl(e){return e===null?[]:If.filter(n=>typeof e[n]=="string")}function Af(e){return typeof e=="string"&&fn.includes(e)}function $l(e,n){if(n==null||n==="")return null;let t=cn(e);if(t===null)return null;let i=cn(t[n]);if(i===null||typeof i.id!="number"||typeof i.title!="string"||!Af(i.state)||typeof i.slug!="string"||typeof i.workspaceKey!="string")return null;let o={id:i.id,title:i.title,state:i.state,slug:i.slug,workspaceKey:i.workspaceKey};typeof i.gatePresent=="number"&&(o.gatePresent=i.gatePresent),typeof i.gateTotal=="number"&&(o.gateTotal=i.gateTotal),typeof i.criteria=="string"&&(o.criteria=i.criteria);let r=ie(i.description);return r!==null&&r.trim()!==""&&(o.descriptionExcerpt=Wo(r,220)),r!==null&&r.trim()!==""&&(o.descriptionFull=r),o}function jl(e){if(e==null)return{button:null,reason:"no document"};let n=e.querySelectorAll('[role="tab"]');for(let t of Array.from(n)){let i=(t.textContent??"").trim();if(i==="Tickets"||i.startsWith("Tickets ("))return{button:t,reason:null}}return{button:null,reason:"the Tickets tab is not shown on this screen"}}function Fl(e,n,t){let i=e;return n!==void 0&&(i+=" \xB7 "+n+(n===1?" ticket":" tickets")),t===!1?i+=" \xB7 file kept":t===!0&&(i+=" \xB7 file deleted"),i}function Nf(e,n){let t=e?.ticketId;if(typeof t=="number"||typeof t=="string")return String(t);if(n!==null&&typeof n=="object"){let i=n.ticketId;if(typeof i=="number"||typeof i=="string")return String(i)}return null}function Cf(e,n){if(e===null||n===null||n===void 0||n==="")return null;let t=n,i=e.tickets.find(a=>q(a)===t)??null;if(i===null)return null;let o=q(i),r=new Map,s=(a,l)=>{r.has(a)||r.set(a,l)};for(let a of e.tickets)s(q(a),a),s(String(a.id),a),s(a.workspaceKey+":"+String(a.id),a);return{ticket:i,boardKey:o,evidence:e.evidence[o]??[],comments:e.comments[o]??[],ticketsByKey:r}}function _f(e){let n=Pn(e);if(n===null||n==="")return null;try{let t=JSON.parse(n);return t!==null&&typeof t=="object"&&!Array.isArray(t)?t:null}catch{return null}}function Qn(e,n){if(n===null)return null;let t=ti(e,n);return t===null?`#${n}`:`#${n} \u2014 ${t}`}function Of(e){return`Select ${e} on the board`}function He(e){let[n,t]=k.default.useState(!1),[i,o]=k.default.useState(!1),[r,s]=k.default.useState(!1),[a,l]=k.default.useState(null),d=e.body??null,c=e.footer??null,u=d!==null||c!==null,p=n&&u,f=Sl(e.state,e.summary,e.errorSummary),b=e.summaryNode!==void 0&&e.errorSummary===void 0?e.summaryNode:null,w=e.ticketId!==null&&e.ticketId!==void 0&&e.sessionId!==void 0;k.default.useEffect(()=>{e.ticketId===null||e.ticketId===void 0||console.info(`[aidos] toolview ticket=${e.ticketId} sessionId=${e.sessionId??"MISSING"} useProjection=${typeof e.useProjection} canSelect=${w}`)},[e.ticketId,e.sessionId,e.useProjection,w]);let x=w?_=>{_.stopPropagation(),console.info(`[aidos] click-through fired for ticket ${e.ticketId}`),gn(e.sessionId,e.ticketId),l(null),o(!0)}:void 0,m=e.useProjection!==void 0?$l(e.useProjection("aidos.tickets"),e.ticketId):null,A=Cf(e.sessionId===void 0?null:zn(e.sessionId),e.ticketId);return k.default.createElement("div",{className:"tool-render-card","data-error":e.state==="error"||void 0},k.default.createElement("div",{className:"tool-render-row","data-state":e.state,"data-expandable":u?!0:void 0,role:u?"button":void 0,tabIndex:u?0:void 0,"aria-expanded":u?p:void 0,onClick:u?()=>t(!n):void 0,onKeyDown:u?_=>{(_.key==="Enter"||_.key===" ")&&(_.preventDefault(),t(!n))}:void 0},k.default.createElement(ai,{open:p,disabled:!u}),k.default.createElement("span",{className:"tool-render-name-badge",style:zi(e.title,e.state==="error")},k.default.createElement("span",{className:"tool-render-name-badge-icon"},e.icon),k.default.createElement("span",{className:"tool-render-name-badge-text",title:e.title,"data-dsh-tip":""},e.title)),k.default.createElement("span",{className:"tool-render-sep","aria-hidden":"true"}),x!==void 0&&e.errorSummary===void 0?k.default.createElement("span",{className:"tool-render-path"+(b===null?"":" aidos-row-summary-rich"),role:"link",tabIndex:0,title:Of(f.text),"data-dsh-tip":"",onClick:x,onKeyDown:_=>{(_.key==="Enter"||_.key===" ")&&(_.preventDefault(),x(_))}},b??f.text):k.default.createElement("span",{className:"tool-render-summary"+(b===null?"":" aidos-row-summary-rich"),"tool-render-error":f.isError?!0:void 0},b??f.text)),p?k.default.createElement("div",{className:"tool-render-body"},d,c!==null?k.default.createElement("div",{className:"aidos-tool-footer"},c):null):null,i?k.default.createElement(be,{title:A!==null?`#${A.ticket.id} ${A.ticket.title}`:"Ticket",wide:A!==null,onClose:()=>o(!1)},A!==null&&e.sessionId!==void 0?k.default.createElement(k.default.Fragment,null,k.default.createElement(yi,{key:me(A.ticket),ticket:A.ticket,ticketIdKey:A.boardKey,evidence:A.evidence,comments:A.comments,evidenceCollapsed:r,onToggleEvidence:()=>{s(_=>!_)},onClose:()=>o(!1),agentId:e.sessionId,onFieldSaved:()=>{},ticketsByKey:A.ticketsByKey,onJump:_=>{gn(e.sessionId,_),o(!1)}})):m!==null?k.default.createElement(k.default.Fragment,null,k.default.createElement(Ue,{ticket:m}),m.descriptionFull!==void 0?k.default.createElement("div",{className:"aidos-md aidos-ticket-peek-description",dangerouslySetInnerHTML:{__html:jt(m.descriptionFull)}}):null,k.default.createElement("div",{className:"aidos-ticket-peek-actions"},w?k.default.createElement("button",{type:"button",className:"tool-render-approval-btn tool-render-approval-approve",onClick:_=>{_.stopPropagation(),gn(e.sessionId,e.ticketId);let W=jl(typeof document>"u"?void 0:document);W.button!==null?(W.button.click(),o(!1)):l(W.reason)}},k.default.createElement(Rn,null)," Open on board"):null),a!==null?k.default.createElement("p",{className:"aidos-ticket-peek-note",role:"status"},a):null):k.default.createElement("p",{className:"aidos-ticket-peek-empty"},"#"+(e.ticketId??"?")+" isn't in this session's own board yet, or belongs to another session. Open the Tickets tab to look it up there.")):null)}function vn({facts:e}){return e.length===0?null:k.default.createElement("dl",{className:"aidos-tool-facts"},e.map((n,t)=>k.default.createElement(k.default.Fragment,{key:n.label+":"+t},k.default.createElement("dt",null,n.label),k.default.createElement(Pf,{fact:n}))))}function Pf({fact:e}){return e.full!==void 0&&e.full!==""?k.default.createElement(Vl,{fact:e,as:"dd"}):k.default.createElement("dd",{title:e.value,"data-dsh-tip":""},e.value)}function Vl({fact:e,as:n}){let[t,i]=k.default.useState(e.open===!0);return k.default.createElement(n,{className:n==="span"?"aidos-tool-fact-value":void 0,"data-expanded":t?!0:void 0},t?k.default.createElement(Lf,{fact:e}):k.default.createElement("span",{className:"aidos-tool-fact-clipped",title:e.value,"data-dsh-tip":""},e.value),k.default.createElement("button",{className:"aidos-tool-fact-more",type:"button","aria-expanded":t,onClick:r=>{r.stopPropagation(),i(!t)}},t?"Show less":"Show more"))}function Mf({fact:e}){return e.full===void 0||e.full===""?k.default.createElement("span",{className:"aidos-tool-list-text",title:e.value,"data-dsh-tip":""},e.value):k.default.createElement("span",{className:"aidos-tool-list-text aidos-tool-list-value"},k.default.createElement(Vl,{fact:e,as:"span"}))}function Lf({fact:e}){let n=e.full??e.value;return e.markdown!==!0?k.default.createElement("span",{className:"aidos-tool-fact-full"},n):k.default.createElement("div",{className:"aidos-md aidos-tool-fact-full",dangerouslySetInnerHTML:{__html:jt(n)}})}function Df({tables:e,onSelect:n}){return e.length===0?null:k.default.createElement("div",{className:"aidos-tool-stack"},e.map(t=>k.default.createElement("section",{className:"aidos-tool-table",key:t.id},k.default.createElement(ql,{id:t.id,state:t.state,title:t.title,onSelect:n}),k.default.createElement(vn,{facts:t.facts}))))}function ql({id:e,state:n,title:t,onSelect:i}){return k.default.createElement("header",{className:"aidos-tool-table-head"},i!==void 0?k.default.createElement("button",{className:"aidos-tool-table-id aidos-tool-table-id-link",type:"button",onClick:o=>{o.stopPropagation(),i(e)}},"#"+e):k.default.createElement("span",{className:"aidos-tool-table-id"},"#"+e),n===""?null:k.default.createElement("span",{className:"aidos-tool-list-tag"},n),k.default.createElement("span",{className:"aidos-tool-table-title",title:t,"data-dsh-tip":""},t))}function Kf(e){let n=Il(e);return n===null?null:k.default.createElement(ql,{id:n.id,state:n.state,title:n.title})}function Vi({text:e,isError:n}){return k.default.createElement("pre",{className:"tool-render-output","tool-render-error":n===!0?!0:void 0},e)}function en(e){if(e===null||e==="")return null;let n=Bi(e);if(n===null)return k.default.createElement(Vi,{text:e,isError:!0});let t=[];n.code!==null&&t.push({label:"code",value:n.code});for(let[i,o]of Object.entries(n.extra))t.push(Fe(i,Qo(o)));return n.message===null&&t.length===0?k.default.createElement(Vi,{text:e,isError:!0}):k.default.createElement(k.default.Fragment,null,n.message===null?null:k.default.createElement("p",{className:"aidos-tool-message"},n.message),k.default.createElement(vn,{facts:t}))}function Ge(e){let n=e?.block,t=Mi(Pi(n)),i=Li(n),o=_f(n),r=Nf(t,o),s=i==="error"?Di(n):null,a=s!==null&&s!==""?Ki(s):void 0,l=s===null?null:Bi(s),d=i==="error"&&l?.refusal===!0?"stopped":i,c=Pn(n);return{args:t,state:d,result:o,resultText:c,ticketId:r,errorText:s,errorSummary:a}}function xt(e){return e===null||e===""?null:k.default.createElement(Vi,{text:e,isError:!1})}function Bf(e){let{args:n,state:t,result:i,ticketId:o,errorText:r,errorSummary:s}=Ge(e),a=typeof n?.kind=="string"?n.kind:void 0,l=Yo(),d=k.default.createElement(k.default.Fragment,null,r!==null&&r!==""?en(r):a!==void 0?k.default.createElement("ul",{className:"aidos-evidence-list"},k.default.createElement(Je,{row:{kind:a.startsWith("builtin:")?a:"builtin:"+a,payload:n?.payload??{},author:"agent",at:typeof i?.updatedAt=="number"?i.updatedAt:void 0},onView:l.open})):null,l.viewer);return k.default.createElement(He,{icon:k.default.createElement(oi,null),title:"Evidence",summary:Qn(e.sessionId,o)??"evidence",state:t,body:d,errorSummary:s,ticketId:o,sessionId:e.sessionId,useProjection:e.useProjection})}function zf(e){let{args:n,state:t,result:i,resultText:o,ticketId:r,errorText:s,errorSummary:a}=Ge(e),l=typeof n?.to=="string"?n.to:null,d=Qn(e.sessionId,r),c=[...Ll(i),...Zo(i)],u=s!==null&&s!==""?en(s):c.length>0?k.default.createElement(vn,{facts:c}):i===null?xt(o):null,p=Pl(d,l,Me),f=p.state===null?void 0:k.default.createElement(k.default.Fragment,null,k.default.createElement("span",{className:"aidos-move-title",title:d??p.title,"data-dsh-tip":""},p.title),k.default.createElement("span",{className:"aidos-move-arrow","aria-hidden":"true"},"\u2192"),k.default.createElement("span",{className:Tn(p.state)},Me(p.state)));return k.default.createElement(He,{icon:k.default.createElement(ut,null),title:"Move ticket",summary:p.text,summaryNode:f,state:t,body:u,errorSummary:a,ticketId:r,sessionId:e.sessionId,useProjection:e.useProjection})}function $f(e){let{args:n,state:t,result:i,ticketId:o,errorText:r,errorSummary:s}=Ge(e),a=i?.created===!0,l=typeof n?.title=="string"?n.title:null,d=a&&l!==null?`#${o??"?"} \u2014 ${l}`:Qn(e.sessionId,o),c=Jo(n),u=r!==null&&r!==""?en(r):c.length>0?k.default.createElement(vn,{facts:c}):null;return k.default.createElement(He,{icon:k.default.createElement(Ze,null),title:a?"Create ticket":"Edit ticket",summary:d??"ticket",state:t,body:u,errorSummary:s,ticketId:o,sessionId:e.sessionId,useProjection:e.useProjection})}function jf(e){let{state:n,result:t,resultText:i,ticketId:o,errorText:r,errorSummary:s}=Ge(e),a=Zo(t),l=Nl(t),d=Yo(),c=r!==null&&r!==""?en(r):a.length===0&&l.length===0?t===null?xt(i):null:k.default.createElement(k.default.Fragment,null,Kf(t),k.default.createElement(vn,{facts:a}),l.length>0?k.default.createElement("ul",{className:"aidos-evidence-list"},l.map((u,p)=>k.default.createElement(Je,{key:p,row:{kind:u.kind,payload:{note:u.excerpt},author:u.author,at:u.at},onView:d.open}))):null,d.viewer);return k.default.createElement(He,{icon:k.default.createElement(In,null),title:"Read ticket",summary:Qn(e.sessionId,o)??"ticket",state:n,body:c,errorSummary:s,ticketId:o,sessionId:e.sessionId,useProjection:e.useProjection})}function Ff(e){let{args:n,state:t,result:i,resultText:o,errorText:r,errorSummary:s}=Ge(e),a=Ol(n),l=typeof i?.summary=="string"?i.summary:null,d=Al(i),c=r!==null&&r!==""?en(r):d.length===0?i===null?xt(o):null:k.default.createElement(Df,{tables:d,onSelect:e.sessionId===void 0?void 0:u=>{gn(e.sessionId,u)}});return k.default.createElement(He,{icon:k.default.createElement(ct,null),title:"Read board",summary:a,state:t,body:c,footer:l,errorSummary:s})}function Vf(e){let{args:n,state:t,result:i,ticketId:o,errorText:r,errorSummary:s}=Ge(e),a=Ml(n,i),d=(Qn(e.sessionId,o)??"allowlist")+" \xB7 "+a.length+(a.length===1?" path":" paths"),c=r!==null&&r!==""?en(r):a.length===0?null:k.default.createElement(k.default.Fragment,null,k.default.createElement(vn,{facts:a}),e.sessionId!==void 0&&o!==null?k.default.createElement(Ga,{sessionId:e.sessionId,boardKey:String(o)}):null);return k.default.createElement(He,{icon:k.default.createElement(ri,null),title:"Request allowlist",summary:d,state:t,body:c,errorSummary:s,ticketId:o,sessionId:e.sessionId,useProjection:e.useProjection})}function qf(e){let{args:n,state:t,errorText:i,errorSummary:o}=Ge(e),r=Bl(n),s=r.length===0?"nothing":r.length===1?Qn(e.sessionId,r[0].ticketId)??"#"+r[0].ticketId:r.length+" tickets",a=i!==null&&i!==""?en(i):r.length===0?null:k.default.createElement("ul",{className:"aidos-tool-list"},r.map(l=>k.default.createElement("li",{key:l.ticketId+":"+l.actionId},k.default.createElement("span",{className:"aidos-tool-list-key"},"#",l.ticketId),k.default.createElement("span",{className:"aidos-tool-list-tag"},l.actionId),k.default.createElement(Mf,{fact:Fe("reason",l.reason)}),e.sessionId!==void 0&&Ua(l.actionId)?k.default.createElement(Ha,{sessionId:e.sessionId,boardKey:String(l.ticketId),actionId:l.actionId}):null)));return k.default.createElement(He,{icon:k.default.createElement(ii,null),title:"Suggest actions",summary:s,state:t,body:a,errorSummary:o,ticketId:r.length===1?r[0].ticketId:null,sessionId:e.sessionId,useProjection:e.useProjection})}function Uf(e){let{args:n,state:t,errorText:i,errorSummary:o}=Ge(e),r=i??Pn(e.block),s=n?.projectId===void 0?"the project plan":"project "+String(n.projectId);return k.default.createElement(He,{icon:k.default.createElement(Rn,null),title:"Export plan",summary:s,state:t,body:r===null||r===""?null:k.default.createElement(Vi,{text:r,isError:i!==null&&t==="error"}),errorSummary:o})}function Hf(e){let{args:n,state:t,result:i,resultText:o,errorText:r,errorSummary:s}=Ge(e),a=typeof n?.file=="string"?n.file:"a plan",l=i?.imported??i?.count,d=Kl(i),c=r!==null&&r!==""?en(r):d.length>0?k.default.createElement(vn,{facts:d}):i===null?xt(o):null;return k.default.createElement(He,{icon:k.default.createElement(Rn,null),title:"Import plan",summary:Fl(a,typeof l=="number"?l:void 0,typeof i?.deleted=="boolean"?i.deleted:void 0),state:t,body:c,errorSummary:s})}function Gf(e){let{args:n,state:t,result:i,resultText:o,errorText:r,errorSummary:s}=Ge(e),a=n?.projectId===void 0?"the plan blocks":"project "+String(n.projectId),l=Dl(i),d=r!==null&&r!==""?en(r):l.length>0?k.default.createElement(vn,{facts:l}):i===null?xt(o):null;return k.default.createElement(He,{icon:k.default.createElement(In,null),title:"Read plan blocks",summary:a,state:t,body:d,errorSummary:s})}function Wf(e){let{args:n,state:t,errorText:i,errorSummary:o}=Ge(e),r=zl(n),s=Jo(n).filter(l=>l.label!=="projectId"),a=i!==null&&i!==""?en(i):s.length>0?k.default.createElement(vn,{facts:s}):null;return k.default.createElement(He,{icon:k.default.createElement(Ze,null),title:"Edit plan blocks",summary:r.length===0?"no block":r.join(" \xB7 "),state:t,body:a,errorSummary:o})}function Qf(e){let{args:n,state:t,result:i,resultText:o,ticketId:r,errorText:s,errorSummary:a}=Ge(e),l=Cl(i),d=_l(i),c=Yo(),u=typeof n?.index=="number"?n.index:null,p=Qn(e.sessionId,r)??"ticket",f=u===null?p+" \xB7 evidence":p+" \xB7 evidence ["+String(u)+"]",b=s!==null&&s!==""?en(s):l.length===0&&d.length===0?i===null?xt(o):null:k.default.createElement(k.default.Fragment,null,k.default.createElement("ul",{className:"aidos-evidence-list"},l.map(w=>k.default.createElement(Je,{key:String(w.index)+":"+w.kind,row:{kind:w.kind,payload:w.payload,author:w.author,at:w.at},onView:c.open}))),d.map((w,x)=>k.default.createElement("div",{className:"aidos-comment",key:x},k.default.createElement("div",null,k.default.createElement("span",{className:"aidos-evidence-author"},w.author)),k.default.createElement("p",{className:"aidos-detail-body"},w.body))),c.viewer);return k.default.createElement(He,{icon:k.default.createElement(In,null),title:"Read evidence",summary:f,state:t,body:b,errorSummary:a,ticketId:r,sessionId:e.sessionId,useProjection:e.useProjection})}function Yo(){let[e,n]=k.default.useState(null);return{open:n,viewer:e===null?null:k.default.createElement(Nn,{row:e,onClose:()=>{n(null)}})}}var Ul=[["get_tickets",Ff],["get_ticket",jf],["get_evidence",Qf],["set_ticket",$f],["attach_evidence",Bf],["move_ticket",zf],["request_allowlist",Vf],["suggest_actions",qf],["plan",Uf],["plan_import",Hf],["plan_meta",Gf],["plan_meta_set",Wf]];var Zf="aidos",Jf=["slots"],Yf="aidos";function Xf(){if(!(typeof document>"u"))for(let e of[{marker:"aidos/board.css",text:rr},{marker:"aidos/plan-meta.css",text:ar},{marker:"aidos/tool-render.css",text:sr}]){if(document.querySelector(`style[data-plugin-css="${e.marker}"]`)!==null)continue;let n=document.createElement("style");n.dataset.plugin="aidos",n.dataset.pluginCss=e.marker,n.textContent=e.text,document.head.appendChild(n)}}function eh(e,n){return function(i){try{return n(i)}catch(o){return console.warn(`aidos: the ${e} tool row failed to render`,o),St.default.createElement("div",{className:"tool-render-card"},St.default.createElement("div",{className:"tool-render-row","data-state":"error"},St.default.createElement("span",{className:"tool-render-title"},e),St.default.createElement("span",{className:"tool-render-sep"}),St.default.createElement("span",{className:"tool-render-summary"},"this card could not render; the call itself was unaffected")))}}}function nh(e){let n=[];for(let[t,i]of[...Rl,...Ul])try{n.push(e.register({name:"tool.call.toolview",key:t,priority:-100},eh(t,i)))}catch(o){console.warn(`aidos: the ${t} tool row could not register; the other rows continue`,o)}return function(){for(let t of n)t()}}function Hl(e){return e.inject("conversation.view",()=>e.register({name:"conversation.view",id:"tickets",order:20,label:_t},Os))}function th(e){Xf(),e.effect(()=>{let r=e.get("slots");return r===void 0?()=>{}:nh(r)},"aidos: scratch tool rows");let n=null,t=!1,i=_t();function o(r){t&&n===null&&(n=Hl(r),i=_t()),!t&&n!==null&&(n(),n=null)}e.effect(function(){let r=e.get("slots");if(r===void 0)return()=>{};let s=e.get("sessions");if(s===void 0||typeof s.list?.getSnapshot!="function"||typeof s.list?.subscribe!="function")return t=!0,o(r),function(){t=!1,o(r)};let a=s.list.getSnapshot(),l=function(){let c=a.current?a.byId[a.current]?.agentPreset:void 0;t=c===void 0||c===Yf,o(r),Lr(a.current??null)},d=s.list.subscribe(function(){a=s.list.getSnapshot(),l()});return l(),function(){d(),t=!1,o(r)}},"aidos: tickets tab visibility"),Pr(function(){if(n===null)return;let r=_t();if(r===i)return;let s=e.get("slots");if(s!==void 0)try{n(),n=Hl(s),i=r,console.info(`[aidos] tab re-registered for label "${r}" <- this remounts the board`)}catch(a){n=null,console.error("aidos: the Tickets tab failed to re-register after a badge change; the tab may show a stale count until the next visibility change",a)}})}
