...
function apply(ctx) {
  ...
  ctx.effect(function() {
    ...
    const list = { current: sessions.list.getSnapshot() };
    const sync = function() {
      const preset = list.current.current ? list.current.byId[list.current.current]?.agentPreset : void 0;
      const want = preset === void 0 || preset === AIDOS_PRESET;
