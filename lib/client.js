...
function TicketView(props) {
  ...
  return /* @__PURE__ */ import_react4.default.createElement("div", { className: "aidos-root" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "aidos-toolbar" }, /* @__PURE__ */ import_react4.default.createElement("span", { className: "aidos-empty-note" }, props.tickets.length + " of " + props.allTicketsCount + " tickets"), /* @__PURE__ */ import_react4.default.createElement("span", { className: "aidos-toolbar-actions" }, props.onQueue !== void 0 ? /* @__PURE__ */ import_react4.default.createElement(
    "button",
    {
      className: "aidos-btn",
    ...
    "Waiting on you",
    props.queueCount !== void 0 && props.queueCount > 0 ? /* @__PURE__ */ import_react4.default.createElement("span", { className: "aidos-queue-badge" }, props.queueCount) : null
  ) : null, /* @__PURE__ */ import_react4.default.createElement("button", { className: "aidos-btn", onClick: props.onPlan }, "Plan"), /* @__PURE__ */ import_react4.default.createElement("button", { className: "aidos-btn aidos-btn-primary", onClick: props.onCreate }, "Create"))), /* @__PURE__ */ import_react4.default.createElement(
    FilterPanel,
    {
...
function WarningIcon() {
  return /* @__PURE__ */ import_react9.default.createElement(
    ...
    /* @__PURE__ */ import_react9.default.createElement("path", { d: "M6 1.5l4.5 8h-9z" }),
    /* @__PURE__ */ import_react9.default.createElement("path", { d: "M6 4.75v2.5" }),
    /* @__PURE__ */ import_react9.default.createElement("path", { d: "M6 8.6v.4" })
  );
}
...
function TailoredForm(props) {
  ...
  if (props.kind === "builtin:review_pass" || props.kind === "builtin:review_note" || props.kind === "builtin:comment") {
...
function CriteriaPanel(props) {
  ...
  return /* @__PURE__ */ import_react20.default.createElement("details", { className: "aidos-panel" }, /* @__PURE__ */ import_react20.default.createElement("summary", { className: "aidos-panel-head" }, /* @__PURE__ */ import_react20.default.createElement("span", { className: "aidos-panel-title" }, "Criteria " + covered + "/" + lines.length)), /* @__PURE__ */ import_react20.default.createElement("div", { className: "aidos-panel-body" }, lines.length === 0 ? /* @__PURE__ */ import_react20.default.createElement("p", { className: "aidos-detail-note" }, "No criteria yet \u2014 add the first one below.") : null, /* @__PURE__ */ import_react20.default.createElement("ul", { className: "aidos-criteria" }, lines.map((line, index) => /* @__PURE__ */ import_react20.default.createElement(
    ...
    editingIndex === index ? /* @__PURE__ */ import_react20.default.createElement(
    ...
    ) : /* @__PURE__ */ import_react20.default.createElement("span", { className: "aidos-criterion-row" }, uncoveredSet.has(line) ? /* @__PURE__ */ import_react20.default.createElement(
      "span",
      {
      ...
      /* @__PURE__ */ import_react20.default.createElement(WarningIcon, null)
    ) : null, /* @__PURE__ */ import_react20.default.createElement("span", { className: "aidos-criterion-text" }, line), /* @__PURE__ */ import_react20.default.createElement("span", { className: "aidos-criterion-actions" }, /* @__PURE__ */ import_react20.default.createElement(
      "button",
      {
        className: "aidos-icon-btn",
        title: "Edit",
...
function derivedQueue(tickets, evidenceKindsOf) {
  ...
  for (const ticket of tickets) {
    ...
    for (const action of actionsFor(ticket, kinds)) {
      ...
      if (action.unavailableReason !== void 0) continue;
      entries.push({
        ticket,
        actionId: action.id,
        label: action.label,
...
function humanQueue(tickets, evidenceKindsOf, nominations = [], sortKey = "suggested") {
  const entries = derivedQueue(tickets, evidenceKindsOf);
  for (const nomination of nominations) {
    const key = String(nomination.ticketId);
    const match = entries.find(
      (entry) => String(entry.ticket.id) === key && entry.actionId === nomination.actionId
    );
...
function TicketStrip(props) {
  ...
  return /* @__PURE__ */ import_react23.default.createElement("li", { className }, /* @__PURE__ */ import_react23.default.createElement("div", { className: "aidos-ticket-strip-main" }, /* @__PURE__ */ import_react23.default.createElement(
    "span",
    {
      className: "aidos-chip aidos-chip-id",
    ...
    ticketChipLabel(ticket)
  ), /* @__PURE__ */ import_react23.default.createElement("span", { className: "aidos-ticket-strip-body" }, /* @__PURE__ */ import_react23.default.createElement("span", { className: "aidos-ticket-strip-title", title: ticket.title }, ticket.title), props.meta !== void 0 ? /* @__PURE__ */ import_react23.default.createElement("span", { className: "aidos-ticket-strip-meta" }, props.meta) : null), /* @__PURE__ */ import_react23.default.createElement("span", { className: "aidos-ticket-strip-chips" }, /* @__PURE__ */ import_react23.default.createElement("span", { className: badgeClass(ticket.state) }, stateLabel(ticket.state)), showGate ? /* @__PURE__ */ import_react23.default.createElement("span", { className: "aidos-chip aidos-chip-metric", title: "Gate progress" }, /* @__PURE__ */ import_react23.default.createElement("span", { className: "aidos-chip-key" }, "Gate"), /* @__PURE__ */ import_react23.default.createElement("span", { className: "aidos-chip-value" }, formatGateFraction(
    ticket.gatePresent ?? null,
    ticket.gateTotal ?? null,
    hasCriteria(ticket)
  ))) : null), /* @__PURE__ */ import_react23.default.createElement("span", { className: "aidos-ticket-strip-actions" }, props.onOpen !== void 0 ? /* @__PURE__ */ import_react23.default.createElement(
    "button",
    {
      className: "aidos-icon-btn",
      title: "Open " + full,
    ...
    /* @__PURE__ */ import_react23.default.createElement(PopOutIcon, null)
  ) : null, props.actions)));
}
...
function QueuePanel(props) {
  ...
  const entries = humanQueue(
    props.tickets,
    (ticket) => (props.evidenceByTicket[String(ticket.id)] ?? []).map((row) => row.kind),
    props.nominations ?? [],
    sortKey
  );
  if (entries.length === 0) {
  ...
  return /* @__PURE__ */ import_react25.default.createElement("div", { className: "aidos-queue" }, /* @__PURE__ */ import_react25.default.createElement("div", { className: "aidos-queue-head" }, /* @__PURE__ */ import_react25.default.createElement("span", { className: "aidos-queue-count" }, entries.length + (entries.length === 1 ? " ask" : " asks")), /* @__PURE__ */ import_react25.default.createElement("label", { className: "aidos-queue-sort" }, /* @__PURE__ */ import_react25.default.createElement("span", null, "Sort"), /* @__PURE__ */ import_react25.default.createElement(
  ...
  ))), /* @__PURE__ */ import_react25.default.createElement("ul", { className: "aidos-ticket-strips" }, entries.map((entry) => /* @__PURE__ */ import_react25.default.createElement(
    TicketStrip,
    {
      key: String(entry.ticket.id) + ":" + entry.actionId,
      ticket: entry.ticket,
      highlighted: entry.nominationReason !== void 0,
    ...
    ApprovalRunner,
    {
      ...
      onResolve: (outcome) => {
        ...
        setWorking(true);
        void props.onAct(running, outcome).catch(() => void 0).then(() => {
          setWorking(false);
          setRunning(null);
        });
      }
...
function queueEntriesFor(tickets, evidenceByTicket, nominations = []) {
  return humanQueue(
    tickets,
    (ticket) => (evidenceByTicket[String(ticket.id)] ?? []).map((row) => row.kind),
    nominations
  );
}
...
function ProjectionReader(props) {
  ...
  const [selectedKey, setSelectedKey] = import_react27.default.useState(null);
  ...
  const detailPanel = selectedTicket === null ? null : /* @__PURE__ */ import_react27.default.createElement(
    DetailView,
    {
