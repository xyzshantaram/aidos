...
function AttachEvidenceRow(props) {
  ...
  const body = errorText2 !== null && errorText2 !== "" ? errorBody(errorText2) : kind !== void 0 ? /* @__PURE__ */ import_react31.default.createElement("ul", { className: "aidos-evidence-list" }, /* @__PURE__ */ import_react31.default.createElement(
    EvidenceStrip,
    {
      row: {
