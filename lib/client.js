...
function EvidenceTags({ evidence }) {
  ...
  return /* @__PURE__ */ import_react2.default.createElement("div", { className: "aidos-evidence-row" }, counts2.map((count) => /* @__PURE__ */ import_react2.default.createElement(
    "span",
    {
      key: count.kind,
...
function TicketView(props) {
  ...
  return /* @__PURE__ */ import_react4.default.createElement("div", { className: "aidos-root" }, /* @__PURE__ */ import_react4.default.createElement(
    FilterPanel,
    {
  ...
  ), /* @__PURE__ */ import_react4.default.createElement("div", { className: "aidos-grid-wrap" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "aidos-grid-chrome" }, /* @__PURE__ */ import_react4.default.createElement("span", { className: "aidos-empty-note" }, props.tickets.length + " of " + props.allTicketsCount + " tickets"), /* @__PURE__ */ import_react4.default.createElement("button", { className: "aidos-btn", onClick: props.onPlan }, "Plan"), /* @__PURE__ */ import_react4.default.createElement("button", { className: "aidos-btn aidos-btn-primary", onClick: props.onCreate }, "Create")), content));
}
...
function FieldEditor(props) {
  ...
  const [draft, setDraft] = import_react5.default.useState(String(props.value));
  ...
  if (editing) {
    ...
    return /* @__PURE__ */ import_react5.default.createElement("div", { className: "aidos-field-editor" }, isTextarea ? /* @__PURE__ */ import_react5.default.createElement(
      "textarea",
      {
    ...
    ), /* @__PURE__ */ import_react5.default.createElement("span", null, /* @__PURE__ */ import_react5.default.createElement("button", { className: "aidos-btn", disabled: saving, onClick: save }, "Save"), " ", /* @__PURE__ */ import_react5.default.createElement("button", { className: "aidos-btn", disabled: saving, onClick: cancel }, "Cancel")));
  }
  return /* @__PURE__ */ import_react5.default.createElement("div", { className: "aidos-field-editor" }, /* @__PURE__ */ import_react5.default.createElement("span", null, props.children !== void 0 ? props.children : String(props.value), " ", /* @__PURE__ */ import_react5.default.createElement("button", { className: "aidos-btn", onClick: beginEdit }, "Edit")));
}
...
function ActionBar(props) {
  ...
  const buttons = actions.map((action) => {
    ...
    if (action.id === "submit-for-review") {
      return /* @__PURE__ */ import_react6.default.createElement("details", { className: "aidos-spoiler", key: action.id }, /* @__PURE__ */ import_react6.default.createElement("summary", { className: "aidos-spoiler-summary" }, "Advanced"), /* @__PURE__ */ import_react6.default.createElement(
        "button",
        {
    ...
    return /* @__PURE__ */ import_react6.default.createElement("button", { className, key: action.id, onClick: opener }, action.label);
  });
  return /* @__PURE__ */ import_react6.default.createElement("div", { className: "aidos-action-bar" }, buttons);
}
...
function CommentsSection(props) {
  ...
  const [collapsed, setCollapsed] = import_react7.default.useState(comments.length === 1);
  const [draft, setDraft] = import_react7.default.useState("");
  const [sending, setSending] = import_react7.default.useState(false);
  ...
  const rows = newestFirst.map((comment, index) => {
    ...
    return /* @__PURE__ */ import_react7.default.createElement("div", { className: "aidos-comment", key: index }, /* @__PURE__ */ import_react7.default.createElement("div", null, /* @__PURE__ */ import_react7.default.createElement("span", { className: "aidos-evidence-author" }, comment.author)), /* @__PURE__ */ import_react7.default.createElement("p", { className: "aidos-detail-body" }, comment.text), /* @__PURE__ */ import_react7.default.createElement("p", { className: "aidos-detail-note" }, time));
  });
  return /* @__PURE__ */ import_react7.default.createElement("div", { className: "aidos-comments-section" }, /* @__PURE__ */ import_react7.default.createElement("div", { className: "aidos-panel-head" }, /* @__PURE__ */ import_react7.default.createElement("h4", { className: "aidos-panel-title" }, "Comments"), /* @__PURE__ */ import_react7.default.createElement(
    "button",
    {
      className: "aidos-btn aidos-toggle-btn",
      onClick: () => {
  ...
  )), collapsed ? null : /* @__PURE__ */ import_react7.default.createElement(import_react7.default.Fragment, null, rows.length === 0 ? /* @__PURE__ */ import_react7.default.createElement("p", { className: "aidos-detail-note" }, "No comments yet.") : rows, /* @__PURE__ */ import_react7.default.createElement(
    "textarea",
    {
...
function EvidenceAttachForm(props) {
  ...
  const [kind, setKind] = import_react8.default.useState(kinds.length > 0 ? kinds[0].id : "");
  ...
  return /* @__PURE__ */ import_react8.default.createElement(
    ...
    /* @__PURE__ */ import_react8.default.createElement("div", { className: "aidos-modal-row" }, /* @__PURE__ */ import_react8.default.createElement("label", null, "Evidence kind"), /* @__PURE__ */ import_react8.default.createElement(
      "select",
      {
      ...
      kinds.map((descriptor) => /* @__PURE__ */ import_react8.default.createElement("option", { value: descriptor.id, key: descriptor.id }, descriptor.label))
    )),
    /* @__PURE__ */ import_react8.default.createElement("div", { className: "aidos-modal-row" }, /* @__PURE__ */ import_react8.default.createElement("label", null, "Note (optional)"), /* @__PURE__ */ import_react8.default.createElement(
      "textarea",
      {
...
function SignoffDialog(props) {
  ...
  return /* @__PURE__ */ import_react9.default.createElement(
    ...
    /* @__PURE__ */ import_react9.default.createElement(
      ...
      /* @__PURE__ */ import_react9.default.createElement("div", { className: "aidos-modal-head" }, /* @__PURE__ */ import_react9.default.createElement("h3", { className: "aidos-modal-title" }, "Sign off ticket"), /* @__PURE__ */ import_react9.default.createElement(
        "button",
        {
      ...
      /* @__PURE__ */ import_react9.default.createElement("p", { className: "aidos-modal-body" }, "Signoff grants the agent write access on this ticket. Confirm to proceed."),
      /* @__PURE__ */ import_react9.default.createElement("div", { className: "aidos-modal-form" }, /* @__PURE__ */ import_react9.default.createElement(
        "button",
        {
          className: "aidos-btn aidos-btn-primary",
          disabled: working,
...
function SendBackModal(props) {
  const [reason, setReason] = import_react10.default.useState("");
  ...
  return /* @__PURE__ */ import_react10.default.createElement(
    ...
    /* @__PURE__ */ import_react10.default.createElement(
      ...
      /* @__PURE__ */ import_react10.default.createElement("div", { className: "aidos-modal-head" }, /* @__PURE__ */ import_react10.default.createElement("h3", { className: "aidos-modal-title" }, "Send back"), /* @__PURE__ */ import_react10.default.createElement(
        "button",
        {
          className: "aidos-close-btn",
          onClick: () => {
      ...
      /* @__PURE__ */ import_react10.default.createElement("p", { className: "aidos-modal-body" }, "Send the ticket back to in progress. The reason attaches as a comment."),
      /* @__PURE__ */ import_react10.default.createElement("div", { className: "aidos-modal-form" }, /* @__PURE__ */ import_react10.default.createElement("div", { className: "aidos-modal-row" }, /* @__PURE__ */ import_react10.default.createElement("label", null, "Reason"), /* @__PURE__ */ import_react10.default.createElement(
        "textarea",
        {
          value: reason,
          disabled: working,
...
function MarkDoneModal(props) {
  const [step, setStep] = import_react11.default.useState(1);
  const [finalComment, setFinalComment] = import_react11.default.useState("");
  ...
  return /* @__PURE__ */ import_react11.default.createElement(
    ...
    /* @__PURE__ */ import_react11.default.createElement(
      ...
      /* @__PURE__ */ import_react11.default.createElement("div", { className: "aidos-modal-head" }, /* @__PURE__ */ import_react11.default.createElement("h3", { className: "aidos-modal-title" }, "Mark done"), /* @__PURE__ */ import_react11.default.createElement(
        "button",
        {
          className: "aidos-close-btn",
          onClick: () => {
      ...
      step === 1 ? /* @__PURE__ */ import_react11.default.createElement("div", { className: "aidos-modal-form" }, /* @__PURE__ */ import_react11.default.createElement("p", { className: "aidos-modal-body" }, "The ticket criteria:"), criteriaLines2.length === 0 ? /* @__PURE__ */ import_react11.default.createElement("p", { className: "aidos-detail-note" }, "No criteria on this ticket.") : /* @__PURE__ */ import_react11.default.createElement("ul", { className: "aidos-check-list" }, criteriaLines2.map((line) => /* @__PURE__ */ import_react11.default.createElement("li", { className: "aidos-check-row", key: line }, line))), /* @__PURE__ */ import_react11.default.createElement(
        "button",
        {
          className: "aidos-btn aidos-btn-primary",
          onClick: () => {
        ...
        "Continue"
      )) : /* @__PURE__ */ import_react11.default.createElement("div", { className: "aidos-modal-form" }, /* @__PURE__ */ import_react11.default.createElement("p", { className: "aidos-modal-body" }, "The evidence summary:"), summary.length === 0 ? /* @__PURE__ */ import_react11.default.createElement("p", { className: "aidos-detail-note" }, "No evidence rows yet.") : /* @__PURE__ */ import_react11.default.createElement("ul", { className: "aidos-check-list" }, summary.map((entry) => /* @__PURE__ */ import_react11.default.createElement("li", { className: "aidos-check-row", key: entry.kind }, entry.kind + ": " + entry.count))), /* @__PURE__ */ import_react11.default.createElement("div", { className: "aidos-modal-row" }, /* @__PURE__ */ import_react11.default.createElement("label", null, "Final comment (optional)"), /* @__PURE__ */ import_react11.default.createElement(
        "textarea",
        {
          value: finalComment,
          disabled: working,
...
function DescriptionPanel(props) {
  const [expanded, setExpanded] = import_react12.default.useState(false);
  ...
  let body;
  if (empty) {
    body = /* @__PURE__ */ import_react12.default.createElement("p", { className: "aidos-detail-note" }, "No description.");
  } else {
    body = /* @__PURE__ */ import_react12.default.createElement(import_react12.default.Fragment, null, /* @__PURE__ */ import_react12.default.createElement(
      "div",
      {
        className: "aidos-md" + (clipped ? " aidos-md-clipped" : ""),
        dangerouslySetInnerHTML: { __html: html }
      }
    ), long ? /* @__PURE__ */ import_react12.default.createElement(
      "button",
      {
  ...
  return /* @__PURE__ */ import_react12.default.createElement("div", { className: "aidos-panel" }, /* @__PURE__ */ import_react12.default.createElement("div", { className: "aidos-panel-head" }, /* @__PURE__ */ import_react12.default.createElement("h4", { className: "aidos-panel-title" }, "Description")), /* @__PURE__ */ import_react12.default.createElement("div", { className: "aidos-panel-body" }, /* @__PURE__ */ import_react12.default.createElement(
    FieldEditor,
    {
      field: "description",
...
function CriteriaPanel(props) {
  const [collapsed, setCollapsed] = import_react12.default.useState(false);
  ...
  const list = lines.length === 0 ? /* @__PURE__ */ import_react12.default.createElement("p", { className: "aidos-detail-note" }, "No criteria.") : /* @__PURE__ */ import_react12.default.createElement("ul", { className: "aidos-criteria" }, lines.map((line) => /* @__PURE__ */ import_react12.default.createElement(
    "li",
    {
      key: line,
  ...
  return /* @__PURE__ */ import_react12.default.createElement("div", { className: "aidos-panel" }, /* @__PURE__ */ import_react12.default.createElement("div", { className: "aidos-panel-head" }, /* @__PURE__ */ import_react12.default.createElement("h4", { className: "aidos-panel-title" }, "Criteria " + covered + "/" + lines.length), /* @__PURE__ */ import_react12.default.createElement(
    "button",
    {
    ...
    collapsed ? "Expand" : "Collapse"
  )), collapsed ? null : /* @__PURE__ */ import_react12.default.createElement("div", { className: "aidos-panel-body" }, /* @__PURE__ */ import_react12.default.createElement(
    FieldEditor,
    {
      field: "criteria",
      ticketId: props.ticketIdKey,
...
function DependencySection(props) {
  ...
  const [hits, setHits] = import_react12.default.useState(null);
  const [searching, setSearching] = import_react12.default.useState(false);
  const [adding, setAdding] = import_react12.default.useState(null);
  const [collapsed, setCollapsed] = import_react12.default.useState(false);
  ...
  const body = /* @__PURE__ */ import_react12.default.createElement(import_react12.default.Fragment, null, /* @__PURE__ */ import_react12.default.createElement("div", { className: "aidos-dep-row" }, current.length === 0 ? /* @__PURE__ */ import_react12.default.createElement("p", { className: "aidos-detail-note" }, "No dependencies.") : current.map((ref) => /* @__PURE__ */ import_react12.default.createElement("span", { key: ref, className: "aidos-chip aidos-chip-dep", title: ref }, displayDep(ref)))), /* @__PURE__ */ import_react12.default.createElement("div", { className: "aidos-dep-search" }, /* @__PURE__ */ import_react12.default.createElement(
    "input",
    {
    ...
    "Search"
  )), hits !== null ? /* @__PURE__ */ import_react12.default.createElement("div", { className: "aidos-dep-results" }, hits.length === 0 ? /* @__PURE__ */ import_react12.default.createElement("p", { className: "aidos-detail-note" }, "No matches.") : hits.map((hit) => /* @__PURE__ */ import_react12.default.createElement(
    "button",
    {
      key: refOf(hit),
    ...
    /* @__PURE__ */ import_react12.default.createElement("span", { className: "aidos-suggestion-title" }, hit.title),
    /* @__PURE__ */ import_react12.default.createElement("span", { className: "aidos-chip aidos-chip-id" }, displayDep(refOf(hit)))
  ))) : null);
  return /* @__PURE__ */ import_react12.default.createElement("div", { className: "aidos-panel" }, /* @__PURE__ */ import_react12.default.createElement("div", { className: "aidos-panel-head" }, /* @__PURE__ */ import_react12.default.createElement("h4", { className: "aidos-panel-title" }, "Dependencies"), /* @__PURE__ */ import_react12.default.createElement(
    "button",
    {
      className: "aidos-panel-toggle",
      onClick: () => {
    ...
    collapsed ? "Expand" : "Collapse"
  )), collapsed ? null : /* @__PURE__ */ import_react12.default.createElement("div", { className: "aidos-panel-body" }, body));
}
function EvidencePanel(props) {
  const body = /* @__PURE__ */ import_react12.default.createElement("div", { className: "aidos-panel-body" }, props.evidence.length === 0 ? /* @__PURE__ */ import_react12.default.createElement("p", { className: "aidos-detail-note" }, "No evidence rows yet.") : /* @__PURE__ */ import_react12.default.createElement("ul", { className: "aidos-evidence-list" }, props.evidence.map((row, index) => /* @__PURE__ */ import_react12.default.createElement("li", { className: "aidos-evidence-item", key: row.at ?? index }, /* @__PURE__ */ import_react12.default.createElement("span", { className: "aidos-evidence-kind" }, kindLabel(row.kind)), /* @__PURE__ */ import_react12.default.createElement("span", { className: "aidos-evidence-author" }, row.author), typeof row.payload.criteria === "string" ? /* @__PURE__ */ import_react12.default.createElement("span", { className: "aidos-evidence-meta" }, "criterion: " + row.payload.criteria) : null, /* @__PURE__ */ import_react12.default.createElement(
    "button",
    {
  ...
  return /* @__PURE__ */ import_react12.default.createElement("div", { className: "aidos-panel" }, /* @__PURE__ */ import_react12.default.createElement("div", { className: "aidos-panel-head" }, /* @__PURE__ */ import_react12.default.createElement("h4", { className: "aidos-panel-title" }, "Evidence"), /* @__PURE__ */ import_react12.default.createElement("button", { className: "aidos-panel-toggle", onClick: props.onToggleEvidence }, props.evidenceCollapsed ? "Expand" : "Collapse")), props.evidenceCollapsed ? null : body);
}
function DetailPanel(props) {
  const ticket = props.ticket;
  const badge = badgeClass(ticket.state);
  const [deletingAt, setDeletingAt] = import_react12.default.useState(null);
  ...
  return /* @__PURE__ */ import_react12.default.createElement(import_react12.default.Fragment, null, /* @__PURE__ */ import_react12.default.createElement("div", { className: "aidos-detail-head" }, /* @__PURE__ */ import_react12.default.createElement(
    "span",
    {
      className: "aidos-chip aidos-chip-id",
      style: { background: idColor(fullTicketId(ticket)) },
  ...
  ), /* @__PURE__ */ import_react12.default.createElement("span", { className: badge }, stateLabel(ticket.state)), /* @__PURE__ */ import_react12.default.createElement("button", { className: "aidos-close-btn", onClick: props.onClose }, "\xD7")), /* @__PURE__ */ import_react12.default.createElement("dl", { className: "aidos-facts" }, /* @__PURE__ */ import_react12.default.createElement("div", { className: "aidos-facts-row" }, /* @__PURE__ */ import_react12.default.createElement("dt", { className: "aidos-facts-label" }, "State"), /* @__PURE__ */ import_react12.default.createElement("dd", { className: "aidos-facts-value" }, stateLabel(ticket.state))), /* @__PURE__ */ import_react12.default.createElement("div", { className: "aidos-facts-row" }, /* @__PURE__ */ import_react12.default.createElement("dt", { className: "aidos-facts-label" }, "Gate"), /* @__PURE__ */ import_react12.default.createElement("dd", { className: "aidos-facts-value" }, formatGateFraction(ticket.gatePresent, ticket.gateTotal, hasCriteria(ticket)))), /* @__PURE__ */ import_react12.default.createElement("div", { className: "aidos-facts-row" }, /* @__PURE__ */ import_react12.default.createElement("dt", { className: "aidos-facts-label" }, "Confidence"), /* @__PURE__ */ import_react12.default.createElement("dd", { className: "aidos-facts-value" }, String(ringPercent(ticket.confidenceScore)) + "%", /* @__PURE__ */ import_react12.default.createElement(
    "span",
    {
    ...
    "*"
  ))), /* @__PURE__ */ import_react12.default.createElement("div", { className: "aidos-facts-row" }, /* @__PURE__ */ import_react12.default.createElement("dt", { className: "aidos-facts-label" }, "Phase"), /* @__PURE__ */ import_react12.default.createElement("dd", { className: "aidos-facts-value" }, String(ticket.phase))), /* @__PURE__ */ import_react12.default.createElement("div", { className: "aidos-facts-row" }, /* @__PURE__ */ import_react12.default.createElement("dt", { className: "aidos-facts-label" }, "Order"), /* @__PURE__ */ import_react12.default.createElement("dd", { className: "aidos-facts-value" }, String(ticket.order))), /* @__PURE__ */ import_react12.default.createElement("div", { className: "aidos-facts-row" }, /* @__PURE__ */ import_react12.default.createElement("dt", { className: "aidos-facts-label" }, "Slug"), /* @__PURE__ */ import_react12.default.createElement("dd", { className: "aidos-facts-value" }, ticket.slug))), /* @__PURE__ */ import_react12.default.createElement(
    DescriptionPanel,
    {
      ticket,
...
function DetailView(props) {
  const [signoffOpen, setSignoffOpen] = import_react12.default.useState(false);
  const [sendBackOpen, setSendBackOpen] = import_react12.default.useState(false);
  const [markDoneOpen, setMarkDoneOpen] = import_react12.default.useState(false);
  const [submitting, setSubmitting] = import_react12.default.useState(false);
  const ticket = props.ticket;
  ...
  return /* @__PURE__ */ import_react12.default.createElement("div", { className: "aidos-detail" }, /* @__PURE__ */ import_react12.default.createElement(
    DetailPanel,
    {
      ticket,
      ticketIdKey: props.ticketIdKey,
  ...
  ), /* @__PURE__ */ import_react12.default.createElement(EvidenceAttachForm, { ticketId: props.ticketIdKey, agentId }), signoffOpen ? /* @__PURE__ */ import_react12.default.createElement(
    SignoffDialog,
    {
      open: true,
      ticketId: props.ticketIdKey,
  ...
  ) : null, sendBackOpen ? /* @__PURE__ */ import_react12.default.createElement(
    SendBackModal,
    {
      open: true,
      ticketId: props.ticketIdKey,
  ...
  ) : null, markDoneOpen ? /* @__PURE__ */ import_react12.default.createElement(
    MarkDoneModal,
    {
      open: true,
      ticketId: props.ticketIdKey,
...
function CreateTicketModal(props) {
  const [title, setTitle] = import_react13.default.useState("");
  const [description, setDescription] = import_react13.default.useState("");
  const [criteria, setCriteria] = import_react13.default.useState("");
  ...
  return /* @__PURE__ */ import_react13.default.createElement(
    ...
    /* @__PURE__ */ import_react13.default.createElement(
      ...
      /* @__PURE__ */ import_react13.default.createElement("div", { className: "aidos-modal-head" }, /* @__PURE__ */ import_react13.default.createElement("h3", { className: "aidos-modal-title" }, "Create a ticket"), /* @__PURE__ */ import_react13.default.createElement(
        "button",
        {
          className: "aidos-close-btn",
          onClick: () => {
      ...
      /* @__PURE__ */ import_react13.default.createElement("div", { className: "aidos-modal-form" }, /* @__PURE__ */ import_react13.default.createElement("div", { className: "aidos-modal-row" }, /* @__PURE__ */ import_react13.default.createElement("label", null, "Title"), /* @__PURE__ */ import_react13.default.createElement(
        "input",
        {
          type: "text",
          value: title,
      ...
      )), /* @__PURE__ */ import_react13.default.createElement("div", { className: "aidos-modal-row" }, /* @__PURE__ */ import_react13.default.createElement("label", null, "Description"), /* @__PURE__ */ import_react13.default.createElement(
        "textarea",
        {
          value: description,
          disabled: saving,
      ...
      )), /* @__PURE__ */ import_react13.default.createElement("div", { className: "aidos-modal-row" }, /* @__PURE__ */ import_react13.default.createElement("label", null, "Criteria"), /* @__PURE__ */ import_react13.default.createElement(
        "textarea",
        {
          value: criteria,
          disabled: saving,
...
function PlanMetaModal(props) {
  const [editing, setEditing] = import_react14.default.useState(null);
  ...
  function renderEditControls(key) {
    ...
    ), /* @__PURE__ */ import_react14.default.createElement("div", { className: "aidos-plan-meta-actions" }, /* @__PURE__ */ import_react14.default.createElement(
      "button",
      {
        className: "aidos-btn aidos-btn-primary",
        disabled: saving,
  ...
  function renderNamedBlock(key, label, text) {
    return /* @__PURE__ */ import_react14.default.createElement("div", { className: "aidos-plan-meta-block", key }, /* @__PURE__ */ import_react14.default.createElement("div", { className: "aidos-plan-meta-block-head" }, /* @__PURE__ */ import_react14.default.createElement("span", { className: "aidos-plan-meta-block-title" }, label), /* @__PURE__ */ import_react14.default.createElement(
      "button",
      {
        className: "aidos-btn",
        disabled: saving,
      ...
      "Edit"
    )), editing === key ? renderEditControls(key) : /* @__PURE__ */ import_react14.default.createElement("pre", { className: "aidos-plan-meta-text" }, text === "" ? "(empty)" : text));
  }
  function renderSectionBlock(position, heading, text) {
    const open = expanded.includes(position);
    return /* @__PURE__ */ import_react14.default.createElement("div", { className: "aidos-plan-meta-block", key: position }, /* @__PURE__ */ import_react14.default.createElement("div", { className: "aidos-plan-meta-block-head" }, /* @__PURE__ */ import_react14.default.createElement(
      "button",
      {
      ...
      /* @__PURE__ */ import_react14.default.createElement("span", { "aria-hidden": "true" }, open ? "\u25BE" : "\u25B8"),
      heading
    ), /* @__PURE__ */ import_react14.default.createElement(
      "button",
      {
      ...
      "Edit"
    )), editing === position || open ? editing === position ? renderEditControls(position) : /* @__PURE__ */ import_react14.default.createElement("pre", { className: "aidos-plan-meta-text" }, text === "" ? "(empty)" : text) : null);
  }
  ...
  return /* @__PURE__ */ import_react14.default.createElement(
    ...
    /* @__PURE__ */ import_react14.default.createElement(
      ...
      /* @__PURE__ */ import_react14.default.createElement("div", { className: "aidos-modal-head" }, /* @__PURE__ */ import_react14.default.createElement("h3", { className: "aidos-modal-title" }, "Plan"), /* @__PURE__ */ import_react14.default.createElement(
        "button",
        {
          className: "aidos-close-btn",
          onClick: () => {
...
function ProjectionReader(props) {
  ...
  const [merge, setMergeState] = import_react16.default.useState(() => getMerge(sessionId));
  const [mergePending, setMergePending] = import_react16.default.useState(() => isMergePulling(sessionId) && getMerge(sessionId) === null);
  ...
  const [selectedKey, setSelectedKey] = import_react16.default.useState(null);
  const [createOpen, setCreateOpen] = import_react16.default.useState(false);
  const [planOpen, setPlanOpen] = import_react16.default.useState(false);
  ...
  if (error !== null) {
    ...
    body = /* @__PURE__ */ import_react16.default.createElement("div", { className: "aidos-merge-loading", role: "status" }, /* @__PURE__ */ import_react16.default.createElement("span", { className: "aidos-merge-spinner", "aria-hidden": "true" }), /* @__PURE__ */ import_react16.default.createElement("span", null, "Loading workspace tickets\u2026"));
  } else {
  ...
  const planModal = /* @__PURE__ */ import_react16.default.createElement(
    PlanMetaModal,
    {
      open: planOpen,
  ...
  return /* @__PURE__ */ import_react16.default.createElement(import_react16.default.Fragment, null, /* @__PURE__ */ import_react16.default.createElement("div", { className: "aidos-layout" }, body, detailPanel), createModal, planModal, /* @__PURE__ */ import_react16.default.createElement(ToastContainer, null));
}
