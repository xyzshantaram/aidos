...
function GetTicketsRow(props) {
  ...
  const body = state === "error" ? errorBody(errorText2) : lines.length === 0 ? null : /* @__PURE__ */ import_react29.default.createElement("ul", { className: "aidos-tool-list" }, lines.map((line) => /* @__PURE__ */ import_react29.default.createElement("li", { key: line.id }, /* @__PURE__ */ import_react29.default.createElement("span", { className: "aidos-tool-list-key" }, "#", line.id), line.state === "" ? null : /* @__PURE__ */ import_react29.default.createElement("span", { className: "aidos-tool-list-tag" }, line.state), /* @__PURE__ */ import_react29.default.createElement("span", { className: "aidos-tool-list-text", title: line.title, "data-dsh-tip": "" }, line.title))));
  return /* @__PURE__ */ import_react29.default.createElement(
    AidosRow,
    {
...
function RequestAllowlistRow(props) {
  ...
  const body = state === "error" ? errorBody(errorText2) : paths.length === 0 ? null : /* @__PURE__ */ import_react29.default.createElement("ul", { className: "aidos-tool-list" }, paths.map((entry) => /* @__PURE__ */ import_react29.default.createElement("li", { key: entry.path }, /* @__PURE__ */ import_react29.default.createElement("span", { className: "aidos-tool-list-text" }, entry.path), entry.created ? /* @__PURE__ */ import_react29.default.createElement("span", { className: "aidos-tool-list-tag", title: "Does not exist yet; approving creates it", "data-dsh-tip": "" }, "will be created") : null)));
  return /* @__PURE__ */ import_react29.default.createElement(
    AidosRow,
    {
...
function SuggestActionsRow(props) {
  ...
  const body = state === "error" ? errorBody(errorText2) : lines.length === 0 ? null : /* @__PURE__ */ import_react29.default.createElement("ul", { className: "aidos-tool-list" }, lines.map((line) => /* @__PURE__ */ import_react29.default.createElement("li", { key: line.ticketId + ":" + line.actionId }, /* @__PURE__ */ import_react29.default.createElement("span", { className: "aidos-tool-list-key" }, "#", line.ticketId), /* @__PURE__ */ import_react29.default.createElement("span", { className: "aidos-tool-list-tag" }, line.actionId), /* @__PURE__ */ import_react29.default.createElement("span", { className: "aidos-tool-list-text", title: line.reason, "data-dsh-tip": "" }, line.reason))));
  return /* @__PURE__ */ import_react29.default.createElement(
    AidosRow,
    {
