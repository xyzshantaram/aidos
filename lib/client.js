...
.aidos-queue-count {
  margin-left: 6px;
  font-weight: 700;
  /* Inherit: on the attention state the button paints the text white, and
     a colour here would fight it. */
  color: inherit;
}

/* #131: the attention state. The button itself turns blue with white text
   when the agent has asked for something the gate ALLOWS -- a signal
   visible from any screen the toolbar is on, which is the whole ask (a
   nomination used to be invisible until the queue was opened). */
.aidos-btn.aidos-btn-attention {
  background: var(--accent-blue);
  border-color: var(--accent-blue);
  color: #fff;
}

.aidos-btn.aidos-btn-attention:hover {
  /* Keep the blue on hover: the neutral hover background would read as the
     state clearing itself under the cursor. */
  background: var(--accent-blue);
  border-color: var(--accent-blue);
  color: #fff;
...
function queueButtonState(nominated) {
  ...
  return /* @__PURE__ */ import_react5.default.createElement("div", { className: "aidos-root" }, /* @__PURE__ */ import_react5.default.createElement("div", { className: "aidos-toolbar" }, /* @__PURE__ */ import_react5.default.createElement("span", { className: "aidos-empty-note" }, props.tickets.length + " of " + props.allTicketsCount + " tickets"), /* @__PURE__ */ import_react5.default.createElement("span", { className: "aidos-toolbar-actions" }, props.onQueue !== void 0 ? (
    ...
    /* @__PURE__ */ import_react5.default.createElement(
      "button",
      {
        ...
        title: (queueButton.indicator ? "The agent has asked for something you can act on" : "What is waiting on you") + /*
         ...
         */
        (props.agentAskCountStale === true ? " (the last refresh failed; showing the last known count)" : ""),
        "data-dsh-tip": ""
      },
      "Waiting on you",
      queueButton.count !== null ? /* @__PURE__ */ import_react5.default.createElement("b", { className: "aidos-queue-count" }, queueButton.count) : null
    )
