...
`,e=e.substring(p.length+1),l=!0),!l){let k=this.rules.other.nextBulletRegex(v),A=this.rules.other.hrRegex(v),w=this.rules.other.fencesBeginRegex(v),O=this.rules.other.headingBeginRegex(v),L=this.rules.other.htmlBeginRegex(v),ee=this.rules.other.blockquoteBeginRegex(v);for(;e;){let I=e.split(`
`,1)[0],te;if(p=I,this.options.pedantic?(p=p.replace(this.rules.other.listReplaceNesting,"  "),te=p):te=p.replace(this.rules.other.tabCharGlobal,"    "),w.test(p)||O.test(p)||L.test(p)||ee.test(p)||k.test(p)||A.test(p))break;if(te.search(this.rules.other.nonSpaceChar)>=v||!p.trim())c+=`
`+te.slice(v);else{if(h||f.replace(this.rules.other.tabCharGlobal,"    ").search(this.rules.other.nonSpaceChar)>=4||w.test(f)||O.test(f)||A.test(f))break;c+=`
`+p}h=!p.trim(),d+=I+`
...
`))if(jg.test(t))return t;return $g(e)}function Ug(e){let n=Go(e);if(n===null)return null;let{code:t,message:i}=n;return i===null?t:t===null?i:`${t} \u2014 ${i}`}var Vg=new Set(["tool_error","Error","error"]),qg=[/^gate refused/i,/\brefused\b/i,/is not one of the ticket's criteria/i,/cannot attach kind/i,/outside the allowlist/i,/\bnot permitted\b/i];function Go(e){let n=e.indexOf("{"),t=e.lastIndexOf("}");if(n===-1||t<=n)return null;let i;try{i=JSON.parse(e.slice(n,t+1))}catch{return null}if(i===null||typeof i!="object"||Array.isArray(i))return null;let o=i,r=typeof o.message=="string"?o.message:null,s=typeof o.code=="string"?o.code:typeof o.error=="string"?o.error:null,a=s!==null&&Vg.has(s)&&r!==null?null:s,l={};for(let[c,f]of Object.entries(o))c==="ok"||c==="error"||c==="code"||c==="message"||(l[c]=f);let d=r??s??"";return{code:a,message:r,extra:l,refusal:qg.some(c=>c.test(d))}}function kc(e,n){if(n===void 0||n==="")return e;let t=n.endsWith("/")?n:n+"/";return e.startsWith(t)?e.slice(t.length):e}function da(e){if(e===null||e==="")return e;try{let n=JSON.parse(e);if(n===null||typeof n!="object")return e;let t=n;return typeof t.content=="string"?t.content:typeof t.message=="string"?t.message:e}catch{return e}}function Hg(e){let n=0;for(let o=0;o<e.length;o++)n=n*31+e.charCodeAt(o)|0;n=Math.abs(n);let i=n*.6180339887498949%1;return Math.floor(i*360)}function Wo(e,n){if(n)return{background:"color-mix(in srgb, var(--dsw-alias-state-error-primary) 85%, black)",borderColor:"var(--dsw-alias-state-error-primary)",color:"#fff"};let t=Hg(e);return{background:`color-mix(in srgb, hsl(${t} 65% 45%) 55%, var(--dsw-alias-bg-tertiary))`,borderColor:`hsl(${t} 55% 60%)`}}function Gg({state:e,open:n}){return ve.default.createElement(bo,{open:n})}function Qo({title:e,icon:n,summary:t,state:i,body:o,errorSummary:r,path:s,openFile:a,inspect:l}){let[d,c]=ve.default.useState(!1),f=o!==null||l!==void 0,p=d&&f,h=i==="error"&&r!==void 0,v=h?r:t,k=!h&&s!==void 0&&a!==void 0,A=()=>{s!==void 0&&a!==void 0&&a(s)};return ve.default.createElement("div",{className:"tool-render-card","data-error":i==="error"||void 0,"data-stopped":i==="stopped"||void 0},ve.default.createElement("div",{className:"tool-render-row","data-state":i,"data-expandable":f?!0:void 0,role:f?"button":void 0,tabIndex:f?0:void 0,"aria-expanded":f?p:void 0,onClick:f?()=>c(!d):void 0,onKeyDown:f?w=>{(w.key==="Enter"||w.key===" ")&&(w.preventDefault(),c(!d))}:void 0},f?ve.default.createElement(Gg,{state:i,open:p}):null,ve.default.createElement("span",{className:"tool-render-name-badge",style:Wo(e,i==="error")},ve.default.createElement("span",{className:"tool-render-name-badge-icon"},n),ve.default.createElement("span",{className:"tool-render-name-badge-text",title:e,"data-dsh-tip":""},e)),ve.default.createElement("span",{className:"tool-render-sep","aria-hidden":"true"}),k?ve.default.createElement("span",{className:"tool-render-path",role:"link",tabIndex:0,title:s,"data-dsh-tip":"",onClick:w=>{w.stopPropagation(),A()},onKeyDown:w=>{(w.key==="Enter"||w.key===" ")&&(w.preventDefault(),w.stopPropagation(),A())}},v):ve.default.createElement("span",{className:"tool-render-summary","tool-render-error":h?!0:void 0,title:v,"data-dsh-tip":""},v)),p?ve.default.createElement("div",{className:"tool-render-body"},o,l!==void 0?ve.default.createElement("button",{type:"button",className:"tool-render-inspect",onClick:l},ve.default.createElement($s,null),"Inspect"):null):null)}function Yo(e,n){let t=Uo(jo(e.block)),i=Vo(e.block),o=vi(t,["path","file_path"]),r=i==="error"?qo(e.block):null,s=o!==void 0?kc(o,e.cwd):n,a=r!==null&&r!==""?Ho(r):void 0;return{args:t,state:i,summary:s,errorText:r,errorSummary:a,path:o,openFile:e.openFile,inspect:e.inspect}}function Zo(e,n){return e===null||e===""?null:ve.default.createElement("pre",{className:"tool-render-output","tool-render-error":n?!0:void 0},e)}function Wg(e,n){return xc(la(e,yc(null,e)),n)}function xc(e,n){let t=mc(n??""),i=wc(e.map(o=>o.number));return ve.default.createElement("div",{className:"tool-render-code"},e.map((o,r)=>ve.default.createElement("div",{className:"tool-render-code-row",key:r},ve.default.createElement("span",{className:"tool-render-gutter","aria-hidden":"true",style:{width:i}},o.number===null?"":String(o.number)),ve.default.createElement("code",{className:"tool-render-line-cell hljs","data-highlighted":"yes",dangerouslySetInnerHTML:{__html:bc(o.text,t)}}))))}function Qg(e,n){return ve.default.createElement("div",{className:"tool-render-write"},ve.default.createElement("div",{className:"tool-render-write-note"},"No earlier version on record; new content below"),xc(la(e,1),n))}function Yg(e){let n=Yo(e,"Read"),{args:t,state:i,errorText:o}=n,r=i==="error"?o:da(St(e.block)),s=vi(t,["path","file_path"]),a=i==="error"||r===null||r===""?Zo(r,i==="error"):Wg(r,s);return ve.default.createElement(Qo,{...n,icon:ve.default.createElement(et,null),title:"Scratch read",body:a})}function Zg(e){let n=Yo(e,"Write"),{args:t,state:i,errorText:o}=n,r=i==="error"?o:vi(t,["content"])??null,s=i==="error"||r===null||r===""?Zo(r,i==="error"):Qg(r,n.path);return ve.default.createElement(Qo,{...n,icon:ve.default.createElement(Tn,null),title:"Scratch write",body:s})}function Jg(e){let n=Yo(e,"Edit"),{args:t,state:i,errorText:o}=n,r;if(i==="error")r=o;else{let s=vi(t,["old_string"]),a=vi(t,["new_string"]);r=s!==void 0||a!==void 0?`- ${s??""}
+ ${a??""}`:da(St(e.block))}return ve.default.createElement(Qo,{...n,icon:ve.default.createElement(Tn,null),title:"Scratch edit",body:Zo(r,i==="error")})}function Xg(e){let n=Yo(e,"Mkdir"),{state:t,errorText:i}=n;return ve.default.createElement(Qo,{...n,icon:ve.default.createElement(li,null),title:"Scratch mkdir",body:Zo(t==="error"?i:null,t==="error")})}var Sc=[["scratch_read",Yg],["scratch_write",Zg],["scratch_edit",Jg],["scratch_mkdir",Xg]];var m=le(require("react"),1);function qn(e){return e!==null&&typeof e=="object"&&!Array.isArray(e)?e:null}function Hn(e){return Array.isArray(e)?e:[]}function me(e){return typeof e=="string"?e:typeof e=="number"||typeof e=="boolean"?String(e):null}function ca(e,n=120){let i=(typeof e=="string"?e:JSON.stringify(e)??"").replace(/\s+/g," ").trim();return i.length>n?i.slice(0,n-1)+"\u2026":i}function ua(e){if(typeof e=="string")return e;if(e===void 0)return"";try{return JSON.stringify(e,null,2)??String(e)}catch{return String(e)}}function Ne(e,n,t){let i=ca(n,t?.max),o=n.trim(),r=o!==i,s=/\n/.test(o);return!r&&!s?{label:e,value:i}:{label:e,value:i,full:o,...t?.markdown===!0?{markdown:!0}:{},...t?.open===!0?{open:!0}:{}}}function pa(e){let n=qn(e?.ticket);if(n===null)return[];let t=[],i=me(n.state);i!==null&&t.push({label:"State",value:i});let o=n.gatePresent,r=n.gateTotal;typeof o=="number"&&typeof r=="number"&&t.push({label:"Gate",value:`${o}/${r}`});let s=me(n.description);s!==null&&s.trim()!==""&&t.push(Ne("Description",s,{markdown:!0}));let a=me(n.criteria);a!==null&&a.trim()!==""&&t.push(Ne("Criteria",a));let l=me(n.body);l!==null&&l.trim()!==""&&t.push(Ne("Body",l,{markdown:!0}));let d=Hn(n.allowlist);d.length>0&&t.push(Ne("Allowlist",d.map(p=>String(p)).join(" \xB7 ")));let c=Hn(n.dependsOn);c.length>0&&t.push(Ne("Depends on",c.map(p=>String(p)).join(" \xB7 ")));let f=e?.commentCount;return typeof f=="number"&&f>0&&t.push({label:"Comments",value:String(f)}),t}function em(e){let n=[],t=e.gatePresent,i=e.gateTotal;typeof t=="number"&&typeof i=="number"&&n.push({label:"Gate",value:`${t}/${i}`});let o=e.confidenceScore;typeof o=="number"&&n.push({label:"Score",value:String(o)});let r=e.phase;typeof r=="number"&&n.push({label:"Phase",value:String(r)});let s=e.dependsOnCount;typeof s=="number"&&s>0&&n.push({label:"Depends on",value:String(s)});let a=e.allowlistCount;typeof a=="number"&&a>0&&n.push({label:"Allowlist",value:`${a} path${a===1?"":"s"}`});let l=me(e.descriptionExcerpt);if(l!==null&&l.trim()!==""){let c=e.descriptionTruncated===!0?l.trimEnd()+`

_(excerpt \u2014 read the ticket for the rest)_`:l;n.push(Ne("Description",c,{markdown:!0}))}return{id:me(e.id)??"?",state:me(e.state)??"",title:me(e.title)??"",facts:n}}function Tc(e){let n=qn(e?.ticket);if(n===null)return null;let t=me(n.title)??"";return t.trim()===""?null:{id:me(n.id)??"?",state:me(n.state)??"",title:t}}function Ec(e){return Hn(e?.tickets).map(n=>qn(n)).filter(n=>n!==null).map(n=>em(n))}function Rc(e){return Hn(e?.evidence).map(n=>qn(n)).filter(n=>n!==null).map(n=>({kind:me(n.kind)??"",author:me(n.author)??"agent",at:typeof n.at=="number"?n.at:void 0,excerpt:me(n.excerpt)??""})).filter(n=>n.kind!=="")}function Ac(e){return Hn(e?.evidence).map(n=>qn(n)).filter(n=>n!==null).map((n,t)=>({index:typeof n.index=="number"?n.index:t,kind:me(n.kind)??"",author:me(n.author)??"agent",at:typeof n.at=="number"?n.at:void 0,payload:qn(n.payload)??{}})).filter(n=>n.kind!=="")}function Ic(e){return Hn(e?.comments).map(n=>qn(n)).filter(n=>n!==null).map(n=>({author:me(n.author)??"user",at:typeof n.at=="number"?n.at:void 0,body:me(n.body)??""})).filter(n=>n.body!=="")}function Nc(e){if(e===null)return"all tickets";let n=[],i=(Array.isArray(e.stateIds)?e.stateIds:[e.stateIds]).map(c=>me(c)).filter(c=>c!==null&&c!=="");i.length>0&&n.push(i.join("|"));let o=me(e.search);o!==null&&o!==""&&n.push(`"${o}"`);let r=Hn(e.projectIds).map(c=>me(c)).filter(c=>c!==null&&c!==""),s=me(e.projectId);r.length>0?n.push(`projects ${r.join(",")}`):s!==null&&s!==""&&n.push(`project ${s}`);let a=me(e.sortKey);a!==null&&a!==""&&n.push(`${a} ${e.descending===!1?"\u2191":"\u2193"}`),e.detail==="full"&&n.push("full");let l=me(e.limit);l!==null&&l!==""&&n.push(`limit ${l}`);let d=me(e.offset);return d!==null&&d!==""&&d!=="0"&&n.push(`offset ${d}`),n.length===0?"all tickets":n.join(" \xB7 ")}var nm=new Set(["ticketId","projectId"]),tm=new Set(["description","body"]);function fa(e){if(e===null)return[];let n=[];for(let[t,i]of Object.entries(e))nm.has(t)||i!==void 0&&n.push(Ne(t,ua(i),{open:!0,...tm.has(t)?{markdown:!0}:{}}));return n}var im=72;function _c(e,n,t){let i=ca(e??"move",im);if(n===null||n==="")return{title:i,state:null,text:i};let o=t===void 0?n:t(n);return{title:i,state:n,text:`${i} \u2192 ${o}`}}function om(e,n){let t=new Set(Hn(n?.created).map(i=>String(i)));return Hn(e?.paths).map(i=>{let o=String(i);return{path:o,created:t.has(o)}})}function Cc(e,n){return om(e,n).map(t=>Ne(t.created?"will be created":"exists",t.path))}function Oc(e){let n=me(e?.fromState),t=me(e?.toState);return n===null||t===null?[]:[{label:"From",value:n},{label:"To",value:t}]}function Pc(e){let n=[];for(let i of["frontmatter","preamble"]){let o=e?.[i];typeof o=="string"&&n.push(o===""?{label:i,value:"(empty)"}:Ne(i,o))}let t=e?.contextSections;return Array.isArray(t)&&n.push({label:"contextSections",value:String(t.length)}),n}function Mc(e){let n=[],t=e?.imported??e?.count;typeof t=="number"&&n.push({label:"Imported",value:String(t)}),typeof e?.projectId=="number"&&n.push({label:"Project",value:String(e.projectId)});let i=e?.deleted;typeof i=="boolean"&&n.push({label:"Plan file",value:i?"deleted":"KEPT"});let o=e?.deletionError;return typeof o=="string"&&o!==""&&n.push(Ne("Deletion error",o)),n}function Lc(e){return Hn(e?.suggestions).map(n=>qn(n)).filter(n=>n!==null).map(n=>({ticketId:me(n.ticketId)??"?",actionId:me(n.actionId)??"",reason:me(n.reason)??""}))}var rm=["frontmatter","preamble","contextSections"];function Dc(e){return e===null?[]:rm.filter(n=>typeof e[n]=="string")}function am(e){return typeof e=="string"&&Zn.includes(e)}function Bc(e,n){if(n==null||n==="")return null;let t=qn(e);if(t===null)return null;let i=qn(t[n]);if(i===null||typeof i.id!="number"||typeof i.title!="string"||!am(i.state)||typeof i.slug!="string"||typeof i.workspaceKey!="string")return null;let o={id:i.id,title:i.title,state:i.state,slug:i.slug,workspaceKey:i.workspaceKey};typeof i.gatePresent=="number"&&(o.gatePresent=i.gatePresent),typeof i.gateTotal=="number"&&(o.gateTotal=i.gateTotal),typeof i.criteria=="string"&&(o.criteria=i.criteria);let r=me(i.description);return r!==null&&r.trim()!==""&&(o.descriptionExcerpt=ca(r,220)),r!==null&&r.trim()!==""&&(o.descriptionFull=r),o}function zc(e){if(e==null)return{button:null,reason:"no document"};let n=e.querySelectorAll('[role="tab"]');for(let t of Array.from(n)){let i=(t.textContent??"").trim();if(i==="Tickets"||i.startsWith("Tickets ("))return{button:t,reason:null}}return{button:null,reason:"the Tickets tab is not shown on this screen"}}function Kc(e,n,t){let i=e;return n!==void 0&&(i+=" \xB7 "+n+(n===1?" ticket":" tickets")),t===!1?i+=" \xB7 file kept":t===!0&&(i+=" \xB7 file deleted"),i}function sm(e,n){let t=e?.ticketId;if(typeof t=="number"||typeof t=="string")return String(t);if(n!==null&&typeof n=="object"){let i=n.ticketId;if(typeof i=="number"||typeof i=="string")return String(i)}return null}function lm(e,n){if(e===null||n===null||n===void 0||n==="")return null;let t=n,i=e.tickets.find(a=>J(a)===t)??null;if(i===null)return null;let o=J(i),r=new Map,s=(a,l)=>{r.has(a)||r.set(a,l)};for(let a of e.tickets)s(J(a),a),s(String(a.id),a),s(a.workspaceKey+":"+String(a.id),a);return{ticket:i,boardKey:o,evidence:e.evidence[o]??[],comments:e.comments[o]??[],ticketsByKey:r}}function dm(e){let n=St(e);if(n===null||n==="")return null;try{let t=JSON.parse(n);return t!==null&&typeof t=="object"&&!Array.isArray(t)?t:null}catch{return null}}function rt(e,n){if(n===null)return null;let t=go(e,n);return t===null?`#${n}`:`#${n} \u2014 ${t}`}function cm(e){return`Select ${e} on the board`}function en(e){let[n,t]=m.default.useState(!1),[i,o]=m.default.useState(!1),[r,s]=m.default.useState(!1),[a,l]=m.default.useState(null),d=e.body??null,c=e.footer??null,f=d!==null||c!==null,p=n&&f,h=vc(e.state,e.summary,e.errorSummary),v=e.summaryNode!==void 0&&e.errorSummary===void 0?e.summaryNode:null,k=e.ticketId!==null&&e.ticketId!==void 0&&e.sessionId!==void 0;m.default.useEffect(()=>{e.ticketId===null||e.ticketId===void 0||console.info(`[aidos] toolview ticket=${e.ticketId} sessionId=${e.sessionId??"MISSING"} useProjection=${typeof e.useProjection} canSelect=${k}`)},[e.ticketId,e.sessionId,e.useProjection,k]);let A=k?L=>{L.stopPropagation(),console.info(`[aidos] click-through fired for ticket ${e.ticketId}`),Xn(e.sessionId,e.ticketId),l(null),o(!0)}:void 0,w=e.useProjection!==void 0?Bc(e.useProjection("aidos.tickets"),e.ticketId):null,O=lm(e.sessionId===void 0?null:Dt(e.sessionId),e.ticketId);return m.default.createElement("div",{className:"tool-render-card","data-error":e.state==="error"||void 0},m.default.createElement("div",{className:"tool-render-row","data-state":e.state,"data-expandable":f?!0:void 0,role:f?"button":void 0,tabIndex:f?0:void 0,"aria-expanded":f?p:void 0,onClick:f?()=>t(!n):void 0,onKeyDown:f?L=>{(L.key==="Enter"||L.key===" ")&&(L.preventDefault(),t(!n))}:void 0},m.default.createElement(bo,{open:p,disabled:!f}),m.default.createElement("span",{className:"tool-render-name-badge",style:Wo(e.title,e.state==="error")},m.default.createElement("span",{className:"tool-render-name-badge-icon"},e.icon),m.default.createElement("span",{className:"tool-render-name-badge-text",title:e.title,"data-dsh-tip":""},e.title)),m.default.createElement("span",{className:"tool-render-sep","aria-hidden":"true"}),A!==void 0&&e.errorSummary===void 0?m.default.createElement("span",{className:"tool-render-path"+(v===null?"":" aidos-row-summary-rich"),role:"link",tabIndex:0,title:cm(h.text),"data-dsh-tip":"",onClick:A,onKeyDown:L=>{(L.key==="Enter"||L.key===" ")&&(L.preventDefault(),A(L))}},v??h.text):m.default.createElement("span",{className:"tool-render-summary"+(v===null?"":" aidos-row-summary-rich"),"tool-render-error":h.isError?!0:void 0},v??h.text)),p?m.default.createElement("div",{className:"tool-render-body"},d,c!==null?m.default.createElement("div",{className:"aidos-tool-footer"},c):null):null,i?m.default.createElement(De,{title:O!==null?`#${O.ticket.id} ${O.ticket.title}`:"Ticket",wide:O!==null,onClose:()=>o(!1)},O!==null&&e.sessionId!==void 0?m.default.createElement(m.default.Fragment,null,m.default.createElement(Co,{key:Le(O.ticket),ticket:O.ticket,ticketIdKey:O.boardKey,evidence:O.evidence,comments:O.comments,evidenceCollapsed:r,onToggleEvidence:()=>{s(L=>!L)},onClose:()=>o(!1),agentId:e.sessionId,onFieldSaved:()=>{},ticketsByKey:O.ticketsByKey,onJump:L=>{Xn(e.sessionId,L),o(!1)}})):w!==null?m.default.createElement(m.default.Fragment,null,m.default.createElement(An,{ticket:w}),w.descriptionFull!==void 0?m.default.createElement("div",{className:"aidos-md aidos-ticket-peek-description",dangerouslySetInnerHTML:{__html:qi(w.descriptionFull)}}):null,m.default.createElement("div",{className:"aidos-ticket-peek-actions"},k?m.default.createElement("button",{type:"button",className:"tool-render-approval-btn tool-render-approval-approve",onClick:L=>{L.stopPropagation(),Xn(e.sessionId,e.ticketId);let ee=zc(typeof document>"u"?void 0:document);ee.button!==null?(ee.button.click(),o(!1)):l(ee.reason)}},m.default.createElement(mt,null)," Open on board"):null),a!==null?m.default.createElement("p",{className:"aidos-ticket-peek-note",role:"status"},a):null):m.default.createElement("p",{className:"aidos-ticket-peek-empty"},"#"+(e.ticketId??"?")+" isn't in this session's own board yet, or belongs to another session. Open the Tickets tab to look it up there.")):null)}function Ln({facts:e}){return e.length===0?null:m.default.createElement("dl",{className:"aidos-tool-facts"},e.map((n,t)=>m.default.createElement(m.default.Fragment,{key:n.label+":"+t},m.default.createElement("dt",null,n.label),m.default.createElement(um,{fact:n}))))}function um({fact:e}){return e.full!==void 0&&e.full!==""?m.default.createElement(Fc,{fact:e,as:"dd"}):m.default.createElement("dd",{title:e.value,"data-dsh-tip":""},e.value)}function Fc({fact:e,as:n}){let[t,i]=m.default.useState(e.open===!0);return m.default.createElement(n,{className:n==="span"?"aidos-tool-fact-value":void 0,"data-expanded":t?!0:void 0},t?m.default.createElement(pm,{fact:e}):m.default.createElement("span",{className:"aidos-tool-fact-clipped",title:e.value,"data-dsh-tip":""},e.value),m.default.createElement("button",{className:"aidos-tool-fact-more",type:"button","aria-expanded":t,onClick:r=>{r.stopPropagation(),i(!t)}},t?"Show less":"Show more"))}function Jo({fact:e}){return e.full===void 0||e.full===""?m.default.createElement("span",{className:"aidos-tool-list-text",title:e.value,"data-dsh-tip":""},e.value):m.default.createElement("span",{className:"aidos-tool-list-text aidos-tool-list-value"},m.default.createElement(Fc,{fact:e,as:"span"}))}function pm({fact:e}){let n=e.full??e.value;return e.markdown!==!0?m.default.createElement("span",{className:"aidos-tool-fact-full"},n):m.default.createElement("div",{className:"aidos-md aidos-tool-fact-full",dangerouslySetInnerHTML:{__html:qi(n)}})}function fm({tables:e,onSelect:n}){return e.length===0?null:m.default.createElement("div",{className:"aidos-tool-stack"},e.map(t=>m.default.createElement("section",{className:"aidos-tool-table",key:t.id},m.default.createElement($c,{id:t.id,state:t.state,title:t.title,onSelect:n}),m.default.createElement(Ln,{facts:t.facts}))))}function $c({id:e,state:n,title:t,onSelect:i}){return m.default.createElement("header",{className:"aidos-tool-table-head"},i!==void 0?m.default.createElement("button",{className:"aidos-tool-table-id aidos-tool-table-id-link",type:"button",onClick:o=>{o.stopPropagation(),i(e)}},"#"+e):m.default.createElement("span",{className:"aidos-tool-table-id"},"#"+e),n===""?null:m.default.createElement("span",{className:"aidos-tool-list-tag"},n),m.default.createElement("span",{className:"aidos-tool-table-title",title:t,"data-dsh-tip":""},t))}function hm(e){let n=Tc(e);return n===null?null:m.default.createElement($c,{id:n.id,state:n.state,title:n.title})}function Xo({text:e,isError:n}){return m.default.createElement("pre",{className:"tool-render-output","tool-render-error":n===!0?!0:void 0},e)}function an(e){if(e===null||e==="")return null;let n=Go(e);if(n===null)return m.default.createElement(Xo,{text:e,isError:!0});let t=[];n.code!==null&&t.push({label:"code",value:n.code});for(let[i,o]of Object.entries(n.extra))t.push(Ne(i,ua(o)));return n.message===null&&t.length===0?m.default.createElement(Xo,{text:e,isError:!0}):m.default.createElement(m.default.Fragment,null,n.message===null?null:m.default.createElement("p",{className:"aidos-tool-message"},n.message),m.default.createElement(Ln,{facts:t}))}function nn(e){let n=e?.block,t=Uo(jo(n)),i=Vo(n),o=dm(n),r=sm(t,o),s=i==="error"?qo(n):null,a=s!==null&&s!==""?Ho(s):void 0,l=s===null?null:Go(s),d=i==="error"&&l?.refusal===!0?"stopped":i,c=St(n);return{args:t,state:d,result:o,resultText:c,ticketId:r,errorText:s,errorSummary:a}}function Tt(e){return e===null||e===""?null:m.default.createElement(Xo,{text:e,isError:!1})}function gm(e){let{args:n,state:t,result:i,ticketId:o,errorText:r,errorSummary:s}=nn(e),a=typeof n?.kind=="string"?n.kind:void 0,l=nr(),d=m.default.createElement(m.default.Fragment,null,r!==null&&r!==""?an(r):a!==void 0?m.default.createElement("ul",{className:"aidos-evidence-list"},m.default.createElement(En,{row:{kind:a.startsWith("builtin:")?a:"builtin:"+a,payload:n?.payload??{},author:"agent",at:typeof i?.updatedAt=="number"?i.updatedAt:void 0},onView:l.open})):null,l.viewer);return m.default.createElement(en,{icon:m.default.createElement(Li,null),title:"Evidence",summary:rt(e.sessionId,o)??"evidence",state:t,body:d,errorSummary:s,ticketId:o,sessionId:e.sessionId,useProjection:e.useProjection})}function mm(e){let{args:n,state:t,result:i,resultText:o,ticketId:r,errorText:s,errorSummary:a}=nn(e),l=typeof n?.to=="string"?n.to:null,d=rt(e.sessionId,r),c=[...Oc(i),...pa(i)],f=s!==null&&s!==""?an(s):c.length>0?m.default.createElement(Ln,{facts:c}):i===null?Tt(o):null,p=_c(d,l,cn),h=p.state===null?void 0:m.default.createElement(m.default.Fragment,null,m.default.createElement("span",{className:"aidos-move-title",title:d??p.title,"data-dsh-tip":""},p.title),m.default.createElement("span",{className:"aidos-move-arrow","aria-hidden":"true"},"\u2192"),m.default.createElement("span",{className:ht(p.state)},cn(p.state)));return m.default.createElement(en,{icon:m.default.createElement(li,null),title:"Move ticket",summary:p.text,summaryNode:h,state:t,body:f,errorSummary:a,ticketId:r,sessionId:e.sessionId,useProjection:e.useProjection})}function bm(e){let{args:n,state:t,result:i,ticketId:o,errorText:r,errorSummary:s}=nn(e),a=i?.created===!0,l=typeof n?.title=="string"?n.title:null,d=a&&l!==null?`#${o??"?"} \u2014 ${l}`:rt(e.sessionId,o),c=fa(n),f=r!==null&&r!==""?an(r):c.length>0?m.default.createElement(Ln,{facts:c}):null;return m.default.createElement(en,{icon:m.default.createElement(Tn,null),title:a?"Create ticket":"Edit ticket",summary:d??"ticket",state:t,body:f,errorSummary:s,ticketId:o,sessionId:e.sessionId,useProjection:e.useProjection})}function wm(e){let{state:n,result:t,resultText:i,ticketId:o,errorText:r,errorSummary:s}=nn(e),a=pa(t),l=Rc(t),d=nr(),c=r!==null&&r!==""?an(r):a.length===0&&l.length===0?t===null?Tt(i):null:m.default.createElement(m.default.Fragment,null,hm(t),m.default.createElement(Ln,{facts:a}),l.length>0?m.default.createElement("ul",{className:"aidos-evidence-list"},l.map((f,p)=>m.default.createElement(En,{key:p,row:{kind:f.kind,payload:{note:f.excerpt},author:f.author,at:f.at},onView:d.open}))):null,d.viewer);return m.default.createElement(en,{icon:m.default.createElement(et,null),title:"Read ticket",summary:rt(e.sessionId,o)??"ticket",state:n,body:c,errorSummary:s,ticketId:o,sessionId:e.sessionId,useProjection:e.useProjection})}function ym(e){let{args:n,state:t,result:i,resultText:o,errorText:r,errorSummary:s}=nn(e),a=Nc(n),l=typeof i?.summary=="string"?i.summary:null,d=Ec(i),c=r!==null&&r!==""?an(r):d.length===0?i===null?Tt(o):null:m.default.createElement(fm,{tables:d,onSelect:e.sessionId===void 0?void 0:f=>{Xn(e.sessionId,f)}});return m.default.createElement(en,{icon:m.default.createElement(si,null),title:"Read board",summary:a,state:t,body:c,footer:l,errorSummary:s})}function vm(e){let{args:n,state:t,result:i,ticketId:o,errorText:r,errorSummary:s}=nn(e),a=Cc(n,i),d=(rt(e.sessionId,o)??"allowlist")+" \xB7 "+a.length+(a.length===1?" path":" paths"),c=r!==null&&r!==""?an(r):a.length===0?null:m.default.createElement(m.default.Fragment,null,m.default.createElement(Ln,{facts:a}),e.sessionId!==void 0&&o!==null?m.default.createElement(pd,{sessionId:e.sessionId,boardKey:String(o)}):null);return m.default.createElement(en,{icon:m.default.createElement(mo,null),title:"Request allowlist",summary:d,state:t,body:c,errorSummary:s,ticketId:o,sessionId:e.sessionId,useProjection:e.useProjection})}function km(e){let{args:n,state:t,errorText:i,errorSummary:o}=nn(e),r=Lc(n),s=r.length===0?"nothing":r.length===1?rt(e.sessionId,r[0].ticketId)??"#"+r[0].ticketId:r.length+" tickets",a=i!==null&&i!==""?an(i):r.length===0?null:m.default.createElement("ul",{className:"aidos-tool-list"},r.map(l=>m.default.createElement("li",{key:l.ticketId+":"+l.actionId},m.default.createElement("span",{className:"aidos-tool-list-key"},"#",l.ticketId),m.default.createElement("span",{className:"aidos-tool-list-tag"},l.actionId),m.default.createElement(Jo,{fact:Ne("reason",l.reason)}),e.sessionId!==void 0&&dd(l.actionId)?m.default.createElement(ud,{sessionId:e.sessionId,boardKey:String(l.ticketId),actionId:l.actionId}):null)));return m.default.createElement(en,{icon:m.default.createElement(Mi,null),title:"Suggest actions",summary:s,state:t,body:a,errorSummary:o,ticketId:r.length===1?r[0].ticketId:null,sessionId:e.sessionId,useProjection:e.useProjection})}function xm(e){let{args:n,state:t,errorText:i,errorSummary:o}=nn(e),r=i??St(e.block),s=n?.projectId===void 0?"the project plan":"project "+String(n.projectId);return m.default.createElement(en,{icon:m.default.createElement(mt,null),title:"Export plan",summary:s,state:t,body:r===null||r===""?null:m.default.createElement(Xo,{text:r,isError:i!==null&&t==="error"}),errorSummary:o})}function Sm(e){let{args:n,state:t,result:i,resultText:o,errorText:r,errorSummary:s}=nn(e),a=typeof n?.file=="string"?n.file:"a plan",l=i?.imported??i?.count,d=Mc(i),c=r!==null&&r!==""?an(r):d.length>0?m.default.createElement(Ln,{facts:d}):i===null?Tt(o):null;return m.default.createElement(en,{icon:m.default.createElement(mt,null),title:"Import plan",summary:Kc(a,typeof l=="number"?l:void 0,typeof i?.deleted=="boolean"?i.deleted:void 0),state:t,body:c,errorSummary:s})}function Tm(e){let{args:n,state:t,result:i,resultText:o,errorText:r,errorSummary:s}=nn(e),a=n?.projectId===void 0?"the plan blocks":"project "+String(n.projectId),l=Pc(i),d=r!==null&&r!==""?an(r):l.length>0?m.default.createElement(Ln,{facts:l}):i===null?Tt(o):null;return m.default.createElement(en,{icon:m.default.createElement(et,null),title:"Read plan blocks",summary:a,state:t,body:d,errorSummary:s})}function Em(e){let{args:n,state:t,errorText:i,errorSummary:o}=nn(e),r=Dc(n),s=fa(n).filter(l=>l.label!=="projectId"),a=i!==null&&i!==""?an(i):s.length>0?m.default.createElement(Ln,{facts:s}):null;return m.default.createElement(en,{icon:m.default.createElement(Tn,null),title:"Edit plan blocks",summary:r.length===0?"no block":r.join(" \xB7 "),state:t,body:a,errorSummary:o})}function Rm(e){let{args:n,state:t,result:i,resultText:o,ticketId:r,errorText:s,errorSummary:a}=nn(e),l=Ac(i),d=Ic(i),c=nr(),f=typeof n?.index=="number"?n.index:null,p=rt(e.sessionId,r)??"ticket",h=f===null?p+" \xB7 evidence":p+" \xB7 evidence ["+String(f)+"]",v=s!==null&&s!==""?an(s):l.length===0&&d.length===0?i===null?Tt(o):null:m.default.createElement(m.default.Fragment,null,m.default.createElement("ul",{className:"aidos-evidence-list"},l.map(k=>m.default.createElement(En,{key:String(k.index)+":"+k.kind,row:{kind:k.kind,payload:k.payload,author:k.author,at:k.at},onView:c.open}))),d.map((k,A)=>m.default.createElement("div",{className:"aidos-comment",key:A},m.default.createElement("div",null,m.default.createElement("span",{className:"aidos-evidence-author"},k.author)),m.default.createElement("p",{className:"aidos-detail-body"},k.body))),c.viewer);return m.default.createElement(en,{icon:m.default.createElement(et,null),title:"Read evidence",summary:h,state:t,body:v,errorSummary:a,ticketId:r,sessionId:e.sessionId,useProjection:e.useProjection})}function nr(){let[e,n]=m.default.useState(null);return{open:n,viewer:e===null?null:m.default.createElement(bt,{row:e,onClose:()=>{n(null)}})}}function er(e){return Array.isArray(e)?e.filter(n=>typeof n=="string"):[]}function ha(e,n){return n!==null&&typeof n.commit=="string"&&n.commit.trim()!==""?n.commit.trim():e!==null&&typeof e.hash=="string"&&e.hash.trim()!==""?e.hash.trim():null}function ga(e){return e===null||typeof e.subject!="string"||e.subject.trim()===""?null:e.subject.trim()}function Am(e){return e===null||e===""?null:e.length<=12?e:e.slice(0,12)}function Im(e,n,t,i){let o=Am(ha(n,t)),r=ga(t),s=i??(e===null?null:`#${e}`),a=r===null?null:Ne("subject",r,{max:80}).value,l=o===null?r??"commit":a===null?o:`${o} \u2014 ${a}`;return s===null?l:`${s} \xB7 ${l}`}function Nm(e,n){let t=[],i=ha(e,n);i!==null&&t.push(Ne("Commit",i));let o=ga(n);o!==null&&t.push(Ne("Subject",o)),e!==null&&typeof e.note=="string"&&e.note.trim()!==""&&t.push(Ne("Note",e.note.trim()));let r=n?.gatePresent,s=n?.gateTotal;return typeof r=="number"&&typeof s=="number"&&t.push({label:"Gate",value:`${r}/${s}`}),n!==null&&typeof n.nextStep=="string"&&n.nextStep.trim()!==""&&t.push(Ne("Next step",n.nextStep.trim())),t}function _m(e){let{args:n,state:t,result:i,resultText:o,ticketId:r,errorText:s,errorSummary:a}=nn(e),l=nr(),d=rt(e.sessionId,r),c=Im(r,n,i,d),f=Nm(n,i),p=ha(n,i),h=ga(i),v=n!==null&&typeof n.note=="string"&&n.note.trim()!==""?n.note.trim():null,k=s!==null&&s!==""?an(s):f.length===0&&p===null?i===null?Tt(o):null:m.default.createElement(m.default.Fragment,null,f.length>0?m.default.createElement(Ln,{facts:f}):null,p===null?null:m.default.createElement("ul",{className:"aidos-evidence-list"},m.default.createElement(En,{row:{kind:"builtin:user_commit",payload:{commit:p,...h===null?{}:{subject:h},...v===null?{}:{note:v}},author:"agent"},onView:l.open})),l.viewer);return m.default.createElement(en,{icon:m.default.createElement(Li,null),title:"Attach commit",summary:c,state:t,body:k,errorSummary:a,ticketId:r,sessionId:e.sessionId,useProjection:e.useProjection})}function Cm(e,n,t,i){let o=t===null?[]:er(t.attached),r=er(n?.tags),s=o.length>0?o:t===null?r:o,a=`${s.length} tag${s.length===1?"":"s"}`,l=t!==null&&typeof t.createdCount=="number"?t.createdCount:null;return(i??(e===null?null:`#${e}`)??"tags")+" \xB7 "+a+(l!==null&&l>0?` \xB7 created ${l}`:"")}function Om(e,n){if(n===null)return[];let t=[],i=er(n.attached);if(i.length>0)t.push(Ne("Attached",i.join(", ")));else{let o=er(e?.tags);o.length>0&&t.push(Ne("Requested",o.join(", ")))}return typeof n.message=="string"&&n.message.trim()!==""&&t.push(Ne("Created",n.message.trim())),t}function Pm(e){let{args:n,state:t,result:i,ticketId:o,errorText:r,errorSummary:s}=nn(e),a=rt(e.sessionId,o),l=Cm(o,n,i,a),d=Om(n,i),c=r!==null&&r!==""?an(r):d.length>0?m.default.createElement(Ln,{facts:d}):null;return m.default.createElement(en,{icon:m.default.createElement(Tn,null),title:"Attach tags",summary:l,state:t,body:c,errorSummary:s,ticketId:o,sessionId:e.sessionId,useProjection:e.useProjection})}function Mm(e,n){let t=e!==null&&typeof e.action=="string"&&e.action!==""?e.action:n!==null&&typeof n.action=="string"&&n.action!==""?n.action:null,i=e!==null&&typeof e.tag=="string"&&e.tag!==""?e.tag:n!==null&&typeof n.tag=="string"&&n.tag!==""?n.tag:null;if(t===null||i===null)return null;let o=e?.to??n?.to,r=e?.ticketId??n?.ticketId;return{action:t,tag:i,to:typeof o=="string"&&o!==""?o:null,ticketId:typeof r=="number"||typeof r=="string"?String(r):null,reason:e!==null&&typeof e.reason=="string"?e.reason:"",status:n!==null&&typeof n.status=="string"?n.status:null,requestId:n!==null&&typeof n.requestId=="string"?n.requestId:null}}function Lm(e){if(e===null)return"tag change";let n=e.action==="migrate"&&e.to!==null?`${e.tag} \u2192 ${e.to}`:e.action==="detach"&&e.ticketId!==null?`detach ${e.tag} from #${e.ticketId}`:`${e.action} ${e.tag}`;return e.status===null?n:`${n} \xB7 ${e.status}`}function Dm(e){let{args:n,state:t,result:i,errorText:o,errorSummary:r}=nn(e),s=Mm(n,i),a=Lm(s),l=s?.requestId===null||s?.requestId===void 0?null:`request ${s.requestId}`,d=o!==null&&o!==""?an(o):s===null?null:m.default.createElement("ul",{className:"aidos-tool-list"},m.default.createElement("li",{key:s.action+":"+s.tag+":"+(s.ticketId??"")},m.default.createElement("span",{className:"aidos-tool-list-key"},s.tag),m.default.createElement("span",{className:"aidos-tool-list-tag"},s.action),s.action==="detach"&&s.ticketId!==null?m.default.createElement("span",{className:"aidos-tool-list-key"},"#",s.ticketId):null,m.default.createElement(Jo,{fact:Ne("reason",s.reason.trim()===""?"(no reason given)":s.reason)})));return m.default.createElement(en,{icon:m.default.createElement(Mi,null),title:"Suggest tag change",summary:a,state:t,body:d,footer:l,errorSummary:r,ticketId:s!==null&&s.action==="detach"?s.ticketId:null,sessionId:e.sessionId,useProjection:e.useProjection})}function Bm(e){if(e===null||!Array.isArray(e.changes))return[];let n=[];for(let t of e.changes){if(t===null||typeof t!="object"||Array.isArray(t))continue;let i=t,o=i.ticketId,r=i.change;typeof o!="number"&&typeof o!="string"||typeof r!="string"||n.push({ticketId:String(o),state:typeof i.state=="string"?i.state:"",title:typeof i.title=="string"?i.title:"",change:r,nextStep:typeof i.nextStep=="string"&&i.nextStep.trim()!==""?i.nextStep:null})}return n}function zm(e,n,t){let i=e!==null&&(typeof e.ticketId=="number"||typeof e.ticketId=="string")?String(e.ticketId):null;if(n===null)return i===null?"recent changes":`#${i} \xB7 recent changes`;let o=`${t.length} change${t.length===1?"":"s"}`;return i===null?o:`#${i} \xB7 ${o}`}function Km(e){if(e===null)return null;let n=typeof e.covers=="string"&&e.covers.trim()!==""?e.covers.trim():null,t=typeof e.omitted=="number"&&e.omitted>0?e.omitted:null;return n===null&&t===null?null:(n??"board changes")+(t===null?"":` \xB7 ${t} earlier change${t===1?"":"s"} omitted`)}function Fm(e){let{args:n,state:t,result:i,resultText:o,errorText:r,errorSummary:s}=nn(e),a=Bm(i),l=zm(n,i,a),d=Km(i),c=r!==null&&r!==""?an(r):a.length===0?i===null?Tt(o):null:m.default.createElement("ul",{className:"aidos-tool-list"},a.map((f,p)=>m.default.createElement("li",{key:f.ticketId+":"+p},m.default.createElement("span",{className:"aidos-tool-list-key"},"#",f.ticketId),f.state===""?null:m.default.createElement("span",{className:"aidos-tool-list-tag"},f.state),f.title===""?null:m.default.createElement("span",{className:"aidos-tool-list-text",title:f.title,"data-dsh-tip":""},f.title),m.default.createElement(Jo,{fact:Ne("change",f.change)}),f.nextStep===null?null:m.default.createElement(Jo,{fact:Ne("next step","Next: "+f.nextStep)}))));return m.default.createElement(en,{icon:m.default.createElement(et,null),title:"Recent changes",summary:l,state:t,body:c,footer:d,errorSummary:s})}var jc=[["get_tickets",ym],["get_ticket",wm],["get_evidence",Rm],["digest_recent",Fm],["set_ticket",bm],["attach_evidence",gm],["attach_commit",_m],["attach_tags",Pm],["move_ticket",mm],["request_allowlist",vm],["suggest_actions",km],["suggest_tag_change",Dm],["plan",xm],["plan_import",Sm],["plan_meta",Tm],["plan_meta_set",Em]];var $m="aidos",jm=["slots"],Um="aidos";function Vm(){if(!(typeof document>"u"))for(let e of[{marker:"aidos/board.css",text:_a},{marker:"aidos/plan-meta.css",text:Ca},{marker:"aidos/tool-render.css",text:Oa}]){if(document.querySelector(`style[data-plugin-css="${e.marker}"]`)!==null)continue;let n=document.createElement("style");n.dataset.plugin="aidos",n.dataset.pluginCss=e.marker,n.textContent=e.text,document.head.appendChild(n)}}function qm(e,n){return function(i){try{return n(i)}catch(o){return console.warn(`aidos: the ${e} tool row failed to render`,o),ki.default.createElement("div",{className:"tool-render-card"},ki.default.createElement("div",{className:"tool-render-row","data-state":"error"},ki.default.createElement("span",{className:"tool-render-title"},e),ki.default.createElement("span",{className:"tool-render-sep"}),ki.default.createElement("span",{className:"tool-render-summary"},"this card could not render; the call itself was unaffected")))}}}function Vc(e){let n=[...Sc,...jc],t=[],i=0;for(let[o,r]of n)try{t.push(e.inject("tool.call.toolview",()=>{try{return e.register({name:"tool.call.toolview",key:o,priority:-100},qm(o,r))}catch(s){return i+=1,i===n.length&&console.error(`aidos: ALL ${n.length} tool rows failed to register on "tool.call.toolview"; every board tool will render as raw JSON`),console.warn(`aidos: the ${o} tool row could not register; the other rows continue`,s),()=>{}}}))}catch(s){i+=1,console.warn(`aidos: the ${o} tool row could not register; the other rows continue`,s)}if(i===n.length)throw new Error(`aidos: all ${n.length} tool rows failed to register on "tool.call.toolview" -- total registration failure is loud, never a console line`);return function(){for(let o of t)o()}}function Uc(e){return e.inject("conversation.view",()=>e.register({name:"conversation.view",id:"tickets",order:20,label:Ci},Nd))}function Hm(e){Vm(),e.effect(()=>{let r=e.get("slots");return r===void 0?()=>{}:Vc(r)},"aidos: scratch tool rows");let n=null,t=!1,i=Ci();function o(r){t&&n===null&&(n=Uc(r),i=Ci()),!t&&n!==null&&(n(),n=null)}e.effect(function(){let r=e.get("slots");if(r===void 0)return()=>{};let s=e.get("sessions");if(s===void 0||typeof s.list?.getSnapshot!="function"||typeof s.list?.subscribe!="function")return t=!0,o(r),function(){t=!1,o(r)};let a=s.list.getSnapshot(),l=function(){let c=a.current?a.byId[a.current]?.agentPreset:void 0;t=c===void 0||c===Um,o(r),ss(a.current??null)},d=s.list.subscribe(function(){a=s.list.getSnapshot(),l()});return l(),function(){d(),t=!1,o(r)}},"aidos: tickets tab visibility"),rs(function(){if(n===null)return;let r=Ci();if(r===i)return;let s=e.get("slots");if(s!==void 0)try{n(),n=Uc(s),i=r,console.info(`[aidos] tab re-registered for label "${r}" <- this remounts the board`)}catch(a){n=null,console.error("aidos: the Tickets tab failed to re-register after a badge change; the tab may show a stale count until the next visibility change",a)}})}
