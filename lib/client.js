...
function renderEvidenceRow() {
  ...
  return import_react2.default.createElement("div", { className: "aidos-evidence-row" }, chips);
}
...
function LocalTicketView(props) {
  const [retryNonce, setRetryNonce] = import_react4.default.useState(0);
  return import_react4.default.createElement(ProjectionReader, {
    key: retryNonce,
    sessionId: props.sessionId,
...
function ProjectionReader(props) {
  ...
  const loaded = projection !== void 0;
  const rawTickets = projection === void 0 ? [] : Object.values(projection);
  ...
  const [applied, setAppliedStateLocal] = import_react4.default.useState(function() {
    return cloneAppliedState(DEFAULT_APPLIED);
  });
  const [selectedId, setSelectedId] = import_react4.default.useState(null);
  const [createOpen, setCreateOpen] = import_react4.default.useState(false);
  const [toast, setToast] = import_react4.default.useState(null);
  const [errorTimedOut, setErrorTimedOut] = import_react4.default.useState(false);
  const deepLinkHandled = import_react4.default.useRef(false);
  const restoredRef = import_react4.default.useRef(false);
  ...
  const error = errorTimedOut && !loaded ? import_react4.default.createElement(
    "div",
  ...
  const detailPanel = selectedTicket === null ? null : import_react4.default.createElement(
    "div",
    { className: "aidos-detail" },
    import_react4.default.createElement(
      "div",
      { className: "aidos-detail-head" },
      import_react4.default.createElement("h3", { className: "aidos-detail-title" }, selectedTicket.title),
      import_react4.default.createElement(
        "button",
    ...
    import_react4.default.createElement(
      ...
      "The full detail view arrives in a later update. This panel is a placeholder for ticket " + selectedTicket.id + "."
    )
  );
  const createModal = createOpen ? import_react4.default.createElement(
    "div",
    ...
    import_react4.default.createElement(
      ...
      import_react4.default.createElement(
        ...
        import_react4.default.createElement("h3", { className: "aidos-modal-title" }, "Create a ticket"),
        import_react4.default.createElement(
          "button",
  ...
  const toastEl = toast === null ? null : import_react4.default.createElement("div", { className: "aidos-toast" }, toast);
  let body;
  if (error !== null) {
    body = error;
  } else if (!loaded) {
    body = import_react4.default.createElement(
      "div",
    ...
    body = import_react4.default.createElement(TicketView, {
      sessionId,
      tickets: filtered,
      allTicketsCount,
      applied,
