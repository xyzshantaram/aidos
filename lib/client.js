...
function TicketTile(props) {
  ...
  return /* @__PURE__ */ import_react4.default.createElement("button", { className, onClick: props.onSelect }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "aidos-tile-top" }, /* @__PURE__ */ import_react4.default.createElement(
    "span",
    {
  ...
  ), /* @__PURE__ */ import_react4.default.createElement("h3", { className: "aidos-tile-title" }, ticket.title), /* @__PURE__ */ import_react4.default.createElement("span", { className: badge }, stateLabel(ticket.state))), /* @__PURE__ */ import_react4.default.createElement("p", { className: "aidos-tile-preview" }, ticket.description), /* @__PURE__ */ import_react4.default.createElement("div", { className: "aidos-tile-meta" }, /* @__PURE__ */ import_react4.default.createElement("span", { className: "aidos-tile-gate" }, formatGateFraction(ticket.gatePresent, ticket.gateTotal, hasCriteria(ticket))), /* @__PURE__ */ import_react4.default.createElement("span", { className: "aidos-ring-inline" }, /* @__PURE__ */ import_react4.default.createElement(ConfidenceRing, { ticket }))), props.active === true ? /* @__PURE__ */ import_react4.default.createElement("span", { className: "aidos-active-marker" }, "Active") : null, /* @__PURE__ */ import_react4.default.createElement(EvidenceTags, { evidence: props.evidence }), ticket.dependsOn?.map((ref) => /* @__PURE__ */ import_react4.default.createElement("span", { key: ref, className: "aidos-dep-badge", title: ref }, displayDep(ref))));
}
...
function TicketView(props) {
  ...
  ), /* @__PURE__ */ import_react5.default.createElement("div", { className: "aidos-grid-wrap" }, /* @__PURE__ */ import_react5.default.createElement("div", { className: "aidos-grid-chrome" }, /* @__PURE__ */ import_react5.default.createElement("span", { className: "aidos-empty-note" }, props.tickets.length + " of " + props.allTicketsCount + " tickets"), /* @__PURE__ */ import_react5.default.createElement("button", { className: "aidos-btn", onClick: props.onPlan }, "Plan"), /* @__PURE__ */ import_react5.default.createElement("button", { className: "aidos-btn aidos-btn-primary", onClick: props.onCreate }, "Create")), content));
}
...
// src/client/detail-panel.tsx
function renderCriterionGroup(group, onDelete, deletingAt) {
  ...
  const rows = group.rows.map((row, rowIndex) => /* @__PURE__ */ import_react13.default.createElement("div", { className: "aidos-evidence-row-item", key: rowIndex }, /* @__PURE__ */ import_react13.default.createElement("span", { className: "aidos-evidence-kind" }, kindLabel(row.kind)), /* @__PURE__ */ import_react13.default.createElement("span", { className: "aidos-evidence-author" }, row.author), typeof row.payload.criteria === "string" ? /* @__PURE__ */ import_react13.default.createElement("span", { className: "aidos-evidence-meta" }, "criterion: " + row.payload.criteria) : null, /* @__PURE__ */ import_react13.default.createElement(
    "button",
    {
...
function renderEvidenceSection(props, onDeleteEvidence, deletingAt) {
  const groups = groupEvidenceByCriterion(props.ticket.criteria, props.evidence);
  const body = /* @__PURE__ */ import_react13.default.createElement("div", { className: "aidos-evidence-body" }, groups.length === 0 && props.evidence.length === 0 ? /* @__PURE__ */ import_react13.default.createElement("p", { className: "aidos-detail-note" }, "No evidence rows yet.") : groups.map(
    (group) => renderCriterionGroup(group, onDeleteEvidence, deletingAt)
  ));
  return /* @__PURE__ */ import_react13.default.createElement("div", { className: "aidos-panel-section aidos-collapsible" }, /* @__PURE__ */ import_react13.default.createElement("div", { className: "aidos-panel-head" }, /* @__PURE__ */ import_react13.default.createElement("h4", { className: "aidos-panel-title" }, "Evidence"), /* @__PURE__ */ import_react13.default.createElement(
    "button",
    {
      className: "aidos-btn aidos-toggle-btn",
...
function DependencySection(props) {
  ...
  const [collapsed, setCollapsed] = import_react13.default.useState(false);
  ...
  const body = /* @__PURE__ */ import_react13.default.createElement(import_react13.default.Fragment, null, /* @__PURE__ */ import_react13.default.createElement("div", { className: "aidos-dep-row" }, current.length === 0 ? /* @__PURE__ */ import_react13.default.createElement("p", { className: "aidos-detail-note" }, "No dependencies.") : current.map((ref) => /* @__PURE__ */ import_react13.default.createElement("span", { key: ref, className: "aidos-dep-badge", title: ref }, displayDep(ref)))), /* @__PURE__ */ import_react13.default.createElement("div", { className: "aidos-dep-search" }, /* @__PURE__ */ import_react13.default.createElement(
    "input",
    {
  ...
  return /* @__PURE__ */ import_react13.default.createElement("div", { className: "aidos-panel-section aidos-collapsible" }, /* @__PURE__ */ import_react13.default.createElement("div", { className: "aidos-panel-head" }, /* @__PURE__ */ import_react13.default.createElement("h4", { className: "aidos-panel-title" }, "Dependencies"), /* @__PURE__ */ import_react13.default.createElement(
    "button",
    {
      className: "aidos-btn aidos-toggle-btn",
      onClick: () => {
...
function DescriptionSection(props) {
  ...
  return /* @__PURE__ */ import_react13.default.createElement("div", { className: "aidos-description" }, empty ? /* @__PURE__ */ import_react13.default.createElement("p", { className: "aidos-detail-note" }, "No description.") : null, /* @__PURE__ */ import_react13.default.createElement(
    FieldEditor,
    {
      field: "description",
...
function DetailPanel(props) {
  ...
  return /* @__PURE__ */ import_react13.default.createElement(import_react13.default.Fragment, null, /* @__PURE__ */ import_react13.default.createElement("div", { className: "aidos-detail-head" }, /* @__PURE__ */ import_react13.default.createElement(
  ...
  ), /* @__PURE__ */ import_react13.default.createElement("span", { className: badge }, stateLabel(ticket.state)), /* @__PURE__ */ import_react13.default.createElement("button", { className: "aidos-close-btn", onClick: props.onClose }, "\xD7")), /* @__PURE__ */ import_react13.default.createElement("dl", { className: "aidos-summary-table" }, /* @__PURE__ */ import_react13.default.createElement("div", { className: "aidos-summary-row" }, /* @__PURE__ */ import_react13.default.createElement("dt", { className: "aidos-summary-label" }, "Gate"), /* @__PURE__ */ import_react13.default.createElement("dd", { className: "aidos-summary-value" }, formatGateFraction(ticket.gatePresent, ticket.gateTotal, hasCriteria(ticket)))), /* @__PURE__ */ import_react13.default.createElement("div", { className: "aidos-summary-row" }, /* @__PURE__ */ import_react13.default.createElement("dt", { className: "aidos-summary-label" }, "Confidence"), /* @__PURE__ */ import_react13.default.createElement("dd", { className: "aidos-summary-value" }, String(ringPercent(ticket.confidenceScore)) + "%", /* @__PURE__ */ import_react13.default.createElement(
    "span",
    {
    ...
    "*"
  ))), /* @__PURE__ */ import_react13.default.createElement("div", { className: "aidos-summary-row" }, /* @__PURE__ */ import_react13.default.createElement("dt", { className: "aidos-summary-label" }, "Phase"), /* @__PURE__ */ import_react13.default.createElement("dd", { className: "aidos-summary-value" }, String(ticket.phase))), /* @__PURE__ */ import_react13.default.createElement("div", { className: "aidos-summary-row" }, /* @__PURE__ */ import_react13.default.createElement("dt", { className: "aidos-summary-label" }, "Order"), /* @__PURE__ */ import_react13.default.createElement("dd", { className: "aidos-summary-value" }, String(ticket.order)))), /* @__PURE__ */ import_react13.default.createElement(
    DescriptionSection,
    {
      ticket,
  ...
  ), uncovered.length > 0 ? /* @__PURE__ */ import_react13.default.createElement("p", { className: "aidos-detail-note" }, uncovered.length + " uncovered criteria") : null, /* @__PURE__ */ import_react13.default.createElement(
    DependencySection,
    {
      ticketId: props.ticketIdKey,
...
function DetailView(props) {
  ...
  ), /* @__PURE__ */ import_react13.default.createElement(EvidenceAttachForm, { ticketId: props.ticketIdKey, agentId }), signoffOpen ? /* @__PURE__ */ import_react13.default.createElement(
    SignoffDialog,
    {
      open: true,
      ticketId: props.ticketIdKey,
...
function ProjectionReader(props) {
  ...
  return /* @__PURE__ */ import_react17.default.createElement(import_react17.default.Fragment, null, /* @__PURE__ */ import_react17.default.createElement("div", { className: "aidos-layout" }, body, detailPanel), createModal, planModal, /* @__PURE__ */ import_react17.default.createElement(ToastContainer, null));
}
