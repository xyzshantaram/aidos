...
function ScratchRow({ title, icon, summary, state, body, errorSummary }) {
...
function ScratchReadRow(props) {
  ...
  return /* @__PURE__ */ import_react28.default.createElement(ScratchRow, { icon: /* @__PURE__ */ import_react28.default.createElement(CompassIcon, null), title: "Scratch read", summary, state, body, errorSummary });
}
