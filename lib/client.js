...
function humanQueue(tickets, evidenceKindsOf, nominations = []) {
...
function QueuePanel(props) {
  ...
  return /* @__PURE__ */ import_react25.default.createElement("div", { className: "aidos-queue" }, /* @__PURE__ */ import_react25.default.createElement("ul", { className: "aidos-ticket-strips" }, entries.map((entry) => /* @__PURE__ */ import_react25.default.createElement(
    TicketStrip,
    {
